...
from nfselib.bindings.abase.xmldsig_core_schema20020212 import Signature

__NAMESPACE__ = "http://nfse.abase.com.br/nfse.xsd"
...
class TcDadosServico:
    ...
    CodigoTributacaoMunicipio: Optional[int] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://nfse.abase.com.br/nfse.xsd",
