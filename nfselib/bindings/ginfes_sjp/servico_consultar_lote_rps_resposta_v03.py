...
__NAMESPACE__ = "http://nfe.sjp.pr.gov.br/servico_consultar_lote_rps_resposta_v03.xsd"


@dataclass
class ConsultarLoteRpsResposta:
    class Meta:
        namespace = "http://nfe.sjp.pr.gov.br/servico_consultar_lote_rps_resposta_v03.xsd"
