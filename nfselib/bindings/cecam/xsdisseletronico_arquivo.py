...
class DadosNotaFiscalSituacaoNf(Enum):
    C = "C"
    N = "N"
...
class Isseletronico:
    ...
    DadosNotaFiscal: List["Isseletronico.DadosNotaFiscal"] = field(
    ...
    class DadosNotaFiscal:
        ...
        TipoNF: Optional[DadosNotaFiscalTipoNf] = field(
            default=None,
            metadata={
                "type": "Element",
                "namespace": "",
        ...
        DadosItensNotaFiscal: Optional["Isseletronico.DadosNotaFiscal.DadosItensNotaFiscal"] = field(
            default=None,
            metadata={
                "type": "Element",
                "namespace": "",
        ...
        DadosImpostosNotaFiscal: List["Isseletronico.DadosNotaFiscal.DadosImpostosNotaFiscal"] = field(
            default_factory=list,
            metadata={
                "type": "Element",
                "namespace": "",
