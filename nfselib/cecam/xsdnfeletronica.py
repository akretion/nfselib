...
from nfselib.cecam.xsdnota_tomador import DadosItensNotaFiscalRetido1


class DadosItensNotaFiscalRetido2(Enum):
    S = "S"
    N = "N"


class DadosNotaFiscalLocalPrestacao1(Enum):
    VALUE_1 = 1
    VALUE_2 = 2
    VALUE_3 = 3
    VALUE_4 = 4
...
class DadosNotaFiscalUflocalPrestacao1(Enum):
    VALUE = ""
    AC = "AC"
    AL = "AL"
    AM = "AM"
...
class DadosNotaFiscalUftomador1(Enum):
    VALUE = ""
    AC = "AC"
    AL = "AL"
    AM = "AM"
...
class Nfeeletronica:
    ...
    class DadosNotaFiscal:
        ...
        :ivar valor_aliquota_simples_nacional: (OPCIONAL) Valor da
            Alíquota do Simples Nacional, informar quando o tipo da
            empresa for "Simples Nacional"
        ...
        :ivar cidade_local_prestacao: Cidade da Prestação do Serviço
            (usar quando o Local de Prestação for do tipo 4)
        :ivar valor_aliquota_local_prestacao: (OPCIONAL) Valor da
            Alíquota no Local de Prestação do Serviço (usar quando o
            Local de Prestação for do tipo 4)
        ...
        valor_aliquota_simples_nacional: Optional[DadosNotaFiscalValorAliquotaSimplesNacional] = field(
            default=None,
            metadata={
                "name": "ValorAliquotaSimplesNacional",
                "type": "Element",
                "namespace": "",
            }
        )
        ...
        valor_aliquota_local_prestacao: Optional[Decimal] = field(
            default=None,
            metadata={
                "name": "ValorAliquotaLocalPrestacao",
                "type": "Element",
                "namespace": "",
            }
        )
