...
#
# Generated Tue Mar 20 04:15:33 2018 by generateDS.py version 2.29.2.
# Python 3.5.2 (default, Sep 14 2017, 22:51:06)  [GCC 5.4.0 20160609]
#
# Command line options:
#   ('-o', 'nfselib/v2_03/nfse.py')
#
# Command line arguments:
#   schemas/v2_03/nfse.xsd
#
# Command line:
#   /home/rvalyi/DEV/generateds/generateDS.py -o "nfselib/v2_03/nfse.py" schemas/v2_03/nfse.xsd
#
...
class tcCpfCnpj(GeneratedsSuper):
    ...
    def validate_tsCpf(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) != 11:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on tsCpf' % {
    ...
    def validate_tsCnpj(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) != 14:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on tsCnpj' % {
                               "value": value.encode("utf-8")})
    ...
    def export(self, outfile, level, namespace_='', name_='tcCpfCnpj', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_='tcCpfCnpj')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcCpfCnpj', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tcCpfCnpj', fromsubclass_=False, pretty_print=True):
        ...
        if self.Cpf is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Cpf>%s</Cpf>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.Cpf), input_name='Cpf')), eol_))
        if self.Cnpj is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Cnpj>%s</Cnpj>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.Cnpj), input_name='Cnpj')), eol_))
...
class tcEndereco(GeneratedsSuper):
    ...
    def __init__(self, Endereco=None, Numero=None, Complemento=None, Bairro=None, CodigoMunicipio=None, Uf=None, CodigoPais=None, Cep=None):
        self.original_tagname_ = None
        ...
        self.validate_tsCodigoPaisBacen(self.CodigoPais)
        self.Cep = Cep
    ...
    def set_CodigoMunicipio(
        self, CodigoMunicipio): self.CodigoMunicipio = CodigoMunicipio

    def get_Uf(self): return self.Uf

    def set_Uf(self, Uf): self.Uf = Uf

    def get_CodigoPais(self): return self.CodigoPais

    def set_CodigoPais(self, CodigoPais): self.CodigoPais = CodigoPais
    ...
    def validate_tsEndereco(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 125:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsEndereco' % {
                               "value": value.encode("utf-8")})
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tsEndereco' % {
                               "value": value.encode("utf-8")})
    ...
    def validate_tsNumeroEndereco(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 10:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsNumeroEndereco' % {
                               "value": value.encode("utf-8")})
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tsNumeroEndereco' % {
                               "value": value.encode("utf-8")})
    ...
    def validate_tsComplementoEndereco(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 60:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsComplementoEndereco' % {
                               "value": value.encode("utf-8")})
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tsComplementoEndereco' % {
                               "value": value.encode("utf-8")})
    ...
    def validate_tsBairro(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 60:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsBairro' % {
                               "value": value.encode("utf-8")})
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tsBairro' % {
                               "value": value.encode("utf-8")})
    ...
    def validate_tsCodigoMunicipioIbge(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(str(value)) >= 7:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on tsCodigoMunicipioIbge' % {
                               "value": value})
    ...
    def validate_tsUf(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            value = str(value)
            enumerations = ['AC', 'AL', 'AM', 'AP', 'BA', 'CE', 'DF', 'ES', 'GO', 'MA', 'MG', 'MS',
            ...
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on tsUf' % {
                               "value": value.encode("utf-8")})
            if len(value) != 2:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on tsUf' % {
                               "value": value.encode("utf-8")})

    def validate_tsCodigoPaisBacen(self, value):
        # Validate type tsCodigoPaisBacen, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 4:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on tsCodigoPaisBacen' % {
                               "value": value.encode("utf-8")})

    def validate_tsCep(self, value):
        # Validate type tsCep, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) != 8:
                warnings_.warn('Value "%(value)s" does not match xsd length restriction on tsCep' % {
                               "value": value.encode("utf-8")})
    ...
    def export(self, outfile, level, namespace_='', name_='tcEndereco', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_='tcEndereco')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcEndereco', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tcEndereco', fromsubclass_=False, pretty_print=True):
        ...
        if self.Endereco is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Endereco>%s</Endereco>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.Endereco), input_name='Endereco')), eol_))
        if self.Numero is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Numero>%s</Numero>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.Numero), input_name='Numero')), eol_))
        if self.Complemento is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Complemento>%s</Complemento>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.Complemento), input_name='Complemento')), eol_))
        if self.Bairro is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Bairro>%s</Bairro>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.Bairro), input_name='Bairro')), eol_))
        if self.CodigoMunicipio is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CodigoMunicipio>%s</CodigoMunicipio>%s' % (
                self.gds_format_integer(self.CodigoMunicipio, input_name='CodigoMunicipio'), eol_))
        if self.Uf is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Uf>%s</Uf>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.Uf), input_name='Uf')), eol_))
        if self.CodigoPais is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CodigoPais>%s</CodigoPais>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.CodigoPais), input_name='CodigoPais')), eol_))
        if self.Cep is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Cep>%s</Cep>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.Cep), input_name='Cep')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Endereco':
            ...
            # validate type tsUf
            self.validate_tsUf(self.Uf)
        elif nodeName_ == 'CodigoPais':
            CodigoPais_ = child_.text
            CodigoPais_ = self.gds_validate_string(
                CodigoPais_, node, 'CodigoPais')
            self.CodigoPais = CodigoPais_
            # validate type tsCodigoPaisBacen
            self.validate_tsCodigoPaisBacen(self.CodigoPais)
        elif nodeName_ == 'Cep':
            Cep_ = child_.text
...
class tcContato(GeneratedsSuper):
    ...
    def validate_tsTelefone(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 20:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsTelefone' % {
                               "value": value.encode("utf-8")})
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tsTelefone' % {
                               "value": value.encode("utf-8")})
    ...
    def validate_tsEmail(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 80:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsEmail' % {
                               "value": value.encode("utf-8")})
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tsEmail' % {
                               "value": value.encode("utf-8")})
    ...
    def export(self, outfile, level, namespace_='', name_='tcContato', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_='tcContato')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcContato', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tcContato', fromsubclass_=False, pretty_print=True):
        ...
        if self.Telefone is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Telefone>%s</Telefone>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.Telefone), input_name='Telefone')), eol_))
        if self.Email is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Email>%s</Email>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.Email), input_name='Email')), eol_))
...
class tcIdentificacaoOrgaoGerador(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='tcIdentificacaoOrgaoGerador', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcIdentificacaoOrgaoGerador')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcIdentificacaoOrgaoGerador', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class tcIdentificacaoRps(GeneratedsSuper):
    ...
    def validate_tsNumeroRps(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(str(value)) >= 15:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on tsNumeroRps' % {
                               "value": value})
    ...
    def validate_tsSerieRps(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 5:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsSerieRps' % {
                               "value": value.encode("utf-8")})
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tsSerieRps' % {
                               "value": value.encode("utf-8")})
        ...
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (
                    value.encode('utf-8'), self.validate_tsTipoRps_patterns_, ))
    ...
    def export(self, outfile, level, namespace_='', name_='tcIdentificacaoRps', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcIdentificacaoRps')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcIdentificacaoRps', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tcIdentificacaoRps', fromsubclass_=False, pretty_print=True):
        ...
        if self.Numero is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Numero>%s</Numero>%s' %
                          (self.gds_format_integer(self.Numero, input_name='Numero'), eol_))
        if self.Serie is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Serie>%s</Serie>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.Serie), input_name='Serie')), eol_))
        if self.Tipo is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Tipo>%s</Tipo>%s' %
                          (self.gds_format_integer(self.Tipo, input_name='Tipo'), eol_))
...
class tcIdentificacaoPrestador(GeneratedsSuper):
    ...
    def set_InscricaoMunicipal(
        self, InscricaoMunicipal): self.InscricaoMunicipal = InscricaoMunicipal

    def validate_tsInscricaoMunicipal(self, value):
        # Validate type tsInscricaoMunicipal, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 15:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsInscricaoMunicipal' % {
                               "value": value.encode("utf-8")})
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tsInscricaoMunicipal' % {
                               "value": value.encode("utf-8")})
    ...
    def export(self, outfile, level, namespace_='', name_='tcIdentificacaoPrestador', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcIdentificacaoPrestador')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcIdentificacaoPrestador', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tcIdentificacaoPrestador', fromsubclass_=False, pretty_print=True):
        ...
        if self.CpfCnpj is not None:
            self.CpfCnpj.export(outfile, level, namespace_,
                                name_='CpfCnpj', pretty_print=pretty_print)
        if self.InscricaoMunicipal is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<InscricaoMunicipal>%s</InscricaoMunicipal>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.InscricaoMunicipal), input_name='InscricaoMunicipal')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CpfCnpj':
            ...
            InscricaoMunicipal_ = self.gds_validate_string(
                InscricaoMunicipal_, node, 'InscricaoMunicipal')
...
class tcIdentificacaoTomador(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='tcIdentificacaoTomador', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcIdentificacaoTomador')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcIdentificacaoTomador', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class tcIdentificacaoConsulente(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, tcIdentificacaoConsulente)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if tcIdentificacaoConsulente.subclass:
            return tcIdentificacaoConsulente.subclass(*args_, **kwargs_)
        else:
            return tcIdentificacaoConsulente(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, namespace_='', name_='tcIdentificacaoConsulente', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get(
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcIdentificacaoConsulente')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcIdentificacaoConsulente', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='tcIdentificacaoConsulente'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='tcIdentificacaoConsulente', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CpfCnpj':
            ...
            # validate type tsInscricaoMunicipal
            self.validate_tsInscricaoMunicipal(self.InscricaoMunicipal)
# end class tcIdentificacaoConsulente


class tcIdentificacaoIntermediario(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, tcIdentificacaoIntermediario)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if tcIdentificacaoIntermediario.subclass:
            return tcIdentificacaoIntermediario.subclass(*args_, **kwargs_)
        else:
            return tcIdentificacaoIntermediario(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, namespace_='', name_='tcIdentificacaoIntermediario', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get(
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcIdentificacaoIntermediario')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcIdentificacaoIntermediario', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='tcIdentificacaoIntermediario'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='tcIdentificacaoIntermediario', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CpfCnpj':
            ...
            # validate type tsInscricaoMunicipal
            self.validate_tsInscricaoMunicipal(self.InscricaoMunicipal)
# end class tcIdentificacaoIntermediario
...
class tcDadosTomador(GeneratedsSuper):
    ...
    def __init__(self, IdentificacaoTomador=None, NifTomador=None, RazaoSocial=None, Endereco=None, Contato=None):
        self.original_tagname_ = None
        self.IdentificacaoTomador = IdentificacaoTomador
        self.NifTomador = NifTomador
        self.validate_tsNif(self.NifTomador)
    ...
    def set_IdentificacaoTomador(
        self, IdentificacaoTomador): self.IdentificacaoTomador = IdentificacaoTomador

    def get_NifTomador(self): return self.NifTomador

    def set_NifTomador(self, NifTomador): self.NifTomador = NifTomador
    ...
    def validate_tsNif(self, value):
        # Validate type tsNif, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 40:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsNif' % {
                               "value": value.encode("utf-8")})
            if len(value) < 0:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tsNif' % {
                               "value": value.encode("utf-8")})
    ...
    def validate_tsRazaoSocial(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 150:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsRazaoSocial' % {
                               "value": value.encode("utf-8")})
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tsRazaoSocial' % {
                               "value": value.encode("utf-8")})

    def hasContent_(self):
        if (
            self.IdentificacaoTomador is not None or
            self.NifTomador is not None or
    ...
    def export(self, outfile, level, namespace_='', name_='tcDadosTomador', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcDadosTomador')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcDadosTomador', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tcDadosTomador', fromsubclass_=False, pretty_print=True):
        ...
        if self.IdentificacaoTomador is not None:
            self.IdentificacaoTomador.export(
                outfile, level, namespace_, name_='IdentificacaoTomador', pretty_print=pretty_print)
        if self.NifTomador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<NifTomador>%s</NifTomador>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.NifTomador), input_name='NifTomador')), eol_))
        if self.RazaoSocial is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RazaoSocial>%s</RazaoSocial>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.RazaoSocial), input_name='RazaoSocial')), eol_))
        if self.Endereco is not None:
            self.Endereco.export(outfile, level, namespace_,
                                 name_='Endereco', pretty_print=pretty_print)
        if self.Contato is not None:
            self.Contato.export(outfile, level, namespace_,
                                name_='Contato', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'NifTomador':
            NifTomador_ = child_.text
            NifTomador_ = self.gds_validate_string(
                NifTomador_, node, 'NifTomador')
            self.NifTomador = NifTomador_
            # validate type tsNif
            self.validate_tsNif(self.NifTomador)
        elif nodeName_ == 'RazaoSocial':
            RazaoSocial_ = child_.text
            RazaoSocial_ = self.gds_validate_string(
                RazaoSocial_, node, 'RazaoSocial')
...
class tcDadosIntermediario(GeneratedsSuper):
    subclass = None
    superclass = None

    def __init__(self, IdentificacaoIntermediario=None, RazaoSocial=None, CodigoMunicipio=None):
        self.original_tagname_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, tcDadosIntermediario)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if tcDadosIntermediario.subclass:
            return tcDadosIntermediario.subclass(*args_, **kwargs_)
        else:
            return tcDadosIntermediario(*args_, **kwargs_)
    factory = staticmethod(factory)

    def get_IdentificacaoIntermediario(
        self): return self.IdentificacaoIntermediario

    def set_IdentificacaoIntermediario(
        self, IdentificacaoIntermediario): self.IdentificacaoIntermediario = IdentificacaoIntermediario
    ...
    def hasContent_(self):
        if (
            self.IdentificacaoIntermediario is not None or
            self.RazaoSocial is not None or
    ...
    def export(self, outfile, level, namespace_='', name_='tcDadosIntermediario', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('tcDadosIntermediario')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcDadosIntermediario')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcDadosIntermediario', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='tcDadosIntermediario'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='tcDadosIntermediario', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.IdentificacaoIntermediario is not None:
            self.IdentificacaoIntermediario.export(
                outfile, level, namespace_, name_='IdentificacaoIntermediario', pretty_print=pretty_print)
        if self.RazaoSocial is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RazaoSocial>%s</RazaoSocial>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.RazaoSocial), input_name='RazaoSocial')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'IdentificacaoIntermediario':
            obj_ = tcIdentificacaoIntermediario.factory()
            obj_.build(child_)
            self.IdentificacaoIntermediario = obj_
            obj_.original_tagname_ = 'IdentificacaoIntermediario'
        elif nodeName_ == 'RazaoSocial':
            RazaoSocial_ = child_.text
            RazaoSocial_ = self.gds_validate_string(
                RazaoSocial_, node, 'RazaoSocial')
            ...
            # validate type tsCodigoMunicipioIbge
            self.validate_tsCodigoMunicipioIbge(self.CodigoMunicipio)
# end class tcDadosIntermediario


class tcValoresDeclaracaoServico(GeneratedsSuper):
    subclass = None
    superclass = None

    def __init__(self, ValorServicos=None, ValorDeducoes=None, ValorPis=None, ValorCofins=None, ValorInss=None, ValorIr=None, ValorCsll=None, OutrasRetencoes=None, ValTotTributos=None, ValorIss=None, Aliquota=None, DescontoIncondicionado=None, DescontoCondicionado=None):
        self.original_tagname_ = None
        ...
        self.ValTotTributos = ValTotTributos
        self.validate_tsValor(self.ValTotTributos)
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, tcValoresDeclaracaoServico)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if tcValoresDeclaracaoServico.subclass:
            return tcValoresDeclaracaoServico.subclass(*args_, **kwargs_)
        else:
            return tcValoresDeclaracaoServico(*args_, **kwargs_)
    factory = staticmethod(factory)

    def get_ValorServicos(self): return self.ValorServicos

    def set_ValorServicos(
        self, ValorServicos): self.ValorServicos = ValorServicos

    def get_ValorDeducoes(self): return self.ValorDeducoes

    def set_ValorDeducoes(
        self, ValorDeducoes): self.ValorDeducoes = ValorDeducoes
    ...
    def set_OutrasRetencoes(
        self, OutrasRetencoes): self.OutrasRetencoes = OutrasRetencoes

    def get_ValTotTributos(self): return self.ValTotTributos

    def set_ValTotTributos(
        self, ValTotTributos): self.ValTotTributos = ValTotTributos
    ...
    def set_DescontoIncondicionado(
        self, DescontoIncondicionado): self.DescontoIncondicionado = DescontoIncondicionado

    def get_DescontoCondicionado(self): return self.DescontoCondicionado

    def set_DescontoCondicionado(
        self, DescontoCondicionado): self.DescontoCondicionado = DescontoCondicionado

    def validate_tsValor(self, value):
        # Validate type tsValor, a restriction on xsd:decimal.
        if value is not None and Validate_simpletypes_:
            if value < 0:
                warnings_.warn('Value "%(value)s" does not match xsd minInclusive restriction on tsValor' % {
                               "value": value})
            if len(str(value)) >= 15:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on tsValor' % {
                               "value": value})
    ...
    def validate_tsAliquota(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if value < 0:
                warnings_.warn('Value "%(value)s" does not match xsd minInclusive restriction on tsAliquota' % {
                               "value": value})
            if len(str(value)) >= 4:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on tsAliquota' % {
                               "value": value})
    ...
    def hasContent_(self):
        if (
            ...
            self.ValTotTributos is not None or
    ...
    def export(self, outfile, level, namespace_='', name_='tcValoresDeclaracaoServico', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get(
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcValoresDeclaracaoServico')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcValoresDeclaracaoServico', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='tcValoresDeclaracaoServico'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='tcValoresDeclaracaoServico', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.ValorServicos is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ValorServicos>%s</ValorServicos>%s' %
                          (self.gds_format_float(self.ValorServicos, input_name='ValorServicos'), eol_))
        if self.ValorDeducoes is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ValorDeducoes>%s</ValorDeducoes>%s' %
                          (self.gds_format_float(self.ValorDeducoes, input_name='ValorDeducoes'), eol_))
        if self.ValorPis is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ValorPis>%s</ValorPis>%s' %
                          (self.gds_format_float(self.ValorPis, input_name='ValorPis'), eol_))
        if self.ValorCofins is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ValorCofins>%s</ValorCofins>%s' %
                          (self.gds_format_float(self.ValorCofins, input_name='ValorCofins'), eol_))
        if self.ValorInss is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ValorInss>%s</ValorInss>%s' %
                          (self.gds_format_float(self.ValorInss, input_name='ValorInss'), eol_))
        if self.ValorIr is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ValorIr>%s</ValorIr>%s' %
                          (self.gds_format_float(self.ValorIr, input_name='ValorIr'), eol_))
        if self.ValorCsll is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ValorCsll>%s</ValorCsll>%s' %
                          (self.gds_format_float(self.ValorCsll, input_name='ValorCsll'), eol_))
        if self.OutrasRetencoes is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<OutrasRetencoes>%s</OutrasRetencoes>%s' % (
                self.gds_format_float(self.OutrasRetencoes, input_name='OutrasRetencoes'), eol_))
        if self.ValTotTributos is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ValTotTributos>%s</ValTotTributos>%s' % (
                self.gds_format_float(self.ValTotTributos, input_name='ValTotTributos'), eol_))
        if self.ValorIss is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ValorIss>%s</ValorIss>%s' %
                          (self.gds_format_float(self.ValorIss, input_name='ValorIss'), eol_))
        if self.Aliquota is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Aliquota>%s</Aliquota>%s' %
                          (self.gds_format_float(self.Aliquota, input_name='Aliquota'), eol_))
        if self.DescontoIncondicionado is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<DescontoIncondicionado>%s</DescontoIncondicionado>%s' % (
                self.gds_format_float(self.DescontoIncondicionado, input_name='DescontoIncondicionado'), eol_))
        if self.DescontoCondicionado is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<DescontoCondicionado>%s</DescontoCondicionado>%s' % (
                self.gds_format_float(self.DescontoCondicionado, input_name='DescontoCondicionado'), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ValorServicos':
            ...
            # validate type tsValor
            self.validate_tsValor(self.OutrasRetencoes)
        elif nodeName_ == 'ValTotTributos':
            sval_ = child_.text
            try:
                fval_ = float(sval_)
            except (TypeError, ValueError) as exp:
                raise_parse_error(child_, 'requires float or double: %s' % exp)
            fval_ = self.gds_validate_float(fval_, node, 'ValTotTributos')
            self.ValTotTributos = fval_
            # validate type tsValor
            self.validate_tsValor(self.ValTotTributos)
            ...
            try:
                ...
                raise_parse_error(child_, 'requires float or double: %s' % exp)
            fval_ = self.gds_validate_float(
                fval_, node, 'DescontoCondicionado')
            self.DescontoCondicionado = fval_
            # validate type tsValor
            self.validate_tsValor(self.DescontoCondicionado)
# end class tcValoresDeclaracaoServico


class tcValoresNfse(GeneratedsSuper):
    subclass = None
    superclass = None

    def __init__(self, BaseCalculo=None, Aliquota=None, ValorIss=None, ValorLiquidoNfse=None):
        self.original_tagname_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, tcValoresNfse)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if tcValoresNfse.subclass:
            return tcValoresNfse.subclass(*args_, **kwargs_)
        else:
            return tcValoresNfse(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def set_ValorLiquidoNfse(
        self, ValorLiquidoNfse): self.ValorLiquidoNfse = ValorLiquidoNfse
    ...
    def hasContent_(self):
        if (
            ...
            self.Aliquota is not None or
            self.ValorIss is not None or
            self.ValorLiquidoNfse is not None
        ):
            return True
        else:
            return False

    def export(self, outfile, level, namespace_='', name_='tcValoresNfse', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('tcValoresNfse')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcValoresNfse')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcValoresNfse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='tcValoresNfse'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='tcValoresNfse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.BaseCalculo is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<BaseCalculo>%s</BaseCalculo>%s' %
                          (self.gds_format_float(self.BaseCalculo, input_name='BaseCalculo'), eol_))
        if self.Aliquota is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Aliquota>%s</Aliquota>%s' %
                          (self.gds_format_float(self.Aliquota, input_name='Aliquota'), eol_))
        ...
        if self.ValorLiquidoNfse is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ValorLiquidoNfse>%s</ValorLiquidoNfse>%s' % (
                self.gds_format_float(self.ValorLiquidoNfse, input_name='ValorLiquidoNfse'), eol_))
...
class tcDadosServico(GeneratedsSuper):
    ...
    def __init__(self, Valores=None, IssRetido=None, ResponsavelRetencao=None, ItemListaServico=None, CodigoCnae=None, CodigoTributacaoMunicipio=None, CodigoNbs=None, Discriminacao=None, CodigoMunicipio=None, CodigoPais=None, ExigibilidadeISS=None, MunicipioIncidencia=None, NumeroProcesso=None):
        self.original_tagname_ = None
        self.Valores = Valores
        self.IssRetido = IssRetido
        self.validate_tsSimNao(self.IssRetido)
        self.ResponsavelRetencao = ResponsavelRetencao
        self.validate_tsResponsavelRetencao(self.ResponsavelRetencao)
        ...
        self.CodigoNbs = CodigoNbs
        self.validate_tsCodigoNbs(self.CodigoNbs)
        ...
        self.CodigoPais = CodigoPais
        self.validate_tsCodigoPaisBacen(self.CodigoPais)
        self.ExigibilidadeISS = ExigibilidadeISS
        self.validate_tsExigibilidadeISS(self.ExigibilidadeISS)
        self.MunicipioIncidencia = MunicipioIncidencia
        self.validate_tsCodigoMunicipioIbge(self.MunicipioIncidencia)
        self.NumeroProcesso = NumeroProcesso
        self.validate_tsNumeroProcesso(self.NumeroProcesso)
    ...
    def get_ResponsavelRetencao(self): return self.ResponsavelRetencao

    def set_ResponsavelRetencao(
        self, ResponsavelRetencao): self.ResponsavelRetencao = ResponsavelRetencao

    def get_ItemListaServico(self): return self.ItemListaServico

    def set_ItemListaServico(
        self, ItemListaServico): self.ItemListaServico = ItemListaServico

    def get_CodigoCnae(self): return self.CodigoCnae

    def set_CodigoCnae(self, CodigoCnae): self.CodigoCnae = CodigoCnae

    def get_CodigoTributacaoMunicipio(
        self): return self.CodigoTributacaoMunicipio

    def set_CodigoTributacaoMunicipio(
        self, CodigoTributacaoMunicipio): self.CodigoTributacaoMunicipio = CodigoTributacaoMunicipio

    def get_CodigoNbs(self): return self.CodigoNbs

    def set_CodigoNbs(self, CodigoNbs): self.CodigoNbs = CodigoNbs

    def get_Discriminacao(self): return self.Discriminacao

    def set_Discriminacao(
        self, Discriminacao): self.Discriminacao = Discriminacao
    ...
    def get_ExigibilidadeISS(self): return self.ExigibilidadeISS

    def set_ExigibilidadeISS(
        self, ExigibilidadeISS): self.ExigibilidadeISS = ExigibilidadeISS

    def get_MunicipioIncidencia(self): return self.MunicipioIncidencia

    def set_MunicipioIncidencia(
        self, MunicipioIncidencia): self.MunicipioIncidencia = MunicipioIncidencia

    def get_NumeroProcesso(self): return self.NumeroProcesso

    def set_NumeroProcesso(
        self, NumeroProcesso): self.NumeroProcesso = NumeroProcesso
        ...
        if value is not None and Validate_simpletypes_:
            ...
            for enum in enumerations:
                if value == enum:
                    ...
                    break
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on tsItemListaServico' % {
                               "value": value.encode("utf-8")})
    ...
    def validate_tsCodigoCnae(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(str(value)) >= 7:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on tsCodigoCnae' % {
                               "value": value})
    ...
    def validate_tsCodigoTributacao(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 20:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsCodigoTributacao' % {
                               "value": value.encode("utf-8")})
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tsCodigoTributacao' % {
                               "value": value.encode("utf-8")})

    def validate_tsCodigoNbs(self, value):
        # Validate type tsCodigoNbs, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 9:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsCodigoNbs' % {
                               "value": value.encode("utf-8")})
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tsCodigoNbs' % {
                               "value": value.encode("utf-8")})
    ...
    def validate_tsDiscriminacao(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 2000:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsDiscriminacao' % {
                               "value": value.encode("utf-8")})
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tsDiscriminacao' % {
                               "value": value.encode("utf-8")})
    ...
    def validate_tsExigibilidadeISS(self, value):
        # Validate type tsExigibilidadeISS, a restriction on xsd:byte.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_tsExigibilidadeISS_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (
                    value.encode('utf-8'), self.validate_tsExigibilidadeISS_patterns_, ))
    validate_tsExigibilidadeISS_patterns_ = [['^1$|^2$|^3$|^4$|^5$|^6$|^7$']]

    def validate_tsNumeroProcesso(self, value):
        # Validate type tsNumeroProcesso, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 30:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsNumeroProcesso' % {
                               "value": value.encode("utf-8")})
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tsNumeroProcesso' % {
                               "value": value.encode("utf-8")})
    ...
    def hasContent_(self):
        if (
            ...
            self.ResponsavelRetencao is not None or
            self.ItemListaServico is not None or
            self.CodigoCnae is not None or
            self.CodigoTributacaoMunicipio is not None or
            self.CodigoNbs is not None or
            self.Discriminacao is not None or
            self.CodigoMunicipio is not None or
            self.CodigoPais is not None or
            self.ExigibilidadeISS is not None or
            self.MunicipioIncidencia is not None or
            self.NumeroProcesso is not None
        ):
            return True
        else:
            return False
    ...
    def export(self, outfile, level, namespace_='', name_='tcDadosServico', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcDadosServico')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcDadosServico', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tcDadosServico', fromsubclass_=False, pretty_print=True):
        ...
        if self.Valores is not None:
            self.Valores.export(outfile, level, namespace_,
                                name_='Valores', pretty_print=pretty_print)
        if self.IssRetido is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<IssRetido>%s</IssRetido>%s' %
                          (self.gds_format_integer(self.IssRetido, input_name='IssRetido'), eol_))
        if self.ResponsavelRetencao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ResponsavelRetencao>%s</ResponsavelRetencao>%s' % (
                self.gds_format_integer(self.ResponsavelRetencao, input_name='ResponsavelRetencao'), eol_))
        if self.ItemListaServico is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ItemListaServico>%s</ItemListaServico>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.ItemListaServico), input_name='ItemListaServico')), eol_))
        if self.CodigoCnae is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CodigoCnae>%s</CodigoCnae>%s' %
                          (self.gds_format_integer(self.CodigoCnae, input_name='CodigoCnae'), eol_))
        if self.CodigoTributacaoMunicipio is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CodigoTributacaoMunicipio>%s</CodigoTributacaoMunicipio>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.CodigoTributacaoMunicipio), input_name='CodigoTributacaoMunicipio')), eol_))
        if self.CodigoNbs is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CodigoNbs>%s</CodigoNbs>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.CodigoNbs), input_name='CodigoNbs')), eol_))
        if self.Discriminacao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Discriminacao>%s</Discriminacao>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.Discriminacao), input_name='Discriminacao')), eol_))
        if self.CodigoMunicipio is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CodigoMunicipio>%s</CodigoMunicipio>%s' % (
                self.gds_format_integer(self.CodigoMunicipio, input_name='CodigoMunicipio'), eol_))
        if self.CodigoPais is not None:
            ...
            outfile.write('<CodigoPais>%s</CodigoPais>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.CodigoPais), input_name='CodigoPais')), eol_))
        if self.ExigibilidadeISS is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ExigibilidadeISS>%s</ExigibilidadeISS>%s' % (
                self.gds_format_integer(self.ExigibilidadeISS, input_name='ExigibilidadeISS'), eol_))
        if self.MunicipioIncidencia is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<MunicipioIncidencia>%s</MunicipioIncidencia>%s' % (
                self.gds_format_integer(self.MunicipioIncidencia, input_name='MunicipioIncidencia'), eol_))
        if self.NumeroProcesso is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<NumeroProcesso>%s</NumeroProcesso>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.NumeroProcesso), input_name='NumeroProcesso')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Valores':
            obj_ = tcValoresDeclaracaoServico.factory()
            obj_.build(child_)
            self.Valores = obj_
            ...
            self.validate_tsSimNao(self.IssRetido)
        elif nodeName_ == 'ResponsavelRetencao':
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError) as exp:
            ...
            ival_ = self.gds_validate_integer(
                ival_, node, 'ResponsavelRetencao')
            self.ResponsavelRetencao = ival_
            # validate type tsResponsavelRetencao
            self.validate_tsResponsavelRetencao(self.ResponsavelRetencao)
        elif nodeName_ == 'ItemListaServico':
            ItemListaServico_ = child_.text
            ItemListaServico_ = self.gds_validate_string(
                ItemListaServico_, node, 'ItemListaServico')
            ...
            CodigoTributacaoMunicipio_ = self.gds_validate_string(
                CodigoTributacaoMunicipio_, node, 'CodigoTributacaoMunicipio')
            self.CodigoTributacaoMunicipio = CodigoTributacaoMunicipio_
            # validate type tsCodigoTributacao
            self.validate_tsCodigoTributacao(self.CodigoTributacaoMunicipio)
        elif nodeName_ == 'CodigoNbs':
            CodigoNbs_ = child_.text
            CodigoNbs_ = self.gds_validate_string(
                CodigoNbs_, node, 'CodigoNbs')
            self.CodigoNbs = CodigoNbs_
            # validate type tsCodigoNbs
            self.validate_tsCodigoNbs(self.CodigoNbs)
            ...
            # validate type tsCodigoPaisBacen
            self.validate_tsCodigoPaisBacen(self.CodigoPais)
        elif nodeName_ == 'ExigibilidadeISS':
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError) as exp:
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(ival_, node, 'ExigibilidadeISS')
            self.ExigibilidadeISS = ival_
            # validate type tsExigibilidadeISS
            self.validate_tsExigibilidadeISS(self.ExigibilidadeISS)
        elif nodeName_ == 'MunicipioIncidencia':
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError) as exp:
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(
                ival_, node, 'MunicipioIncidencia')
            self.MunicipioIncidencia = ival_
            # validate type tsCodigoMunicipioIbge
            self.validate_tsCodigoMunicipioIbge(self.MunicipioIncidencia)
        elif nodeName_ == 'NumeroProcesso':
            NumeroProcesso_ = child_.text
            NumeroProcesso_ = self.gds_validate_string(
                NumeroProcesso_, node, 'NumeroProcesso')
            self.NumeroProcesso = NumeroProcesso_
            # validate type tsNumeroProcesso
            self.validate_tsNumeroProcesso(self.NumeroProcesso)
...
class tcDadosConstrucaoCivil(GeneratedsSuper):
    ...
    def validate_tsCodigoObra(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 30:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsCodigoObra' % {
                               "value": value.encode("utf-8")})
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tsCodigoObra' % {
                               "value": value.encode("utf-8")})
    ...
    def validate_tsArt(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 30:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsArt' % {
                               "value": value.encode("utf-8")})
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tsArt' % {
                               "value": value.encode("utf-8")})
    ...
    def export(self, outfile, level, namespace_='', name_='tcDadosConstrucaoCivil', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcDadosConstrucaoCivil')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcDadosConstrucaoCivil', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tcDadosConstrucaoCivil', fromsubclass_=False, pretty_print=True):
        ...
        if self.CodigoObra is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CodigoObra>%s</CodigoObra>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.CodigoObra), input_name='CodigoObra')), eol_))
        if self.Art is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Art>%s</Art>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.Art), input_name='Art')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CodigoObra':
            ...
            CodigoObra_ = self.gds_validate_string(
                CodigoObra_, node, 'CodigoObra')
...
class tcDadosPrestador(GeneratedsSuper):
    ...
    def set_IdentificacaoPrestador(
        self, IdentificacaoPrestador): self.IdentificacaoPrestador = IdentificacaoPrestador
    ...
    def validate_tsNomeFantasia(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 60:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsNomeFantasia' % {
                               "value": value.encode("utf-8")})
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tsNomeFantasia' % {
                               "value": value.encode("utf-8")})
    ...
    def export(self, outfile, level, namespace_='', name_='tcDadosPrestador', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcDadosPrestador')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcDadosPrestador', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tcDadosPrestador', fromsubclass_=False, pretty_print=True):
        ...
        if self.IdentificacaoPrestador is not None:
            self.IdentificacaoPrestador.export(
                outfile, level, namespace_, name_='IdentificacaoPrestador', pretty_print=pretty_print)
        if self.RazaoSocial is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RazaoSocial>%s</RazaoSocial>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.RazaoSocial), input_name='RazaoSocial')), eol_))
        if self.NomeFantasia is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<NomeFantasia>%s</NomeFantasia>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.NomeFantasia), input_name='NomeFantasia')), eol_))
        if self.Endereco is not None:
            self.Endereco.export(outfile, level, namespace_,
                                 name_='Endereco', pretty_print=pretty_print)
        if self.Contato is not None:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'IdentificacaoPrestador':
            ...
            NomeFantasia_ = self.gds_validate_string(
                NomeFantasia_, node, 'NomeFantasia')
...
class tcInfRps(GeneratedsSuper):
    ...
    def __init__(self, Id=None, IdentificacaoRps=None, DataEmissao=None, Status=None, RpsSubstituido=None):
        self.original_tagname_ = None
        self.Id = _cast(None, Id)
        self.IdentificacaoRps = IdentificacaoRps
        if isinstance(DataEmissao, BaseStrType_):
            initvalue_ = datetime_.datetime.strptime(
                DataEmissao, '%Y-%m-%d').date()
        else:
    ...
    def set_IdentificacaoRps(
        self, IdentificacaoRps): self.IdentificacaoRps = IdentificacaoRps
    ...
    def set_RpsSubstituido(
        self, RpsSubstituido): self.RpsSubstituido = RpsSubstituido
    ...
    def validate_tsStatusRps(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (
                    value.encode('utf-8'), self.validate_tsStatusRps_patterns_, ))
    ...
    def validate_tsIdTag(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 255:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsIdTag' % {
                               "value": value.encode("utf-8")})
    ...
    def hasContent_(self):
        if (
            ...
            self.RpsSubstituido is not None
        ):
            return True
        else:
            return False
    ...
    def export(self, outfile, level, namespace_='', name_='tcInfRps', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_='tcInfRps')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcInfRps', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tcInfRps', fromsubclass_=False, pretty_print=True):
        ...
        if self.IdentificacaoRps is not None:
            self.IdentificacaoRps.export(
                outfile, level, namespace_, name_='IdentificacaoRps', pretty_print=pretty_print)
        if self.DataEmissao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<DataEmissao>%s</DataEmissao>%s' %
                          (self.gds_format_date(self.DataEmissao, input_name='DataEmissao'), eol_))
        if self.Status is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Status>%s</Status>%s' %
                          (self.gds_format_integer(self.Status, input_name='Status'), eol_))
        if self.RpsSubstituido is not None:
            self.RpsSubstituido.export(
                outfile, level, namespace_, name_='RpsSubstituido', pretty_print=pretty_print)
...
class tcInfDeclaracaoPrestacaoServico(GeneratedsSuper):
    subclass = None
    superclass = None

    def __init__(self, Id=None, Rps=None, Competencia=None, Servico=None, Prestador=None, Tomador=None, Intermediario=None, ConstrucaoCivil=None, RegimeEspecialTributacao=None, OptanteSimplesNacional=None, IncentivoFiscal=None):
        self.original_tagname_ = None
        self.Id = _cast(None, Id)
        self.Rps = Rps
        ...
        self.IncentivoFiscal = IncentivoFiscal
        self.validate_tsSimNao(self.IncentivoFiscal)

    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, tcInfDeclaracaoPrestacaoServico)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if tcInfDeclaracaoPrestacaoServico.subclass:
            return tcInfDeclaracaoPrestacaoServico.subclass(*args_, **kwargs_)
        else:
            return tcInfDeclaracaoPrestacaoServico(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def get_Intermediario(self): return self.Intermediario

    def set_Intermediario(
        self, Intermediario): self.Intermediario = Intermediario

    def get_ConstrucaoCivil(self): return self.ConstrucaoCivil

    def set_ConstrucaoCivil(
        self, ConstrucaoCivil): self.ConstrucaoCivil = ConstrucaoCivil

    def get_RegimeEspecialTributacao(
        self): return self.RegimeEspecialTributacao

    def set_RegimeEspecialTributacao(
        self, RegimeEspecialTributacao): self.RegimeEspecialTributacao = RegimeEspecialTributacao

    def get_OptanteSimplesNacional(self): return self.OptanteSimplesNacional

    def set_OptanteSimplesNacional(
        self, OptanteSimplesNacional): self.OptanteSimplesNacional = OptanteSimplesNacional

    def get_IncentivoFiscal(self): return self.IncentivoFiscal

    def set_IncentivoFiscal(
        self, IncentivoFiscal): self.IncentivoFiscal = IncentivoFiscal
    ...
    def validate_tsRegimeEspecialTributacao(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (
                    value.encode('utf-8'), self.validate_tsRegimeEspecialTributacao_patterns_, ))
    validate_tsRegimeEspecialTributacao_patterns_ = [
        ['^1$|^2$|^3$|^4$|^5$|^6$']]
    ...
    def hasContent_(self):
        if (
            ...
            self.Intermediario is not None or
            self.ConstrucaoCivil is not None or
            self.RegimeEspecialTributacao is not None or
            self.OptanteSimplesNacional is not None or
            self.IncentivoFiscal is not None
        ):
            return True
        else:
            return False

    def export(self, outfile, level, namespace_='', name_='tcInfDeclaracaoPrestacaoServico', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get(
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcInfDeclaracaoPrestacaoServico')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcInfDeclaracaoPrestacaoServico', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='tcInfDeclaracaoPrestacaoServico'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (quote_attrib(self.Id), ))

    def exportChildren(self, outfile, level, namespace_='', name_='tcInfDeclaracaoPrestacaoServico', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Rps is not None:
            self.Rps.export(outfile, level, namespace_,
                            name_='Rps', pretty_print=pretty_print)
        if self.Competencia is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Competencia>%s</Competencia>%s' %
                          (self.gds_format_date(self.Competencia, input_name='Competencia'), eol_))
        if self.Servico is not None:
            self.Servico.export(outfile, level, namespace_,
                                name_='Servico', pretty_print=pretty_print)
        if self.Prestador is not None:
            self.Prestador.export(outfile, level, namespace_,
                                  name_='Prestador', pretty_print=pretty_print)
        if self.Tomador is not None:
            self.Tomador.export(outfile, level, namespace_,
                                name_='Tomador', pretty_print=pretty_print)
        if self.Intermediario is not None:
            self.Intermediario.export(
                outfile, level, namespace_, name_='Intermediario', pretty_print=pretty_print)
        if self.ConstrucaoCivil is not None:
            self.ConstrucaoCivil.export(
                outfile, level, namespace_, name_='ConstrucaoCivil', pretty_print=pretty_print)
        if self.RegimeEspecialTributacao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<RegimeEspecialTributacao>%s</RegimeEspecialTributacao>%s' % (
                self.gds_format_integer(self.RegimeEspecialTributacao, input_name='RegimeEspecialTributacao'), eol_))
        if self.OptanteSimplesNacional is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<OptanteSimplesNacional>%s</OptanteSimplesNacional>%s' % (
                self.gds_format_integer(self.OptanteSimplesNacional, input_name='OptanteSimplesNacional'), eol_))
        if self.IncentivoFiscal is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<IncentivoFiscal>%s</IncentivoFiscal>%s' % (
                self.gds_format_integer(self.IncentivoFiscal, input_name='IncentivoFiscal'), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Rps':
        ...
        elif nodeName_ == 'Intermediario':
            obj_ = tcDadosIntermediario.factory()
            obj_.build(child_)
            self.Intermediario = obj_
            obj_.original_tagname_ = 'Intermediario'
            ...
            try:
                ...
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(
                ival_, node, 'RegimeEspecialTributacao')
            self.RegimeEspecialTributacao = ival_
            # validate type tsRegimeEspecialTributacao
            self.validate_tsRegimeEspecialTributacao(
            ...
            try:
                ...
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(
                ival_, node, 'OptanteSimplesNacional')
            self.OptanteSimplesNacional = ival_
            # validate type tsSimNao
            self.validate_tsSimNao(self.OptanteSimplesNacional)
        elif nodeName_ == 'IncentivoFiscal':
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError) as exp:
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(ival_, node, 'IncentivoFiscal')
            self.IncentivoFiscal = ival_
            # validate type tsSimNao
            self.validate_tsSimNao(self.IncentivoFiscal)
# end class tcInfDeclaracaoPrestacaoServico


class tcDeclaracaoPrestacaoServico(GeneratedsSuper):
    subclass = None
    superclass = None

    def __init__(self, InfDeclaracaoPrestacaoServico=None, Signature=None):
        self.original_tagname_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, tcDeclaracaoPrestacaoServico)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if tcDeclaracaoPrestacaoServico.subclass:
            return tcDeclaracaoPrestacaoServico.subclass(*args_, **kwargs_)
        else:
            return tcDeclaracaoPrestacaoServico(*args_, **kwargs_)
    factory = staticmethod(factory)

    def get_InfDeclaracaoPrestacaoServico(
        self): return self.InfDeclaracaoPrestacaoServico

    def set_InfDeclaracaoPrestacaoServico(
        self, InfDeclaracaoPrestacaoServico): self.InfDeclaracaoPrestacaoServico = InfDeclaracaoPrestacaoServico
    ...
    def hasContent_(self):
        if (
            self.InfDeclaracaoPrestacaoServico is not None or
    ...
    def export(self, outfile, level, namespace_='', name_='tcDeclaracaoPrestacaoServico', namespacedef_=' xmlns:dsig="http://www.w3.org/2000/09/xmldsig#" ', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get(
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcDeclaracaoPrestacaoServico')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcDeclaracaoPrestacaoServico', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='tcDeclaracaoPrestacaoServico'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='tcDeclaracaoPrestacaoServico', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.InfDeclaracaoPrestacaoServico is not None:
            self.InfDeclaracaoPrestacaoServico.export(
                outfile, level, namespace_, name_='InfDeclaracaoPrestacaoServico', pretty_print=pretty_print)
        if self.Signature is not None:
            self.Signature.export(
                outfile, level, namespace_='dsig:', name_='Signature', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'InfDeclaracaoPrestacaoServico':
            obj_ = tcInfDeclaracaoPrestacaoServico.factory()
            obj_.build(child_)
            self.InfDeclaracaoPrestacaoServico = obj_
            obj_.original_tagname_ = 'InfDeclaracaoPrestacaoServico'
        elif nodeName_ == 'Signature':
            obj_ = SignatureType.factory()
            obj_.build(child_)
            self.Signature = obj_
            obj_.original_tagname_ = 'Signature'
# end class tcDeclaracaoPrestacaoServico
...
class tcIdentificacaoNfse(GeneratedsSuper):
    ...
    def __init__(self, Numero=None, CpfCnpj=None, InscricaoMunicipal=None, CodigoMunicipio=None):
        self.original_tagname_ = None
        self.Numero = Numero
    ...
    def validate_tsNumeroNfse(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(str(value)) >= 15:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on tsNumeroNfse' % {
                               "value": value})
    ...
    def export(self, outfile, level, namespace_='', name_='tcIdentificacaoNfse', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcIdentificacaoNfse')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcIdentificacaoNfse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class tcInfNfse(GeneratedsSuper):
    ...
    def __init__(self, Id=None, Numero=None, CodigoVerificacao=None, DataEmissao=None, NfseSubstituida=None, OutrasInformacoes=None, ValoresNfse=None, ValorCredito=None, PrestadorServico=None, OrgaoGerador=None, DeclaracaoPrestacaoServico=None):
        self.original_tagname_ = None
        self.Id = _cast(None, Id)
        self.Numero = Numero
        self.validate_tsNumeroNfse(self.Numero)
        ...
        self.DeclaracaoPrestacaoServico = DeclaracaoPrestacaoServico
    ...
    def set_CodigoVerificacao(
        self, CodigoVerificacao): self.CodigoVerificacao = CodigoVerificacao
    ...
    def set_NfseSubstituida(
        self, NfseSubstituida): self.NfseSubstituida = NfseSubstituida

    def get_OutrasInformacoes(self): return self.OutrasInformacoes

    def set_OutrasInformacoes(
        self, OutrasInformacoes): self.OutrasInformacoes = OutrasInformacoes

    def get_ValoresNfse(self): return self.ValoresNfse

    def set_ValoresNfse(self, ValoresNfse): self.ValoresNfse = ValoresNfse
    ...
    def set_PrestadorServico(
        self, PrestadorServico): self.PrestadorServico = PrestadorServico

    def get_OrgaoGerador(self): return self.OrgaoGerador

    def set_OrgaoGerador(self, OrgaoGerador): self.OrgaoGerador = OrgaoGerador

    def get_DeclaracaoPrestacaoServico(
        self): return self.DeclaracaoPrestacaoServico

    def set_DeclaracaoPrestacaoServico(
        self, DeclaracaoPrestacaoServico): self.DeclaracaoPrestacaoServico = DeclaracaoPrestacaoServico
    ...
    def validate_tsCodigoVerificacao(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 9:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsCodigoVerificacao' % {
                               "value": value.encode("utf-8")})
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tsCodigoVerificacao' % {
                               "value": value.encode("utf-8")})
            if not self.gds_validate_simple_patterns(
                    self.validate_tsCodigoVerificacao_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (
                    value.encode('utf-8'), self.validate_tsCodigoVerificacao_patterns_, ))
    validate_tsCodigoVerificacao_patterns_ = [['^[a-zA-Z0-9]{1,9}$']]

    def validate_tsOutrasInformacoes(self, value):
        # Validate type tsOutrasInformacoes, a restriction on xsd:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 255:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsOutrasInformacoes' % {
                               "value": value.encode("utf-8")})
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tsOutrasInformacoes' % {
                               "value": value.encode("utf-8")})
    ...
    def export(self, outfile, level, namespace_='', name_='tcInfNfse', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_='tcInfNfse')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcInfNfse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tcInfNfse', fromsubclass_=False, pretty_print=True):
        ...
        if self.CodigoVerificacao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CodigoVerificacao>%s</CodigoVerificacao>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.CodigoVerificacao), input_name='CodigoVerificacao')), eol_))
        if self.DataEmissao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<DataEmissao>%s</DataEmissao>%s' %
                          (self.gds_format_datetime(self.DataEmissao, input_name='DataEmissao'), eol_))
        if self.NfseSubstituida is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<NfseSubstituida>%s</NfseSubstituida>%s' % (
                self.gds_format_integer(self.NfseSubstituida, input_name='NfseSubstituida'), eol_))
        if self.OutrasInformacoes is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<OutrasInformacoes>%s</OutrasInformacoes>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.OutrasInformacoes), input_name='OutrasInformacoes')), eol_))
        if self.ValoresNfse is not None:
            self.ValoresNfse.export(
                outfile, level, namespace_, name_='ValoresNfse', pretty_print=pretty_print)
        if self.ValorCredito is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ValorCredito>%s</ValorCredito>%s' %
                          (self.gds_format_float(self.ValorCredito, input_name='ValorCredito'), eol_))
        if self.PrestadorServico is not None:
            self.PrestadorServico.export(
                outfile, level, namespace_, name_='PrestadorServico', pretty_print=pretty_print)
        if self.OrgaoGerador is not None:
            self.OrgaoGerador.export(
                outfile, level, namespace_, name_='OrgaoGerador', pretty_print=pretty_print)
        if self.DeclaracaoPrestacaoServico is not None:
            self.DeclaracaoPrestacaoServico.export(
                outfile, level, namespace_, name_='DeclaracaoPrestacaoServico', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Numero':
            ...
            CodigoVerificacao_ = self.gds_validate_string(
                CodigoVerificacao_, node, 'CodigoVerificacao')
            ...
            OutrasInformacoes_ = self.gds_validate_string(
                OutrasInformacoes_, node, 'OutrasInformacoes')
            self.OutrasInformacoes = OutrasInformacoes_
            # validate type tsOutrasInformacoes
            self.validate_tsOutrasInformacoes(self.OutrasInformacoes)
        elif nodeName_ == 'ValoresNfse':
            obj_ = tcValoresNfse.factory()
            obj_.build(child_)
            self.ValoresNfse = obj_
            obj_.original_tagname_ = 'ValoresNfse'
        ...
        elif nodeName_ == 'DeclaracaoPrestacaoServico':
            obj_ = tcDeclaracaoPrestacaoServico.factory()
            obj_.build(child_)
            self.DeclaracaoPrestacaoServico = obj_
            obj_.original_tagname_ = 'DeclaracaoPrestacaoServico'
# end class tcInfNfse
...
class tcNfse(GeneratedsSuper):
    ...
    def __init__(self, versao=None, InfNfse=None, Signature=None):
        self.original_tagname_ = None
    ...
    def validate_tsVersao(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (
                    value.encode('utf-8'), self.validate_tsVersao_patterns_, ))
    ...
    def export(self, outfile, level, namespace_='', name_='tcNfse', namespacedef_=' xmlns:dsig="http://www.w3.org/2000/09/xmldsig#" ', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_='tcNfse')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcNfse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tcNfse', fromsubclass_=False, pretty_print=True):
        ...
        if self.InfNfse is not None:
            self.InfNfse.export(outfile, level, namespace_,
                                name_='InfNfse', pretty_print=pretty_print)
        if self.Signature is not None:
            self.Signature.export(
                outfile, level, namespace_='dsig:', name_='Signature', pretty_print=pretty_print)
...
class tcInfPedidoCancelamento(GeneratedsSuper):
    ...
    def set_IdentificacaoNfse(
        self, IdentificacaoNfse): self.IdentificacaoNfse = IdentificacaoNfse

    def get_CodigoCancelamento(self): return self.CodigoCancelamento

    def set_CodigoCancelamento(
        self, CodigoCancelamento): self.CodigoCancelamento = CodigoCancelamento
    ...
    def validate_tsCodigoCancelamentoNfse(self, value):
        # Validate type tsCodigoCancelamentoNfse, a restriction on xsd:byte.
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                    self.validate_tsCodigoCancelamentoNfse_patterns_, value):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (
                    value.encode('utf-8'), self.validate_tsCodigoCancelamentoNfse_patterns_, ))
    validate_tsCodigoCancelamentoNfse_patterns_ = [['^1$|^2$|^3$|^4$|^5$']]
    ...
    def export(self, outfile, level, namespace_='', name_='tcInfPedidoCancelamento', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcInfPedidoCancelamento')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcInfPedidoCancelamento', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tcInfPedidoCancelamento', fromsubclass_=False, pretty_print=True):
        ...
        if self.IdentificacaoNfse is not None:
            self.IdentificacaoNfse.export(
                outfile, level, namespace_, name_='IdentificacaoNfse', pretty_print=pretty_print)
        if self.CodigoCancelamento is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<CodigoCancelamento>%s</CodigoCancelamento>%s' % (
                self.gds_format_integer(self.CodigoCancelamento, input_name='CodigoCancelamento'), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'IdentificacaoNfse':
            ...
            try:
                ...
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(
                ival_, node, 'CodigoCancelamento')
            self.CodigoCancelamento = ival_
...
class tcPedidoCancelamento(GeneratedsSuper):
    ...
    def set_InfPedidoCancelamento(
        self, InfPedidoCancelamento): self.InfPedidoCancelamento = InfPedidoCancelamento
    ...
    def export(self, outfile, level, namespace_='', name_='tcPedidoCancelamento', namespacedef_=' xmlns:dsig="http://www.w3.org/2000/09/xmldsig#" ', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcPedidoCancelamento')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcPedidoCancelamento', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tcPedidoCancelamento', fromsubclass_=False, pretty_print=True):
        ...
        if self.InfPedidoCancelamento is not None:
            self.InfPedidoCancelamento.export(
                outfile, level, namespace_, name_='InfPedidoCancelamento', pretty_print=pretty_print)
        if self.Signature is not None:
            self.Signature.export(
                outfile, level, namespace_='dsig:', name_='Signature', pretty_print=pretty_print)
...
class tcConfirmacaoCancelamento(GeneratedsSuper):
    ...
    def __init__(self, Id=None, Pedido=None, DataHora=None):
        self.original_tagname_ = None
        self.Id = _cast(None, Id)
        self.Pedido = Pedido
        if isinstance(DataHora, BaseStrType_):
            initvalue_ = datetime_.datetime.strptime(
                DataHora, '%Y-%m-%dT%H:%M:%S')
        else:
            initvalue_ = DataHora
    ...
    def export(self, outfile, level, namespace_='', name_='tcConfirmacaoCancelamento', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcConfirmacaoCancelamento')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcConfirmacaoCancelamento', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tcConfirmacaoCancelamento', fromsubclass_=False, pretty_print=True):
        ...
        if self.Pedido is not None:
            self.Pedido.export(outfile, level, namespace_,
                               name_='Pedido', pretty_print=pretty_print)
        if self.DataHora is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<DataHora>%s</DataHora>%s' %
                          (self.gds_format_datetime(self.DataHora, input_name='DataHora'), eol_))
...
class tcCancelamentoNfse(GeneratedsSuper):
    ...
    def __init__(self, versao=None, Confirmacao=None, Signature=None):
        self.original_tagname_ = None
        self.versao = _cast(None, versao)
    ...
    def export(self, outfile, level, namespace_='', name_='tcCancelamentoNfse', namespacedef_=' xmlns:dsig="http://www.w3.org/2000/09/xmldsig#" ', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcCancelamentoNfse')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcCancelamentoNfse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tcCancelamentoNfse', fromsubclass_=False, pretty_print=True):
        ...
        if self.Confirmacao is not None:
            self.Confirmacao.export(
                outfile, level, namespace_, name_='Confirmacao', pretty_print=pretty_print)
        if self.Signature is not None:
            self.Signature.export(
                outfile, level, namespace_='dsig:', name_='Signature', pretty_print=pretty_print)
...
class tcRetCancelamento(GeneratedsSuper):
    subclass = None
    superclass = None

    def __init__(self, NfseCancelamento=None):
        self.original_tagname_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, tcRetCancelamento)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if tcRetCancelamento.subclass:
            return tcRetCancelamento.subclass(*args_, **kwargs_)
        else:
            return tcRetCancelamento(*args_, **kwargs_)
    factory = staticmethod(factory)

    def get_NfseCancelamento(self): return self.NfseCancelamento

    def set_NfseCancelamento(
        self, NfseCancelamento): self.NfseCancelamento = NfseCancelamento

    def hasContent_(self):
        if (
            self.NfseCancelamento is not None
        ):
            return True
        else:
            return False

    def export(self, outfile, level, namespace_='', name_='tcRetCancelamento', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('tcRetCancelamento')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcRetCancelamento')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcRetCancelamento', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='tcRetCancelamento'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='tcRetCancelamento', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.NfseCancelamento is not None:
            self.NfseCancelamento.export(
                outfile, level, namespace_, name_='NfseCancelamento', pretty_print=pretty_print)
...
class tcInfSubstituicaoNfse(GeneratedsSuper):
    ...
    def set_NfseSubstituidora(
        self, NfseSubstituidora): self.NfseSubstituidora = NfseSubstituidora
    ...
    def export(self, outfile, level, namespace_='', name_='tcInfSubstituicaoNfse', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcInfSubstituicaoNfse')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcInfSubstituicaoNfse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tcInfSubstituicaoNfse', fromsubclass_=False, pretty_print=True):
        ...
        if self.NfseSubstituidora is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<NfseSubstituidora>%s</NfseSubstituidora>%s' % (
                self.gds_format_integer(self.NfseSubstituidora, input_name='NfseSubstituidora'), eol_))
...
class tcSubstituicaoNfse(GeneratedsSuper):
    ...
    def __init__(self, versao=None, SubstituicaoNfse=None, Signature=None):
        self.original_tagname_ = None
        self.versao = _cast(None, versao)
    ...
    def set_SubstituicaoNfse(
        self, SubstituicaoNfse): self.SubstituicaoNfse = SubstituicaoNfse
    ...
    def insert_Signature_at(
        self, index, value): self.Signature.insert(index, value)
    ...
    def export(self, outfile, level, namespace_='', name_='tcSubstituicaoNfse', namespacedef_=' xmlns:dsig="http://www.w3.org/2000/09/xmldsig#" ', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcSubstituicaoNfse')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcSubstituicaoNfse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tcSubstituicaoNfse', fromsubclass_=False, pretty_print=True):
        ...
        if self.SubstituicaoNfse is not None:
            self.SubstituicaoNfse.export(
                outfile, level, namespace_, name_='SubstituicaoNfse', pretty_print=pretty_print)
        for Signature_ in self.Signature:
            Signature_.export(outfile, level, namespace_='dsig:',
                              name_='Signature', pretty_print=pretty_print)
...
class tcCompNfse(GeneratedsSuper):
    ...
    def set_NfseSubstituicao(
        self, NfseSubstituicao): self.NfseSubstituicao = NfseSubstituicao
    ...
    def export(self, outfile, level, namespace_='', name_='tcCompNfse', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_='tcCompNfse')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcCompNfse', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tcCompNfse', fromsubclass_=False, pretty_print=True):
        ...
        if self.Nfse is not None:
            self.Nfse.export(outfile, level, namespace_,
                             name_='Nfse', pretty_print=pretty_print)
        if self.NfseCancelamento is not None:
            self.NfseCancelamento.export(
                outfile, level, namespace_, name_='NfseCancelamento', pretty_print=pretty_print)
        if self.NfseSubstituicao is not None:
            self.NfseSubstituicao.export(
                outfile, level, namespace_, name_='NfseSubstituicao', pretty_print=pretty_print)
...
class tcMensagemRetorno(GeneratedsSuper):
    ...
    def validate_tsCodigoMensagemAlerta(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 4:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsCodigoMensagemAlerta' % {
                               "value": value.encode("utf-8")})
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tsCodigoMensagemAlerta' % {
                               "value": value.encode("utf-8")})
    ...
    def validate_tsDescricaoMensagemAlerta(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 200:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsDescricaoMensagemAlerta' % {
                               "value": value.encode("utf-8")})
            if len(value) < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tsDescricaoMensagemAlerta' % {
                               "value": value.encode("utf-8")})
    ...
    def export(self, outfile, level, namespace_='', name_='tcMensagemRetorno', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcMensagemRetorno')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcMensagemRetorno', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tcMensagemRetorno', fromsubclass_=False, pretty_print=True):
        ...
        if self.Codigo is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Codigo>%s</Codigo>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.Codigo), input_name='Codigo')), eol_))
        if self.Mensagem is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Mensagem>%s</Mensagem>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.Mensagem), input_name='Mensagem')), eol_))
        if self.Correcao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Correcao>%s</Correcao>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.Correcao), input_name='Correcao')), eol_))
...
class tcMensagemRetornoLote(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='tcMensagemRetornoLote', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='tcMensagemRetornoLote')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcMensagemRetornoLote', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class tcLoteRps(GeneratedsSuper):
    ...
    def __init__(self, Id=None, versao=None, NumeroLote=None, CpfCnpj=None, InscricaoMunicipal=None, QuantidadeRps=None, ListaRps=None):
        self.original_tagname_ = None
        self.Id = _cast(None, Id)
        self.versao = _cast(None, versao)
    ...
    def set_QuantidadeRps(
        self, QuantidadeRps): self.QuantidadeRps = QuantidadeRps
    ...
    def validate_tsNumeroLote(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(str(value)) >= 15:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on tsNumeroLote' % {
                               "value": value})
    ...
    def export(self, outfile, level, namespace_='', name_='tcLoteRps', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_='tcLoteRps')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='tcLoteRps', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tcLoteRps', fromsubclass_=False, pretty_print=True):
        ...
        if self.NumeroLote is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<NumeroLote>%s</NumeroLote>%s' %
                          (self.gds_format_integer(self.NumeroLote, input_name='NumeroLote'), eol_))
        if self.CpfCnpj is not None:
            self.CpfCnpj.export(outfile, level, namespace_,
                                name_='CpfCnpj', pretty_print=pretty_print)
        if self.InscricaoMunicipal is not None:
        ...
        if self.QuantidadeRps is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<QuantidadeRps>%s</QuantidadeRps>%s' % (
                self.gds_format_integer(self.QuantidadeRps, input_name='QuantidadeRps'), eol_))
        if self.ListaRps is not None:
            self.ListaRps.export(outfile, level, namespace_,
                                 name_='ListaRps', pretty_print=pretty_print)
...
class ListaMensagemRetornoLote(GeneratedsSuper):
    ...
    def set_MensagemRetorno(
        self, MensagemRetorno): self.MensagemRetorno = MensagemRetorno

    def add_MensagemRetorno(self, value): self.MensagemRetorno.append(value)

    def insert_MensagemRetorno_at(
        self, index, value): self.MensagemRetorno.insert(index, value)

    def replace_MensagemRetorno_at(
        self, index, value): self.MensagemRetorno[index] = value
    ...
    def export(self, outfile, level, namespace_='', name_='ListaMensagemRetornoLote', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get(
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='ListaMensagemRetornoLote')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ListaMensagemRetornoLote', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ListaMensagemRetornoLote'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='ListaMensagemRetornoLote', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for MensagemRetorno_ in self.MensagemRetorno:
            MensagemRetorno_.export(
                outfile, level, namespace_, name_='MensagemRetorno', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'MensagemRetorno':
            obj_ = tcMensagemRetornoLote.factory()
            obj_.build(child_)
...
class ListaMensagemRetorno(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='ListaMensagemRetorno', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='ListaMensagemRetorno')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ListaMensagemRetorno', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class ListaMensagemAlertaRetorno(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ListaMensagemAlertaRetorno)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ListaMensagemAlertaRetorno.subclass:
            return ListaMensagemAlertaRetorno.subclass(*args_, **kwargs_)
        else:
            return ListaMensagemAlertaRetorno(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, namespace_='', name_='ListaMensagemAlertaRetorno', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get(
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='ListaMensagemAlertaRetorno')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ListaMensagemAlertaRetorno', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ListaMensagemAlertaRetorno'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='ListaMensagemAlertaRetorno', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'MensagemRetorno':
            ...
            self.MensagemRetorno.append(obj_)
            obj_.original_tagname_ = 'MensagemRetorno'
# end class ListaMensagemAlertaRetorno
...
class cabecalho(GeneratedsSuper):
    ...
    def __init__(self, versao=None, versaoDados=None):
        self.original_tagname_ = None
        self.versao = _cast(None, versao)
    ...
    def get_versaoDados(self): return self.versaoDados

    def set_versaoDados(self, versaoDados): self.versaoDados = versaoDados
    ...
    def export(self, outfile, level, namespace_='', name_='cabecalho', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_='cabecalho')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='cabecalho', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='cabecalho'):
        if self.versao is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            outfile.write(' versao=%s' % (quote_attrib(self.versao), ))

    def exportChildren(self, outfile, level, namespace_='', name_='cabecalho', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.versaoDados is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<versaoDados>%s</versaoDados>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.versaoDados), input_name='versaoDados')), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'versaoDados':
            ...
            if versaoDados_:
                versaoDados_ = re_.sub(
                    String_cleanup_pat_, " ", versaoDados_).strip()
            else:
                versaoDados_ = ""
            versaoDados_ = self.gds_validate_string(
                versaoDados_, node, 'versaoDados')
...
class EnviarLoteRpsEnvio(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='EnviarLoteRpsEnvio', namespacedef_=' xmlns:dsig="http://www.w3.org/2000/09/xmldsig#" ', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='EnviarLoteRpsEnvio')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='EnviarLoteRpsEnvio', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='EnviarLoteRpsEnvio', fromsubclass_=False, pretty_print=True):
        ...
        if self.LoteRps is not None:
            self.LoteRps.export(outfile, level, namespace_,
                                name_='LoteRps', pretty_print=pretty_print)
        if self.Signature is not None:
            self.Signature.export(
                outfile, level, namespace_='dsig:', name_='Signature', pretty_print=pretty_print)
...
class EnviarLoteRpsResposta(GeneratedsSuper):
    ...
    def set_DataRecebimento(
        self, DataRecebimento): self.DataRecebimento = DataRecebimento
    ...
    def set_ListaMensagemRetorno(
        self, ListaMensagemRetorno): self.ListaMensagemRetorno = ListaMensagemRetorno
    ...
    def validate_tsNumeroProtocolo(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(value) > 50:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tsNumeroProtocolo' % {
                               "value": value.encode("utf-8")})
    ...
    def export(self, outfile, level, namespace_='', name_='EnviarLoteRpsResposta', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='EnviarLoteRpsResposta')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='EnviarLoteRpsResposta', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='EnviarLoteRpsResposta', fromsubclass_=False, pretty_print=True):
        ...
        if self.DataRecebimento is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<DataRecebimento>%s</DataRecebimento>%s' % (
                self.gds_format_datetime(self.DataRecebimento, input_name='DataRecebimento'), eol_))
        if self.Protocolo is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Protocolo>%s</Protocolo>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.Protocolo), input_name='Protocolo')), eol_))
        if self.ListaMensagemRetorno is not None:
            self.ListaMensagemRetorno.export(
                outfile, level, namespace_, name_='ListaMensagemRetorno', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'NumeroLote':
            ...
            Protocolo_ = self.gds_validate_string(
                Protocolo_, node, 'Protocolo')
...
class EnviarLoteRpsSincronoEnvio(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, EnviarLoteRpsSincronoEnvio)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if EnviarLoteRpsSincronoEnvio.subclass:
            return EnviarLoteRpsSincronoEnvio.subclass(*args_, **kwargs_)
        else:
            return EnviarLoteRpsSincronoEnvio(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, namespace_='', name_='EnviarLoteRpsSincronoEnvio', namespacedef_=' xmlns:dsig="http://www.w3.org/2000/09/xmldsig#" ', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get(
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='EnviarLoteRpsSincronoEnvio')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='EnviarLoteRpsSincronoEnvio', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='EnviarLoteRpsSincronoEnvio'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='EnviarLoteRpsSincronoEnvio', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'LoteRps':
            ...
            self.Signature = obj_
            obj_.original_tagname_ = 'Signature'
# end class EnviarLoteRpsSincronoEnvio


class EnviarLoteRpsSincronoResposta(GeneratedsSuper):
    subclass = None
    superclass = None

    def __init__(self, NumeroLote=None, DataRecebimento=None, Protocolo=None, ListaNfse=None, ListaMensagemRetorno=None, ListaMensagemRetornoLote=None):
        self.original_tagname_ = None
        self.NumeroLote = NumeroLote
        self.validate_tsNumeroLote(self.NumeroLote)
        if isinstance(DataRecebimento, BaseStrType_):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, EnviarLoteRpsSincronoResposta)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if EnviarLoteRpsSincronoResposta.subclass:
            return EnviarLoteRpsSincronoResposta.subclass(*args_, **kwargs_)
        else:
            return EnviarLoteRpsSincronoResposta(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def get_ListaMensagemRetornoLote(
        self): return self.ListaMensagemRetornoLote

    def set_ListaMensagemRetornoLote(
        self, ListaMensagemRetornoLote): self.ListaMensagemRetornoLote = ListaMensagemRetornoLote
    ...
    def export(self, outfile, level, namespace_='', name_='EnviarLoteRpsSincronoResposta', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get(
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='EnviarLoteRpsSincronoResposta')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='EnviarLoteRpsSincronoResposta', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='EnviarLoteRpsSincronoResposta'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='EnviarLoteRpsSincronoResposta', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.ListaNfse is not None:
            self.ListaNfse.export(outfile, level, namespace_,
                                  name_='ListaNfse', pretty_print=pretty_print)
        if self.ListaMensagemRetorno is not None:
            self.ListaMensagemRetorno.export(
                outfile, level, namespace_, name_='ListaMensagemRetorno', pretty_print=pretty_print)
        if self.ListaMensagemRetornoLote is not None:
            self.ListaMensagemRetornoLote.export(
                outfile, level, namespace_, name_='ListaMensagemRetornoLote', pretty_print=pretty_print)
...
class GerarNfseEnvio(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, GerarNfseEnvio)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(self, outfile, level, namespace_='', name_='GerarNfseEnvio', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('GerarNfseEnvio')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='GerarNfseEnvio')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='GerarNfseEnvio', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class GerarNfseResposta(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, GerarNfseResposta)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def export(self, outfile, level, namespace_='', name_='GerarNfseResposta', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('GerarNfseResposta')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='GerarNfseResposta')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='GerarNfseResposta', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class CancelarNfseEnvio(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='CancelarNfseEnvio', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='CancelarNfseEnvio')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='CancelarNfseEnvio', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class CancelarNfseResposta(GeneratedsSuper):
    ...
    def __init__(self, RetCancelamento=None, ListaMensagemRetorno=None):
        self.original_tagname_ = None
    ...
    def get_RetCancelamento(self): return self.RetCancelamento

    def set_RetCancelamento(
        self, RetCancelamento): self.RetCancelamento = RetCancelamento
    ...
    def export(self, outfile, level, namespace_='', name_='CancelarNfseResposta', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='CancelarNfseResposta')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='CancelarNfseResposta', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='CancelarNfseResposta', fromsubclass_=False, pretty_print=True):
        ...
        if self.RetCancelamento is not None:
            self.RetCancelamento.export(
                outfile, level, namespace_, name_='RetCancelamento', pretty_print=pretty_print)
        if self.ListaMensagemRetorno is not None:
            self.ListaMensagemRetorno.export(
                outfile, level, namespace_, name_='ListaMensagemRetorno', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'RetCancelamento':
            obj_ = tcRetCancelamento.factory()
            obj_.build(child_)
...
class SubstituirNfseEnvio(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, SubstituirNfseEnvio)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if SubstituirNfseEnvio.subclass:
            return SubstituirNfseEnvio.subclass(*args_, **kwargs_)
        else:
            return SubstituirNfseEnvio(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, namespace_='', name_='SubstituirNfseEnvio', namespacedef_=' xmlns:dsig="http://www.w3.org/2000/09/xmldsig#" ', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('SubstituirNfseEnvio')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='SubstituirNfseEnvio')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='SubstituirNfseEnvio', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='SubstituirNfseEnvio'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='SubstituirNfseEnvio', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'SubstituicaoNfse':
            obj_ = SubstituicaoNfseType.factory()
            obj_.build(child_)
            self.SubstituicaoNfse = obj_
            obj_.original_tagname_ = 'SubstituicaoNfse'
        elif nodeName_ == 'Signature':
            ...
            self.Signature = obj_
            obj_.original_tagname_ = 'Signature'
# end class SubstituirNfseEnvio


class SubstituirNfseResposta(GeneratedsSuper):
    subclass = None
    superclass = None

    def __init__(self, RetSubstituicao=None, ListaMensagemRetorno=None):
        self.original_tagname_ = None
        self.RetSubstituicao = RetSubstituicao
        self.ListaMensagemRetorno = ListaMensagemRetorno

    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, SubstituirNfseResposta)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if SubstituirNfseResposta.subclass:
            return SubstituirNfseResposta.subclass(*args_, **kwargs_)
        else:
            return SubstituirNfseResposta(*args_, **kwargs_)
    factory = staticmethod(factory)

    def get_RetSubstituicao(self): return self.RetSubstituicao

    def set_RetSubstituicao(
        self, RetSubstituicao): self.RetSubstituicao = RetSubstituicao
    ...
    def hasContent_(self):
        if (
            self.RetSubstituicao is not None or
            self.ListaMensagemRetorno is not None
        ):
            return True
        else:
    ...
    def export(self, outfile, level, namespace_='', name_='SubstituirNfseResposta', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get(
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='SubstituirNfseResposta')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='SubstituirNfseResposta', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='SubstituirNfseResposta'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='SubstituirNfseResposta', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.RetSubstituicao is not None:
            self.RetSubstituicao.export(
                outfile, level, namespace_, name_='RetSubstituicao', pretty_print=pretty_print)
        if self.ListaMensagemRetorno is not None:
            self.ListaMensagemRetorno.export(
                outfile, level, namespace_, name_='ListaMensagemRetorno', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'RetSubstituicao':
            obj_ = RetSubstituicaoType.factory()
            obj_.build(child_)
            self.RetSubstituicao = obj_
            obj_.original_tagname_ = 'RetSubstituicao'
        elif nodeName_ == 'ListaMensagemRetorno':
            obj_ = ListaMensagemRetorno.factory()
            obj_.build(child_)
            self.ListaMensagemRetorno = obj_
            obj_.original_tagname_ = 'ListaMensagemRetorno'
# end class SubstituirNfseResposta
...
class ConsultarLoteRpsEnvio(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='ConsultarLoteRpsEnvio', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='ConsultarLoteRpsEnvio')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ConsultarLoteRpsEnvio', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class ConsultarLoteRpsResposta(GeneratedsSuper):
    ...
    def __init__(self, Situacao=None, ListaNfse=None, ListaMensagemRetorno=None, ListaMensagemRetornoLote=None):
        self.original_tagname_ = None
    ...
    def validate_tsSituacaoLoteRps(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (
                    value.encode('utf-8'), self.validate_tsSituacaoLoteRps_patterns_, ))
    ...
    def export(self, outfile, level, namespace_='', name_='ConsultarLoteRpsResposta', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='ConsultarLoteRpsResposta')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ConsultarLoteRpsResposta', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ConsultarLoteRpsResposta', fromsubclass_=False, pretty_print=True):
        ...
        if self.Situacao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Situacao>%s</Situacao>%s' %
                          (self.gds_format_integer(self.Situacao, input_name='Situacao'), eol_))
        if self.ListaNfse is not None:
            self.ListaNfse.export(outfile, level, namespace_,
                                  name_='ListaNfse', pretty_print=pretty_print)
        if self.ListaMensagemRetorno is not None:
...
class ConsultarNfseRpsEnvio(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='ConsultarNfseRpsEnvio', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='ConsultarNfseRpsEnvio')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ConsultarNfseRpsEnvio', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class ConsultarNfseRpsResposta(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='ConsultarNfseRpsResposta', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='ConsultarNfseRpsResposta')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ConsultarNfseRpsResposta', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ConsultarNfseRpsResposta', fromsubclass_=False, pretty_print=True):
        ...
        if self.CompNfse is not None:
            self.CompNfse.export(outfile, level, namespace_,
                                 name_='CompNfse', pretty_print=pretty_print)
        if self.ListaMensagemRetorno is not None:
            self.ListaMensagemRetorno.export(
                outfile, level, namespace_, name_='ListaMensagemRetorno', pretty_print=pretty_print)
...
class ConsultarNfseServicoPrestadoEnvio(GeneratedsSuper):
    subclass = None
    superclass = None

    def __init__(self, Prestador=None, NumeroNfse=None, PeriodoEmissao=None, PeriodoCompetencia=None, Tomador=None, Intermediario=None, Pagina=None):
        self.original_tagname_ = None
        self.Prestador = Prestador
        self.NumeroNfse = NumeroNfse
        self.validate_tsNumeroNfse(self.NumeroNfse)
        self.PeriodoEmissao = PeriodoEmissao
        self.PeriodoCompetencia = PeriodoCompetencia
        self.Tomador = Tomador
        self.Intermediario = Intermediario
        self.Pagina = Pagina
        self.validate_tsPagina(self.Pagina)

    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ConsultarNfseServicoPrestadoEnvio)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ConsultarNfseServicoPrestadoEnvio.subclass:
            return ConsultarNfseServicoPrestadoEnvio.subclass(*args_, **kwargs_)
        else:
            return ConsultarNfseServicoPrestadoEnvio(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def set_PeriodoEmissao(
        self, PeriodoEmissao): self.PeriodoEmissao = PeriodoEmissao

    def get_PeriodoCompetencia(self): return self.PeriodoCompetencia

    def set_PeriodoCompetencia(
        self, PeriodoCompetencia): self.PeriodoCompetencia = PeriodoCompetencia
    ...
    def get_Pagina(self): return self.Pagina

    def set_Pagina(self, Pagina): self.Pagina = Pagina
    ...
    def validate_tsPagina(self, value):
        # Validate type tsPagina, a restriction on xsd:nonNegativeInteger.
        if value is not None and Validate_simpletypes_:
            if value < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minInclusive restriction on tsPagina' % {
                               "value": value})
            if value > 999999:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on tsPagina' % {
                               "value": value})
    ...
    def hasContent_(self):
        if (
            ...
            self.PeriodoCompetencia is not None or
            self.Tomador is not None or
            self.Intermediario is not None or
    ...
    def export(self, outfile, level, namespace_='', name_='ConsultarNfseServicoPrestadoEnvio', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get(
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='ConsultarNfseServicoPrestadoEnvio')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ConsultarNfseServicoPrestadoEnvio', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ConsultarNfseServicoPrestadoEnvio'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='ConsultarNfseServicoPrestadoEnvio', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.NumeroNfse is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<NumeroNfse>%s</NumeroNfse>%s' %
                          (self.gds_format_integer(self.NumeroNfse, input_name='NumeroNfse'), eol_))
        if self.PeriodoEmissao is not None:
            self.PeriodoEmissao.export(
                outfile, level, namespace_, name_='PeriodoEmissao', pretty_print=pretty_print)
        if self.PeriodoCompetencia is not None:
            self.PeriodoCompetencia.export(
                outfile, level, namespace_, name_='PeriodoCompetencia', pretty_print=pretty_print)
        if self.Tomador is not None:
            self.Tomador.export(outfile, level, namespace_,
                                name_='Tomador', pretty_print=pretty_print)
        if self.Intermediario is not None:
        ...
        if self.Pagina is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Pagina>%s</Pagina>%s' %
                          (self.gds_format_integer(self.Pagina, input_name='Pagina'), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Prestador':
        ...
        elif nodeName_ == 'PeriodoCompetencia':
            obj_ = PeriodoCompetenciaType.factory()
            obj_.build(child_)
            self.PeriodoCompetencia = obj_
            obj_.original_tagname_ = 'PeriodoCompetencia'
        elif nodeName_ == 'Tomador':
            obj_ = tcIdentificacaoTomador.factory()
            obj_.build(child_)
            self.Tomador = obj_
            ...
            if ival_ < 0:
                raise_parse_error(child_, 'requires nonNegativeInteger')
            ival_ = self.gds_validate_integer(ival_, node, 'Pagina')
            self.Pagina = ival_
            # validate type tsPagina
            self.validate_tsPagina(self.Pagina)
# end class ConsultarNfseServicoPrestadoEnvio


class ConsultarNfseServicoPrestadoResposta(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ConsultarNfseServicoPrestadoResposta)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ConsultarNfseServicoPrestadoResposta.subclass:
            return ConsultarNfseServicoPrestadoResposta.subclass(*args_, **kwargs_)
        else:
            return ConsultarNfseServicoPrestadoResposta(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, namespace_='', name_='ConsultarNfseServicoPrestadoResposta', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get(
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='ConsultarNfseServicoPrestadoResposta')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ConsultarNfseServicoPrestadoResposta', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ConsultarNfseServicoPrestadoResposta'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='ConsultarNfseServicoPrestadoResposta', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ListaNfse':
            ...
            self.ListaMensagemRetorno = obj_
            obj_.original_tagname_ = 'ListaMensagemRetorno'
# end class ConsultarNfseServicoPrestadoResposta


class ConsultarNfseServicoTomadoEnvio(GeneratedsSuper):
    subclass = None
    superclass = None

    def __init__(self, Consulente=None, NumeroNfse=None, PeriodoEmissao=None, PeriodoCompetencia=None, Prestador=None, Tomador=None, Intermediario=None, Pagina=None):
        self.original_tagname_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ConsultarNfseServicoTomadoEnvio)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ConsultarNfseServicoTomadoEnvio.subclass:
            return ConsultarNfseServicoTomadoEnvio.subclass(*args_, **kwargs_)
        else:
            return ConsultarNfseServicoTomadoEnvio(*args_, **kwargs_)
    factory = staticmethod(factory)

    def get_Consulente(self): return self.Consulente

    def set_Consulente(self, Consulente): self.Consulente = Consulente
    ...
    def hasContent_(self):
        if (
            self.Consulente is not None or
            self.NumeroNfse is not None or
            self.PeriodoEmissao is not None or
            self.PeriodoCompetencia is not None or
            self.Prestador is not None or
    ...
    def export(self, outfile, level, namespace_='', name_='ConsultarNfseServicoTomadoEnvio', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get(
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='ConsultarNfseServicoTomadoEnvio')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ConsultarNfseServicoTomadoEnvio', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ConsultarNfseServicoTomadoEnvio'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='ConsultarNfseServicoTomadoEnvio', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Consulente is not None:
            self.Consulente.export(
                outfile, level, namespace_, name_='Consulente', pretty_print=pretty_print)
        if self.NumeroNfse is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<NumeroNfse>%s</NumeroNfse>%s' %
                          (self.gds_format_integer(self.NumeroNfse, input_name='NumeroNfse'), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Consulente':
            obj_ = tcIdentificacaoConsulente.factory()
            obj_.build(child_)
            self.Consulente = obj_
            obj_.original_tagname_ = 'Consulente'
        elif nodeName_ == 'NumeroNfse':
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            ...
            obj_ = PeriodoEmissaoType4.factory()
            obj_.build(child_)
            self.PeriodoEmissao = obj_
            obj_.original_tagname_ = 'PeriodoEmissao'
        elif nodeName_ == 'PeriodoCompetencia':
            obj_ = PeriodoCompetenciaType5.factory()
            obj_.build(child_)
            self.PeriodoCompetencia = obj_
            obj_.original_tagname_ = 'PeriodoCompetencia'
        elif nodeName_ == 'Prestador':
            ...
            # validate type tsPagina
            self.validate_tsPagina(self.Pagina)
# end class ConsultarNfseServicoTomadoEnvio


class ConsultarNfseServicoTomadoResposta(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ConsultarNfseServicoTomadoResposta)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ConsultarNfseServicoTomadoResposta.subclass:
            return ConsultarNfseServicoTomadoResposta.subclass(*args_, **kwargs_)
        else:
            return ConsultarNfseServicoTomadoResposta(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, namespace_='', name_='ConsultarNfseServicoTomadoResposta', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get(
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='ConsultarNfseServicoTomadoResposta')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ConsultarNfseServicoTomadoResposta', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ConsultarNfseServicoTomadoResposta'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='ConsultarNfseServicoTomadoResposta', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ListaNfse':
            ...
            self.ListaMensagemRetorno = obj_
            obj_.original_tagname_ = 'ListaMensagemRetorno'
# end class ConsultarNfseServicoTomadoResposta


class ConsultarNfseFaixaEnvio(GeneratedsSuper):
    subclass = None
    superclass = None

    def __init__(self, Prestador=None, Faixa=None, Pagina=None):
        self.original_tagname_ = None
        self.Prestador = Prestador
        self.Faixa = Faixa
        self.Pagina = Pagina
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ConsultarNfseFaixaEnvio)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ConsultarNfseFaixaEnvio.subclass:
            return ConsultarNfseFaixaEnvio.subclass(*args_, **kwargs_)
        else:
            return ConsultarNfseFaixaEnvio(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def get_Faixa(self): return self.Faixa

    def set_Faixa(self, Faixa): self.Faixa = Faixa
    ...
    def export(self, outfile, level, namespace_='', name_='ConsultarNfseFaixaEnvio', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get(
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='ConsultarNfseFaixaEnvio')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ConsultarNfseFaixaEnvio', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ConsultarNfseFaixaEnvio'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='ConsultarNfseFaixaEnvio', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.Faixa is not None:
            self.Faixa.export(outfile, level, namespace_,
                              name_='Faixa', pretty_print=pretty_print)
        if self.Pagina is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Pagina>%s</Pagina>%s' %
                          (self.gds_format_integer(self.Pagina, input_name='Pagina'), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Prestador':
            ...
            self.Prestador = obj_
            obj_.original_tagname_ = 'Prestador'
        elif nodeName_ == 'Faixa':
            obj_ = FaixaType.factory()
            obj_.build(child_)
            self.Faixa = obj_
            obj_.original_tagname_ = 'Faixa'
        elif nodeName_ == 'Pagina':
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            ...
            # validate type tsPagina
            self.validate_tsPagina(self.Pagina)
# end class ConsultarNfseFaixaEnvio


class ConsultarNfseFaixaResposta(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ConsultarNfseFaixaResposta)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ConsultarNfseFaixaResposta.subclass:
            return ConsultarNfseFaixaResposta.subclass(*args_, **kwargs_)
        else:
            return ConsultarNfseFaixaResposta(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, namespace_='', name_='ConsultarNfseFaixaResposta', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get(
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='ConsultarNfseFaixaResposta')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ConsultarNfseFaixaResposta', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ConsultarNfseFaixaResposta'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='ConsultarNfseFaixaResposta', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ListaNfse':
            ...
            self.ListaMensagemRetorno = obj_
            obj_.original_tagname_ = 'ListaMensagemRetorno'
# end class ConsultarNfseFaixaResposta
...
class SignatureType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='SignatureType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='SignatureType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='SignatureType', fromsubclass_=False, pretty_print=True):
        ...
        if self.SignedInfo is not None:
            self.SignedInfo.export(
                outfile, level, namespace_='ds:', name_='SignedInfo', pretty_print=pretty_print)
        if self.SignatureValue is not None:
            self.SignatureValue.export(
                outfile, level, namespace_='ds:', name_='SignatureValue', pretty_print=pretty_print)
        if self.KeyInfo is not None:
            self.KeyInfo.export(outfile, level, namespace_='ds:',
                                name_='KeyInfo', pretty_print=pretty_print)
        for Object_ in self.Object:
            Object_.export(outfile, level, namespace_='ds:',
                           name_='Object', pretty_print=pretty_print)
...
class SignatureValueType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='SignatureValueType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='SignatureValueType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class SignedInfoType(GeneratedsSuper):
    ...
    def set_CanonicalizationMethod(
        self, CanonicalizationMethod): self.CanonicalizationMethod = CanonicalizationMethod
    ...
    def insert_Reference_at(
        self, index, value): self.Reference.insert(index, value)
    ...
    def export(self, outfile, level, namespace_='', name_='SignedInfoType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='SignedInfoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='SignedInfoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.CanonicalizationMethod is not None:
            self.CanonicalizationMethod.export(
                outfile, level, namespace_='ds:', name_='CanonicalizationMethod', pretty_print=pretty_print)
        if self.SignatureMethod is not None:
            self.SignatureMethod.export(
                outfile, level, namespace_='ds:', name_='SignatureMethod', pretty_print=pretty_print)
        for Reference_ in self.Reference:
            Reference_.export(outfile, level, namespace_='ds:',
                              name_='Reference', pretty_print=pretty_print)
...
class CanonicalizationMethodType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='CanonicalizationMethodType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='CanonicalizationMethodType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='CanonicalizationMethodType', fromsubclass_=False, pretty_print=True):
        if not fromsubclass_:
            for item_ in self.content_:
                item_.export(outfile, level, item_.name,
...
class SignatureMethodType(GeneratedsSuper):
    ...
    def set_HMACOutputLength(
        self, HMACOutputLength): self.HMACOutputLength = HMACOutputLength
    ...
    def export(self, outfile, level, namespace_='', name_='SignatureMethodType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='SignatureMethodType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='SignatureMethodType', fromsubclass_=False, pretty_print=True):
        ...
        if self.HMACOutputLength is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<HMACOutputLength>%s</HMACOutputLength>%s' % (
                self.gds_format_integer(self.HMACOutputLength, input_name='HMACOutputLength'), eol_))
        for obj_ in self.anytypeobjs_:
            obj_.export(outfile, level, namespace_, pretty_print=pretty_print)
...
class ReferenceType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='ReferenceType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ReferenceType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ReferenceType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Transforms is not None:
            self.Transforms.export(
                outfile, level, namespace_='ds:', name_='Transforms', pretty_print=pretty_print)
        if self.DigestMethod is not None:
            self.DigestMethod.export(
                outfile, level, namespace_='ds:', name_='DigestMethod', pretty_print=pretty_print)
        if self.DigestValue is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ds:DigestValue>%s</ds:DigestValue>%s' %
                          (self.gds_format_base64(self.DigestValue, input_name='DigestValue'), eol_))
...
class TransformsType(GeneratedsSuper):
    ...
    def insert_Transform_at(
        self, index, value): self.Transform.insert(index, value)
    ...
    def export(self, outfile, level, namespace_='', name_='TransformsType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='TransformsType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='TransformsType', fromsubclass_=False, pretty_print=True):
        ...
        for Transform_ in self.Transform:
            Transform_.export(outfile, level, namespace_='ds:',
                              name_='Transform', pretty_print=pretty_print)
...
class TransformType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='TransformType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='TransformType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='TransformType', fromsubclass_=False, pretty_print=True):
        ...
        for XPath_ in self.XPath:
            showIndent(outfile, level, pretty_print)
            outfile.write('<XPath>%s</XPath>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(XPath_), input_name='XPath')), eol_))
...
class DigestMethodType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='DigestMethodType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='DigestMethodType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class KeyInfoType(GeneratedsSuper):
    ...
    def insert_KeyName_at(
        self, index, value): self.KeyName.insert(index, value)
    ...
    def insert_KeyValue_at(
        self, index, value): self.KeyValue.insert(index, value)
    ...
    def set_RetrievalMethod(
        self, RetrievalMethod): self.RetrievalMethod = RetrievalMethod

    def add_RetrievalMethod(self, value): self.RetrievalMethod.append(value)

    def insert_RetrievalMethod_at(
        self, index, value): self.RetrievalMethod.insert(index, value)

    def replace_RetrievalMethod_at(
        self, index, value): self.RetrievalMethod[index] = value
    ...
    def insert_X509Data_at(
        self, index, value): self.X509Data.insert(index, value)
    ...
    def insert_PGPData_at(
        self, index, value): self.PGPData.insert(index, value)
    ...
    def insert_SPKIData_at(
        self, index, value): self.SPKIData.insert(index, value)
    ...
    def insert_MgmtData_at(
        self, index, value): self.MgmtData.insert(index, value)
    ...
    def export(self, outfile, level, namespace_='', name_='KeyInfoType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='KeyInfoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='KeyInfoType', fromsubclass_=False, pretty_print=True):
        ...
        for KeyName_ in self.KeyName:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ds:KeyName>%s</ds:KeyName>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(KeyName_), input_name='KeyName')), eol_))
        for KeyValue_ in self.KeyValue:
            KeyValue_.export(outfile, level, namespace_='ds:',
                             name_='KeyValue', pretty_print=pretty_print)
        for RetrievalMethod_ in self.RetrievalMethod:
            RetrievalMethod_.export(
                outfile, level, namespace_='ds:', name_='RetrievalMethod', pretty_print=pretty_print)
        for X509Data_ in self.X509Data:
            X509Data_.export(outfile, level, namespace_='ds:',
                             name_='X509Data', pretty_print=pretty_print)
        for PGPData_ in self.PGPData:
            PGPData_.export(outfile, level, namespace_='ds:',
                            name_='PGPData', pretty_print=pretty_print)
        for SPKIData_ in self.SPKIData:
            SPKIData_.export(outfile, level, namespace_='ds:',
                             name_='SPKIData', pretty_print=pretty_print)
        for MgmtData_ in self.MgmtData:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ds:MgmtData>%s</ds:MgmtData>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(MgmtData_), input_name='MgmtData')), eol_))
        if self.anytypeobjs_ is not None:
            self.anytypeobjs_.export(
                outfile, level, namespace_, pretty_print=pretty_print)
...
class KeyValueType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='KeyValueType', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='KeyValueType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='KeyValueType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='KeyValueType', fromsubclass_=False, pretty_print=True):
        ...
        if self.DSAKeyValue is not None:
            self.DSAKeyValue.export(
                outfile, level, namespace_='ds:', name_='DSAKeyValue', pretty_print=pretty_print)
        if self.RSAKeyValue is not None:
            self.RSAKeyValue.export(
                outfile, level, namespace_='ds:', name_='RSAKeyValue', pretty_print=pretty_print)
        if self.anytypeobjs_ is not None:
            self.anytypeobjs_.export(
                outfile, level, namespace_, pretty_print=pretty_print)
...
class RetrievalMethodType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='RetrievalMethodType', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='RetrievalMethodType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='RetrievalMethodType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class X509DataType(GeneratedsSuper):
    ...
    def set_X509IssuerSerial(
        self, X509IssuerSerial): self.X509IssuerSerial = X509IssuerSerial

    def add_X509IssuerSerial(self, value): self.X509IssuerSerial.append(value)

    def insert_X509IssuerSerial_at(
        self, index, value): self.X509IssuerSerial.insert(index, value)

    def replace_X509IssuerSerial_at(
        self, index, value): self.X509IssuerSerial[index] = value
    ...
    def insert_X509SKI_at(
        self, index, value): self.X509SKI.insert(index, value)

    def replace_X509SKI_at(self, index, value): self.X509SKI[index] = value

    def get_X509SubjectName(self): return self.X509SubjectName

    def set_X509SubjectName(
        self, X509SubjectName): self.X509SubjectName = X509SubjectName

    def add_X509SubjectName(self, value): self.X509SubjectName.append(value)

    def insert_X509SubjectName_at(
        self, index, value): self.X509SubjectName.insert(index, value)

    def replace_X509SubjectName_at(
        self, index, value): self.X509SubjectName[index] = value
    ...
    def insert_X509Certificate_at(
        self, index, value): self.X509Certificate.insert(index, value)

    def replace_X509Certificate_at(
        self, index, value): self.X509Certificate[index] = value
    ...
    def insert_X509CRL_at(
        self, index, value): self.X509CRL.insert(index, value)
    ...
    def export(self, outfile, level, namespace_='', name_='X509DataType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='X509DataType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='X509DataType', fromsubclass_=False, pretty_print=True):
        ...
        for X509IssuerSerial_ in self.X509IssuerSerial:
            X509IssuerSerial_.export(
                outfile, level, namespace_, name_='X509IssuerSerial', pretty_print=pretty_print)
        for X509SKI_ in self.X509SKI:
            showIndent(outfile, level, pretty_print)
            outfile.write('<X509SKI>%s</X509SKI>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(X509SKI_), input_name='X509SKI')), eol_))
        for X509SubjectName_ in self.X509SubjectName:
            showIndent(outfile, level, pretty_print)
            outfile.write('<X509SubjectName>%s</X509SubjectName>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(X509SubjectName_), input_name='X509SubjectName')), eol_))
        for X509Certificate_ in self.X509Certificate:
            showIndent(outfile, level, pretty_print)
            outfile.write('<X509Certificate>%s</X509Certificate>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(X509Certificate_), input_name='X509Certificate')), eol_))
        for X509CRL_ in self.X509CRL:
            showIndent(outfile, level, pretty_print)
            outfile.write('<X509CRL>%s</X509CRL>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(X509CRL_), input_name='X509CRL')), eol_))
        if self.anytypeobjs_ is not None:
            self.anytypeobjs_.export(
                outfile, level, namespace_, pretty_print=pretty_print)
...
class X509IssuerSerialType(GeneratedsSuper):
    ...
    def set_X509IssuerName(
        self, X509IssuerName): self.X509IssuerName = X509IssuerName

    def get_X509SerialNumber(self): return self.X509SerialNumber

    def set_X509SerialNumber(
        self, X509SerialNumber): self.X509SerialNumber = X509SerialNumber
    ...
    def export(self, outfile, level, namespace_='', name_='X509IssuerSerialType', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='X509IssuerSerialType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='X509IssuerSerialType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='X509IssuerSerialType', fromsubclass_=False, pretty_print=True):
        ...
        if self.X509IssuerName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<X509IssuerName>%s</X509IssuerName>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.X509IssuerName), input_name='X509IssuerName')), eol_))
        if self.X509SerialNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<X509SerialNumber>%s</X509SerialNumber>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.X509SerialNumber), input_name='X509SerialNumber')), eol_))
...
class PGPDataType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='PGPDataType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='PGPDataType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='PGPDataType', fromsubclass_=False, pretty_print=True):
        ...
        if self.PGPKeyID is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<PGPKeyID>%s</PGPKeyID>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.PGPKeyID), input_name='PGPKeyID')), eol_))
        if self.PGPKeyPacket is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<PGPKeyPacket>%s</PGPKeyPacket>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.PGPKeyPacket), input_name='PGPKeyPacket')), eol_))
        for obj_ in self.anytypeobjs_:
            obj_.export(outfile, level, namespace_, pretty_print=pretty_print)
...
class SPKIDataType(GeneratedsSuper):
    ...
    def insert_SPKISexp_at(
        self, index, value): self.SPKISexp.insert(index, value)
    ...
    def export(self, outfile, level, namespace_='', name_='SPKIDataType', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='SPKIDataType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='SPKIDataType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='SPKIDataType', fromsubclass_=False, pretty_print=True):
        ...
        for SPKISexp_ in self.SPKISexp:
            showIndent(outfile, level, pretty_print)
            outfile.write('<SPKISexp>%s</SPKISexp>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(SPKISexp_), input_name='SPKISexp')), eol_))
        if self.anytypeobjs_ is not None:
            self.anytypeobjs_.export(
                outfile, level, namespace_, pretty_print=pretty_print)
...
class ObjectType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='ObjectType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ObjectType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class ManifestType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='ManifestType', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='ManifestType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ManifestType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class SignaturePropertiesType(GeneratedsSuper):
    ...
    def set_SignatureProperty(
        self, SignatureProperty): self.SignatureProperty = SignatureProperty

    def add_SignatureProperty(
        self, value): self.SignatureProperty.append(value)

    def insert_SignatureProperty_at(
        self, index, value): self.SignatureProperty.insert(index, value)

    def replace_SignatureProperty_at(
        self, index, value): self.SignatureProperty[index] = value
    ...
    def export(self, outfile, level, namespace_='', name_='SignaturePropertiesType', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='SignaturePropertiesType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='SignaturePropertiesType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='SignaturePropertiesType', fromsubclass_=False, pretty_print=True):
        ...
        for SignatureProperty_ in self.SignatureProperty:
            SignatureProperty_.export(
                outfile, level, namespace_='ds:', name_='SignatureProperty', pretty_print=pretty_print)
...
class SignaturePropertyType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='SignaturePropertyType', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='SignaturePropertyType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='SignaturePropertyType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class DSAKeyValueType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='DSAKeyValueType', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='DSAKeyValueType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='DSAKeyValueType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class RSAKeyValueType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='RSAKeyValueType', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='RSAKeyValueType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='RSAKeyValueType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='RSAKeyValueType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Modulus is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Modulus>%s</Modulus>%s' %
                          (self.gds_format_base64(self.Modulus, input_name='Modulus'), eol_))
        if self.Exponent is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<Exponent>%s</Exponent>%s' %
...
class ListaRpsType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='ListaRpsType', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='ListaRpsType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ListaRpsType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ListaRpsType', fromsubclass_=False, pretty_print=True):
        ...
        for Rps_ in self.Rps:
            Rps_.export(outfile, level, namespace_,
                        name_='Rps', pretty_print=pretty_print)
...
class ListaNfseType(GeneratedsSuper):
    ...
    def __init__(self, CompNfse=None, ListaMensagemAlertaRetorno=None):
        self.original_tagname_ = None
        if CompNfse is None:
            self.CompNfse = []
        else:
            self.CompNfse = CompNfse
        self.ListaMensagemAlertaRetorno = ListaMensagemAlertaRetorno
    ...
    def insert_CompNfse_at(
        self, index, value): self.CompNfse.insert(index, value)

    def replace_CompNfse_at(self, index, value): self.CompNfse[index] = value

    def get_ListaMensagemAlertaRetorno(
        self): return self.ListaMensagemAlertaRetorno

    def set_ListaMensagemAlertaRetorno(
        self, ListaMensagemAlertaRetorno): self.ListaMensagemAlertaRetorno = ListaMensagemAlertaRetorno

    def hasContent_(self):
        if (
            self.CompNfse or
            self.ListaMensagemAlertaRetorno is not None
        ):
            return True
        else:
            return False
    ...
    def export(self, outfile, level, namespace_='', name_='ListaNfseType', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='ListaNfseType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ListaNfseType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ListaNfseType', fromsubclass_=False, pretty_print=True):
        ...
        for CompNfse_ in self.CompNfse:
            CompNfse_.export(outfile, level, namespace_,
                             name_='CompNfse', pretty_print=pretty_print)
        if self.ListaMensagemAlertaRetorno is not None:
            self.ListaMensagemAlertaRetorno.export(
                outfile, level, namespace_, name_='ListaMensagemAlertaRetorno', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CompNfse':
            ...
            obj_.original_tagname_ = 'CompNfse'
        elif nodeName_ == 'ListaMensagemAlertaRetorno':
            obj_ = ListaMensagemAlertaRetorno.factory()
            obj_.build(child_)
            self.ListaMensagemAlertaRetorno = obj_
            obj_.original_tagname_ = 'ListaMensagemAlertaRetorno'
...
class ListaNfseType1(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='ListaNfseType1', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='ListaNfseType1')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ListaNfseType1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ListaNfseType1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class SubstituicaoNfseType(GeneratedsSuper):
    subclass = None
    superclass = None

    def __init__(self, Id=None, Pedido=None, Rps=None):
        self.original_tagname_ = None
        self.Id = _cast(None, Id)
        self.Pedido = Pedido
        self.Rps = Rps
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, SubstituicaoNfseType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if SubstituicaoNfseType.subclass:
            return SubstituicaoNfseType.subclass(*args_, **kwargs_)
        else:
            return SubstituicaoNfseType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, namespace_='', name_='SubstituicaoNfseType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('SubstituicaoNfseType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='SubstituicaoNfseType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='SubstituicaoNfseType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='SubstituicaoNfseType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (quote_attrib(self.Id), ))

    def exportChildren(self, outfile, level, namespace_='', name_='SubstituicaoNfseType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Pedido':
            ...
            self.Rps = obj_
            obj_.original_tagname_ = 'Rps'
# end class SubstituicaoNfseType


class RetSubstituicaoType(GeneratedsSuper):
    subclass = None
    superclass = None

    def __init__(self, NfseSubstituida=None, NfseSubstituidora=None):
        self.original_tagname_ = None
        self.NfseSubstituida = NfseSubstituida
        self.NfseSubstituidora = NfseSubstituidora
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, RetSubstituicaoType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if RetSubstituicaoType.subclass:
            return RetSubstituicaoType.subclass(*args_, **kwargs_)
        else:
            return RetSubstituicaoType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, namespace_='', name_='RetSubstituicaoType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('RetSubstituicaoType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='RetSubstituicaoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='RetSubstituicaoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='RetSubstituicaoType'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='RetSubstituicaoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.NfseSubstituida is not None:
            self.NfseSubstituida.export(
                outfile, level, namespace_, name_='NfseSubstituida', pretty_print=pretty_print)
        if self.NfseSubstituidora is not None:
            self.NfseSubstituidora.export(
                outfile, level, namespace_, name_='NfseSubstituidora', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'NfseSubstituida':
            obj_ = NfseSubstituidaType.factory()
            obj_.build(child_)
            self.NfseSubstituida = obj_
            obj_.original_tagname_ = 'NfseSubstituida'
        elif nodeName_ == 'NfseSubstituidora':
            obj_ = NfseSubstituidoraType.factory()
            obj_.build(child_)
            self.NfseSubstituidora = obj_
            obj_.original_tagname_ = 'NfseSubstituidora'
# end class RetSubstituicaoType


class NfseSubstituidaType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, NfseSubstituidaType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if NfseSubstituidaType.subclass:
            return NfseSubstituidaType.subclass(*args_, **kwargs_)
        else:
            return NfseSubstituidaType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, namespace_='', name_='NfseSubstituidaType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('NfseSubstituidaType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='NfseSubstituidaType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='NfseSubstituidaType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='NfseSubstituidaType'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='NfseSubstituidaType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CompNfse':
            ...
            self.ListaMensagemAlertaRetorno = obj_
            obj_.original_tagname_ = 'ListaMensagemAlertaRetorno'
# end class NfseSubstituidaType


class NfseSubstituidoraType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, NfseSubstituidoraType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if NfseSubstituidoraType.subclass:
            return NfseSubstituidoraType.subclass(*args_, **kwargs_)
        else:
            return NfseSubstituidoraType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, namespace_='', name_='NfseSubstituidoraType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get(
            'NfseSubstituidoraType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='NfseSubstituidoraType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='NfseSubstituidoraType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='NfseSubstituidoraType'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='NfseSubstituidoraType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CompNfse':
            ...
            self.CompNfse = obj_
            obj_.original_tagname_ = 'CompNfse'
# end class NfseSubstituidoraType


class ListaNfseType2(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ListaNfseType2)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ListaNfseType2.subclass:
            return ListaNfseType2.subclass(*args_, **kwargs_)
        else:
            return ListaNfseType2(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, namespace_='', name_='ListaNfseType2', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ListaNfseType2')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='ListaNfseType2')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ListaNfseType2', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ListaNfseType2'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='ListaNfseType2', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class PeriodoEmissaoType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='PeriodoEmissaoType', namespacedef_='', pretty_print=True):
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='PeriodoEmissaoType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='PeriodoEmissaoType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='PeriodoEmissaoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.DataInicial is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<DataInicial>%s</DataInicial>%s' %
                          (self.gds_format_date(self.DataInicial, input_name='DataInicial'), eol_))
        if self.DataFinal is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<DataFinal>%s</DataFinal>%s' %
                          (self.gds_format_date(self.DataFinal, input_name='DataFinal'), eol_))
...
class PeriodoCompetenciaType(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, PeriodoCompetenciaType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if PeriodoCompetenciaType.subclass:
            return PeriodoCompetenciaType.subclass(*args_, **kwargs_)
        else:
            return PeriodoCompetenciaType(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, namespace_='', name_='PeriodoCompetenciaType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get(
            'PeriodoCompetenciaType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='PeriodoCompetenciaType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='PeriodoCompetenciaType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='PeriodoCompetenciaType'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='PeriodoCompetenciaType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'DataInicial':
            ...
            dval_ = self.gds_parse_date(sval_)
            self.DataFinal = dval_
# end class PeriodoCompetenciaType


class ListaNfseType3(GeneratedsSuper):
    subclass = None
    superclass = None

    def __init__(self, CompNfse=None, ProximaPagina=None):
        self.original_tagname_ = None
        if CompNfse is None:
            self.CompNfse = []
        else:
        ...
        self.validate_tsPagina(self.ProximaPagina)

    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ListaNfseType3)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ListaNfseType3.subclass:
            return ListaNfseType3.subclass(*args_, **kwargs_)
        else:
            return ListaNfseType3(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def get_ProximaPagina(self): return self.ProximaPagina

    def set_ProximaPagina(
        self, ProximaPagina): self.ProximaPagina = ProximaPagina
    ...
    def hasContent_(self):
        if (
            self.CompNfse or
            self.ProximaPagina is not None
        ):
            return True
        else:
            return False

    def export(self, outfile, level, namespace_='', name_='ListaNfseType3', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ListaNfseType3')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='ListaNfseType3')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ListaNfseType3', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ListaNfseType3'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='ListaNfseType3', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for CompNfse_ in self.CompNfse:
            CompNfse_.export(outfile, level, namespace_,
                             name_='CompNfse', pretty_print=pretty_print)
        if self.ProximaPagina is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ProximaPagina>%s</ProximaPagina>%s' % (
                self.gds_format_integer(self.ProximaPagina, input_name='ProximaPagina'), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CompNfse':
            ...
            if ival_ < 0:
                raise_parse_error(child_, 'requires nonNegativeInteger')
            ival_ = self.gds_validate_integer(ival_, node, 'ProximaPagina')
            self.ProximaPagina = ival_
            # validate type tsPagina
            self.validate_tsPagina(self.ProximaPagina)
# end class ListaNfseType3


class PeriodoEmissaoType4(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, PeriodoEmissaoType4)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if PeriodoEmissaoType4.subclass:
            return PeriodoEmissaoType4.subclass(*args_, **kwargs_)
        else:
            return PeriodoEmissaoType4(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, namespace_='', name_='PeriodoEmissaoType4', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('PeriodoEmissaoType4')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='PeriodoEmissaoType4')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='PeriodoEmissaoType4', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='PeriodoEmissaoType4'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='PeriodoEmissaoType4', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'DataInicial':
            ...
            dval_ = self.gds_parse_date(sval_)
            self.DataFinal = dval_
# end class PeriodoEmissaoType4


class PeriodoCompetenciaType5(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, PeriodoCompetenciaType5)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if PeriodoCompetenciaType5.subclass:
            return PeriodoCompetenciaType5.subclass(*args_, **kwargs_)
        else:
            return PeriodoCompetenciaType5(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, namespace_='', name_='PeriodoCompetenciaType5', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get(
            'PeriodoCompetenciaType5')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='PeriodoCompetenciaType5')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='PeriodoCompetenciaType5', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='PeriodoCompetenciaType5'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='PeriodoCompetenciaType5', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'DataInicial':
            ...
            dval_ = self.gds_parse_date(sval_)
            self.DataFinal = dval_
# end class PeriodoCompetenciaType5


class ListaNfseType6(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ListaNfseType6)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ListaNfseType6.subclass:
            return ListaNfseType6.subclass(*args_, **kwargs_)
        else:
            return ListaNfseType6(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, namespace_='', name_='ListaNfseType6', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ListaNfseType6')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='ListaNfseType6')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ListaNfseType6', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ListaNfseType6'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='ListaNfseType6', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CompNfse':
            ...
            # validate type tsPagina
            self.validate_tsPagina(self.ProximaPagina)
# end class ListaNfseType6


class FaixaType(GeneratedsSuper):
    subclass = None
    superclass = None

    def __init__(self, NumeroNfseInicial=None, NumeroNfseFinal=None):
        self.original_tagname_ = None
        self.NumeroNfseInicial = NumeroNfseInicial
        self.validate_tsNumeroNfse(self.NumeroNfseInicial)
        self.NumeroNfseFinal = NumeroNfseFinal
        self.validate_tsNumeroNfse(self.NumeroNfseFinal)

    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, FaixaType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if FaixaType.subclass:
            return FaixaType.subclass(*args_, **kwargs_)
        else:
            return FaixaType(*args_, **kwargs_)
    factory = staticmethod(factory)

    def get_NumeroNfseInicial(self): return self.NumeroNfseInicial

    def set_NumeroNfseInicial(
        self, NumeroNfseInicial): self.NumeroNfseInicial = NumeroNfseInicial

    def get_NumeroNfseFinal(self): return self.NumeroNfseFinal

    def set_NumeroNfseFinal(
        self, NumeroNfseFinal): self.NumeroNfseFinal = NumeroNfseFinal
    ...
    def hasContent_(self):
        if (
            self.NumeroNfseInicial is not None or
            self.NumeroNfseFinal is not None
        ):
            return True
        else:
            return False

    def export(self, outfile, level, namespace_='', name_='FaixaType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('FaixaType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        already_processed = set()
        self.exportAttributes(
            outfile, level, already_processed, namespace_, name_='FaixaType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='FaixaType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='FaixaType'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='FaixaType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.NumeroNfseInicial is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<NumeroNfseInicial>%s</NumeroNfseInicial>%s' % (
                self.gds_format_integer(self.NumeroNfseInicial, input_name='NumeroNfseInicial'), eol_))
        if self.NumeroNfseFinal is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<NumeroNfseFinal>%s</NumeroNfseFinal>%s' % (
                self.gds_format_integer(self.NumeroNfseFinal, input_name='NumeroNfseFinal'), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'NumeroNfseInicial':
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError) as exp:
            ...
            if ival_ < 0:
                raise_parse_error(child_, 'requires nonNegativeInteger')
            ival_ = self.gds_validate_integer(ival_, node, 'NumeroNfseInicial')
            self.NumeroNfseInicial = ival_
            # validate type tsNumeroNfse
            self.validate_tsNumeroNfse(self.NumeroNfseInicial)
        elif nodeName_ == 'NumeroNfseFinal':
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError) as exp:
            ...
            if ival_ < 0:
                raise_parse_error(child_, 'requires nonNegativeInteger')
            ival_ = self.gds_validate_integer(ival_, node, 'NumeroNfseFinal')
            self.NumeroNfseFinal = ival_
            # validate type tsNumeroNfse
            self.validate_tsNumeroNfse(self.NumeroNfseFinal)
# end class FaixaType


class ListaNfseType7(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ListaNfseType7)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ListaNfseType7.subclass:
            return ListaNfseType7.subclass(*args_, **kwargs_)
        else:
            return ListaNfseType7(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, namespace_='', name_='ListaNfseType7', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ListaNfseType7')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed,
                              namespace_, name_='ListaNfseType7')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='',
                                name_='ListaNfseType7', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ListaNfseType7'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='ListaNfseType7', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
