...
#
# Generated Tue Mar 20 04:11:25 2018 by generateDS.py version 2.29.2.
# Python 3.5.2 (default, Sep 14 2017, 22:51:06)  [GCC 5.4.0 20160609]
#
# Command line options:
#   ('-o', 'nfselib/v2_03/xmldsig-core-schema20020212.py')
#
# Command line arguments:
#   schemas/v2_03/xmldsig-core-schema20020212.xsd
#
# Command line:
#   /home/rvalyi/DEV/generateds/generateDS.py -o "nfselib/v2_03/xmldsig-core-schema20020212.py" schemas/v2_03/xmldsig-core-schema20020212.xsd
#
...
class SignatureType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='ds:', name_='SignatureType', namespacedef_='xmlns:ds="http://www.w3.org/2000/09/xmldsig#"', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespace_='ds:',
...
class CanonicalizationMethodType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='ds:', name_='CanonicalizationMethodType', namespacedef_='xmlns:ds="http://www.w3.org/2000/09/xmldsig#"', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='ds:', name_='CanonicalizationMethodType'):
        if self.Algorithm is not None and 'Algorithm' not in already_processed:
            ...
            outfile.write(' Algorithm=%s' % (self.gds_encode(self.gds_format_string(
                quote_attrib(self.Algorithm), input_name='Algorithm')), ))
...
class SignatureMethodType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='ds:', name_='SignatureMethodType', namespacedef_='xmlns:ds="http://www.w3.org/2000/09/xmldsig#"', pretty_print=True):
    ...
    def exportChildren(self, outfile, level, namespace_='ds:', name_='SignatureMethodType', fromsubclass_=False, pretty_print=True):
        ...
        if self.HMACOutputLength is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ds:HMACOutputLength>%s</ds:HMACOutputLength>%s' % (
...
class ReferenceType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='ds:', name_='ReferenceType'):
        ...
        if self.URI is not None and 'URI' not in already_processed:
            ...
            outfile.write(' URI=%s' % (self.gds_encode(
                self.gds_format_string(quote_attrib(self.URI), input_name='URI')), ))
        if self.Type is not None and 'Type' not in already_processed:
            already_processed.add('Type')
            outfile.write(' Type=%s' % (self.gds_encode(
                self.gds_format_string(quote_attrib(self.Type), input_name='Type')), ))
...
class TransformType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='ds:', name_='TransformType', fromsubclass_=False, pretty_print=True):
        ...
        for XPath_ in self.XPath:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ds:XPath>%s</ds:XPath>%s' % (self.gds_encode(
...
class DigestMethodType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='ds:', name_='DigestMethodType', namespacedef_='xmlns:ds="http://www.w3.org/2000/09/xmldsig#"', pretty_print=True):
...
class KeyValueType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='ds:', name_='KeyValueType', namespacedef_='xmlns:ds="http://www.w3.org/2000/09/xmldsig#"', pretty_print=True):
...
class RetrievalMethodType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='ds:', name_='RetrievalMethodType', namespacedef_='xmlns:ds="http://www.w3.org/2000/09/xmldsig#"', pretty_print=True):
...
class X509DataType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='ds:', name_='X509DataType', fromsubclass_=False, pretty_print=True):
        ...
        for X509SKI_ in self.X509SKI:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ds:X509SKI>%s</ds:X509SKI>%s' %
                          (self.gds_format_base64(X509SKI_, input_name='X509SKI'), eol_))
        for X509SubjectName_ in self.X509SubjectName:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ds:X509SubjectName>%s</ds:X509SubjectName>%s' % (self.gds_encode(
        ...
        for X509Certificate_ in self.X509Certificate:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ds:X509Certificate>%s</ds:X509Certificate>%s' %
                          (self.gds_format_base64(X509Certificate_, input_name='X509Certificate'), eol_))
        for X509CRL_ in self.X509CRL:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ds:X509CRL>%s</ds:X509CRL>%s' %
                          (self.gds_format_base64(X509CRL_, input_name='X509CRL'), eol_))
        if self.anytypeobjs_ is not None:
            self.anytypeobjs_.export(
                outfile, level, namespace_, pretty_print=pretty_print)
...
class X509IssuerSerialType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='ds:', name_='X509IssuerSerialType', namespacedef_='xmlns:ds="http://www.w3.org/2000/09/xmldsig#"', pretty_print=True):
    ...
    def exportChildren(self, outfile, level, namespace_='ds:', name_='X509IssuerSerialType', fromsubclass_=False, pretty_print=True):
        ...
        if self.X509IssuerName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ds:X509IssuerName>%s</ds:X509IssuerName>%s' % (self.gds_encode(
                self.gds_format_string(quote_xml(self.X509IssuerName), input_name='X509IssuerName')), eol_))
        if self.X509SerialNumber is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ds:X509SerialNumber>%s</ds:X509SerialNumber>%s' % (
                self.gds_format_integer(self.X509SerialNumber, input_name='X509SerialNumber'), eol_))
...
class PGPDataType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='ds:', name_='PGPDataType', namespacedef_='xmlns:ds="http://www.w3.org/2000/09/xmldsig#"', pretty_print=True):
    ...
    def exportChildren(self, outfile, level, namespace_='ds:', name_='PGPDataType', fromsubclass_=False, pretty_print=True):
        ...
        if self.PGPKeyID is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ds:PGPKeyID>%s</ds:PGPKeyID>%s' %
                          (self.gds_format_base64(self.PGPKeyID, input_name='PGPKeyID'), eol_))
        if self.PGPKeyPacket is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ds:PGPKeyPacket>%s</ds:PGPKeyPacket>%s' %
                          (self.gds_format_base64(self.PGPKeyPacket, input_name='PGPKeyPacket'), eol_))
        for obj_ in self.anytypeobjs_:
            obj_.export(outfile, level, namespace_, pretty_print=pretty_print)
...
class SPKIDataType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='ds:', name_='SPKIDataType', namespacedef_='xmlns:ds="http://www.w3.org/2000/09/xmldsig#"', pretty_print=True):
    ...
    def exportChildren(self, outfile, level, namespace_='ds:', name_='SPKIDataType', fromsubclass_=False, pretty_print=True):
        ...
        for SPKISexp_ in self.SPKISexp:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ds:SPKISexp>%s</ds:SPKISexp>%s' %
                          (self.gds_format_base64(SPKISexp_, input_name='SPKISexp'), eol_))
        if self.anytypeobjs_ is not None:
            self.anytypeobjs_.export(
                outfile, level, namespace_, pretty_print=pretty_print)
...
class ObjectType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='ds:', name_='ObjectType', namespacedef_='xmlns:ds="http://www.w3.org/2000/09/xmldsig#"', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='ds:', name_='ObjectType'):
        ...
        if self.MimeType is not None and 'MimeType' not in already_processed:
            ...
            outfile.write(' MimeType=%s' % (self.gds_encode(self.gds_format_string(
                quote_attrib(self.MimeType), input_name='MimeType')), ))
...
class ManifestType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='ds:', name_='ManifestType', namespacedef_='xmlns:ds="http://www.w3.org/2000/09/xmldsig#"', pretty_print=True):
...
class SignaturePropertiesType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='ds:', name_='SignaturePropertiesType', namespacedef_='xmlns:ds="http://www.w3.org/2000/09/xmldsig#"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get(
...
class SignaturePropertyType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='ds:', name_='SignaturePropertyType', namespacedef_='xmlns:ds="http://www.w3.org/2000/09/xmldsig#"', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get(
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='ds:', name_='SignaturePropertyType'):
        if self.Target is not None and 'Target' not in already_processed:
            ...
            outfile.write(' Target=%s' % (self.gds_encode(
                self.gds_format_string(quote_attrib(self.Target), input_name='Target')), ))
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(
                self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
...
class DSAKeyValueType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='ds:', name_='DSAKeyValueType', namespacedef_='xmlns:ds="http://www.w3.org/2000/09/xmldsig#"', pretty_print=True):
...
class RSAKeyValueType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='ds:', name_='RSAKeyValueType', namespacedef_='xmlns:ds="http://www.w3.org/2000/09/xmldsig#"', pretty_print=True):
    ...
    def exportChildren(self, outfile, level, namespace_='ds:', name_='RSAKeyValueType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Modulus is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ds:Modulus>%s</ds:Modulus>%s' %
                          (self.gds_format_base64(self.Modulus, input_name='Modulus'), eol_))
        if self.Exponent is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ds:Exponent>%s</ds:Exponent>%s' %
