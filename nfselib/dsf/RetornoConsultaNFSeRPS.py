...
#
# Generated Wed Nov 27 15:47:46 2019 by generateDS.py version 2.29.2.
...
#   ('-f', '')
#   ('-o', '/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/RetornoConsultaNFSeRPS.py')
#
# Command line arguments:
#   -
#
# Command line:
#   /home/mileo/Projects/rvaly/generateds/generateDS.py --no-namespace-defs --use-getter-setter="none" -f -o "/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/RetornoConsultaNFSeRPS.py" -
#
...
class RetornoConsultaNFSeRPS(GeneratedsSuper):
    """Schema utilizado para Retrono de consulta de
                                    notas."""
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, NotasConsultadas=None, Alertas=None, Erros=None):
        self.original_tagname_ = None
        self.Cabecalho = Cabecalho
        self.NotasConsultadas = NotasConsultadas
        self.Alertas = Alertas
        self.Erros = Erros
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, RetornoConsultaNFSeRPS)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if RetornoConsultaNFSeRPS.subclass:
            return RetornoConsultaNFSeRPS.subclass(*args_, **kwargs_)
        else:
            return RetornoConsultaNFSeRPS(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            self.Cabecalho is not None or
            self.NotasConsultadas is not None or
            ...
            return False
    def export(self, outfile, level, namespace_='ns1:', name_='RetornoConsultaNFSeRPS', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('RetornoConsultaNFSeRPS')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='RetornoConsultaNFSeRPS')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns1:', name_='RetornoConsultaNFSeRPS', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns1:', name_='RetornoConsultaNFSeRPS'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='RetornoConsultaNFSeRPS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.NotasConsultadas is not None:
            self.NotasConsultadas.export(outfile, level, namespace_, name_='NotasConsultadas', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'NotasConsultadas':
            obj_ = tpListaNFSeConsultaNota.factory()
            obj_.build(child_)
            self.NotasConsultadas = obj_
            obj_.original_tagname_ = 'NotasConsultadas'
...
# end class RetornoConsultaNFSeRPS
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'RetornoConsultaNFSeRPS'
        rootClass = RetornoConsultaNFSeRPS
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from RetornoConsultaNFSeRPS import *\n\n')
        sys.stdout.write('import RetornoConsultaNFSeRPS as model_\n\n')
