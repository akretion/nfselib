...
#
# Generated Wed Nov 27 15:47:39 2019 by generateDS.py version 2.29.2.
...
#   ('-f', '')
#   ('-o', '/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/ConsultaSeqRps.py')
#
# Command line arguments:
#   -
#
# Command line:
#   /home/mileo/Projects/rvaly/generateds/generateDS.py --no-namespace-defs --use-getter-setter="none" -f -o "/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/ConsultaSeqRps.py" -
#
...
class ConsultaSeqRps(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None):
        self.original_tagname_ = None
        self.Cabecalho = Cabecalho
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ConsultaSeqRps)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ConsultaSeqRps.subclass:
            return ConsultaSeqRps.subclass(*args_, **kwargs_)
        else:
            return ConsultaSeqRps(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            self.Cabecalho is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='ns1:', name_='ConsultaSeqRps', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ConsultaSeqRps')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ConsultaSeqRps')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns1:', name_='ConsultaSeqRps', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns1:', name_='ConsultaSeqRps'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='ConsultaSeqRps', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
# end class ConsultaSeqRps


class CabecalhoType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, CodCid=None, IMPrestador=None, CPFCNPJRemetente=None, SeriePrestacao=None, Versao=None):
        self.original_tagname_ = None
        self.CodCid = CodCid
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'ConsultaSeqRps'
        rootClass = ConsultaSeqRps
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from ConsultaSeqRps import *\n\n')
        sys.stdout.write('import ConsultaSeqRps as model_\n\n')
