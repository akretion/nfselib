...
#   ('-f', '')
#   ('-o', '/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/RetornoCancelamentoNFSe.py')
#
# Command line arguments:
#   -
#
# Command line:
#   /home/mileo/Projects/rvaly/generateds/generateDS.py --no-namespace-defs --use-getter-setter="none" -f -o "/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/RetornoCancelamentoNFSe.py" -
#
...
class RetornoCancelamentoNFSe(GeneratedsSuper):
    """Schema utilizado para RETORNO de Pedidos de cancelamento de NFSe."""
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, NotasCanceladas=None, Alertas=None, Erros=None):
        self.original_tagname_ = None
        self.Cabecalho = Cabecalho
        self.NotasCanceladas = NotasCanceladas
        self.Alertas = Alertas
        self.Erros = Erros
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, RetornoCancelamentoNFSe)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if RetornoCancelamentoNFSe.subclass:
            return RetornoCancelamentoNFSe.subclass(*args_, **kwargs_)
        else:
            return RetornoCancelamentoNFSe(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            self.Cabecalho is not None or
            self.NotasCanceladas is not None or
            ...
            return False
    def export(self, outfile, level, namespace_='ns1:', name_='RetornoCancelamentoNFSe', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('RetornoCancelamentoNFSe')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='RetornoCancelamentoNFSe')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns1:', name_='RetornoCancelamentoNFSe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns1:', name_='RetornoCancelamentoNFSe'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='RetornoCancelamentoNFSe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.NotasCanceladas is not None:
            self.NotasCanceladas.export(outfile, level, namespace_, name_='NotasCanceladas', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'NotasCanceladas':
            obj_ = tpRetornoNotasCancelamentoNFSe.factory()
            obj_.build(child_)
            self.NotasCanceladas = obj_
            obj_.original_tagname_ = 'NotasCanceladas'
...
# end class RetornoCancelamentoNFSe
...
class CabecalhoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, CodCidade=None, Sucesso=True, CPFCNPJRemetente=None, Versao=None):
        self.original_tagname_ = None
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'RetornoCancelamentoNFSe'
        rootClass = RetornoCancelamentoNFSe
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from RetornoCancelamentoNFSe import *\n\n')
        sys.stdout.write('import RetornoCancelamentoNFSe as model_\n\n')
