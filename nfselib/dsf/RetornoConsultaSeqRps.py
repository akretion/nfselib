...
#
# Generated Wed Nov 27 15:47:48 2019 by generateDS.py version 2.29.2.
...
#   ('-f', '')
#   ('-o', '/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/RetornoConsultaSeqRps.py')
#
# Command line arguments:
#   -
#
# Command line:
#   /home/mileo/Projects/rvaly/generateds/generateDS.py --no-namespace-defs --use-getter-setter="none" -f -o "/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/RetornoConsultaSeqRps.py" -
#
...
class RetornoConsultaSeqRps(GeneratedsSuper):
    """Schema utilizado para RETORNO da Consulta
                                    Sequêncial de RPS."""
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, Alertas=None, Erros=None):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, RetornoConsultaSeqRps)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if RetornoConsultaSeqRps.subclass:
            return RetornoConsultaSeqRps.subclass(*args_, **kwargs_)
        else:
            return RetornoConsultaSeqRps(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            self.Cabecalho is not None or
            self.Alertas is not None or
            self.Erros is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='ns1:', name_='RetornoConsultaSeqRps', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('RetornoConsultaSeqRps')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='RetornoConsultaSeqRps')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns1:', name_='RetornoConsultaSeqRps', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns1:', name_='RetornoConsultaSeqRps'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='RetornoConsultaSeqRps', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
# end class RetornoConsultaSeqRps
...
class CabecalhoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, CodCid=None, CPFCNPJRemetente=None, IMPrestador=None, NroUltimoRps=None, SeriePrestacao=None, Versao=None):
        self.original_tagname_ = None
        self.CodCid = CodCid
        self.validate_tpCodCidade(self.CodCid)
        self.CPFCNPJRemetente = CPFCNPJRemetente
        self.validate_tpCPFCNPJ(self.CPFCNPJRemetente)
        self.IMPrestador = IMPrestador
        self.validate_tpInscricaoMunicipal(self.IMPrestador)
        self.NroUltimoRps = NroUltimoRps
        self.validate_tpNumero(self.NroUltimoRps)
    ...
    def hasContent_(self):
        if (
            ...
            self.IMPrestador is not None or
            self.NroUltimoRps is not None or
    ...
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='CabecalhoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.CodCid is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ns1:CodCid>%s</ns1:CodCid>%s' % (self.gds_format_integer(self.CodCid, input_name='CodCid'), eol_))
        ...
        if self.IMPrestador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ns1:IMPrestador>%s</ns1:IMPrestador>%s' % (self.gds_format_integer(self.IMPrestador, input_name='IMPrestador'), eol_))
        if self.NroUltimoRps is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ns1:NroUltimoRps>%s</ns1:NroUltimoRps>%s' % (self.gds_format_integer(self.NroUltimoRps, input_name='NroUltimoRps'), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CodCid':
            ...
            ival_ = self.gds_validate_integer(ival_, node, 'CodCid')
            self.CodCid = ival_
            ...
            self.validate_tpCPFCNPJ(self.CPFCNPJRemetente)
        elif nodeName_ == 'IMPrestador':
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError) as exp:
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(ival_, node, 'IMPrestador')
            self.IMPrestador = ival_
            # validate type tpInscricaoMunicipal
            self.validate_tpInscricaoMunicipal(self.IMPrestador)
        elif nodeName_ == 'NroUltimoRps':
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError) as exp:
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(ival_, node, 'NroUltimoRps')
            self.NroUltimoRps = ival_
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'RetornoConsultaSeqRps'
        rootClass = RetornoConsultaSeqRps
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from RetornoConsultaSeqRps import *\n\n')
        sys.stdout.write('import RetornoConsultaSeqRps as model_\n\n')
