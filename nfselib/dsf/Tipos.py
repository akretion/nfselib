...
#
# Generated Wed Nov 27 15:47:50 2019 by generateDS.py version 2.29.2.
...
#   ('-f', '')
#   ('-o', '/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/Tipos.py')
#
# Command line arguments:
#   -
#
# Command line:
#   /home/mileo/Projects/rvaly/generateds/generateDS.py --no-namespace-defs --use-getter-setter="none" -f -o "/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/Tipos.py" -
#
...
class tpBairroCompleto(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpBairroCompleto', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpBairroCompleto', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpBairroCompleto'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpBairroCompleto', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.TipoBairro is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:TipoBairro>%s</tipos:TipoBairro>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.TipoBairro), input_name='TipoBairro')), eol_))
        if self.NomeBairro is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:NomeBairro>%s</tipos:NomeBairro>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.NomeBairro), input_name='NomeBairro')), eol_))
    def build(self, node):
        already_processed = set()
...
class tpEvento(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpEvento', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpEvento', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpEvento'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpEvento', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Codigo is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:Codigo>%s</tipos:Codigo>%s' % (self.gds_format_integer(self.Codigo, input_name='Codigo'), eol_))
        if self.Descricao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:Descricao>%s</tipos:Descricao>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Descricao), input_name='Descricao')), eol_))
...
class tpCPFCNPJ2(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpCPFCNPJ2', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpCPFCNPJ2', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpCPFCNPJ2'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpCPFCNPJ2', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.CPF is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:CPF>%s</tipos:CPF>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CPF), input_name='CPF')), eol_))
...
class tpConsultaNFSe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpConsultaNFSe', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpConsultaNFSe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpConsultaNFSe'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpConsultaNFSe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.InscricaoPrestador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:InscricaoPrestador>%s</tipos:InscricaoPrestador>%s' % (self.gds_format_integer(self.InscricaoPrestador, input_name='InscricaoPrestador'), eol_))
        if self.NumeroNFe is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:NumeroNFe>%s</tipos:NumeroNFe>%s' % (self.gds_format_integer(self.NumeroNFe, input_name='NumeroNFe'), eol_))
        if self.CodigoVerificacao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:CodigoVerificacao>%s</tipos:CodigoVerificacao>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CodigoVerificacao), input_name='CodigoVerificacao')), eol_))
        if self.SerieRPS is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:SerieRPS>%s</tipos:SerieRPS>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.SerieRPS), input_name='SerieRPS')), eol_))
        if self.NumeroRPS is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:NumeroRPS>%s</tipos:NumeroRPS>%s' % (self.gds_format_integer(self.NumeroRPS, input_name='NumeroRPS'), eol_))
        if self.DataEmissaoRPS is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:DataEmissaoRPS>%s</tipos:DataEmissaoRPS>%s' % (self.gds_format_datetime(self.DataEmissaoRPS, input_name='DataEmissaoRPS'), eol_))
        if self.RazaoSocialPrestador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:RazaoSocialPrestador>%s</tipos:RazaoSocialPrestador>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RazaoSocialPrestador), input_name='RazaoSocialPrestador')), eol_))
        if self.TipoRecolhimento is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:TipoRecolhimento>%s</tipos:TipoRecolhimento>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.TipoRecolhimento), input_name='TipoRecolhimento')), eol_))
        if self.ValorDeduzir is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:ValorDeduzir>%s</tipos:ValorDeduzir>%s' % (self.gds_format_float(self.ValorDeduzir, input_name='ValorDeduzir'), eol_))
        if self.ValorTotal is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:ValorTotal>%s</tipos:ValorTotal>%s' % (self.gds_format_float(self.ValorTotal, input_name='ValorTotal'), eol_))
        if self.Aliquota is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:Aliquota>%s</tipos:Aliquota>%s' % (self.gds_format_float(self.Aliquota, input_name='Aliquota'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class tpChaveNFeRPS(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpChaveNFeRPS', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpChaveNFeRPS', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpChaveNFeRPS'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpChaveNFeRPS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpChaveNFe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpChaveNFe', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpChaveNFe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpChaveNFe'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpChaveNFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpChaveRPS(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpChaveRPS', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpChaveRPS', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpChaveRPS'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpChaveRPS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpChaveSubstituicaoNFSe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpChaveSubstituicaoNFSe', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpChaveSubstituicaoNFSe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpChaveSubstituicaoNFSe'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpChaveSubstituicaoNFSe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.CPFCNPJTomador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:CPFCNPJTomador>%s</tipos:CPFCNPJTomador>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CPFCNPJTomador), input_name='CPFCNPJTomador')), eol_))
        if self.NumeroNFSeSubstituida is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:NumeroNFSeSubstituida>%s</tipos:NumeroNFSeSubstituida>%s' % (self.gds_format_integer(self.NumeroNFSeSubstituida, input_name='NumeroNFSeSubstituida'), eol_))
        if self.DataEmissaoNFSeSubstituida is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:DataEmissaoNFSeSubstituida>%s</tipos:DataEmissaoNFSeSubstituida>%s' % (self.gds_format_date(self.DataEmissaoNFSeSubstituida, input_name='DataEmissaoNFSeSubstituida'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class tpDeducoes(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpDeducoes', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpDeducoes', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpDeducoes'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpDeducoes', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.DeducaoPor is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:DeducaoPor>%s</tipos:DeducaoPor>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DeducaoPor), input_name='DeducaoPor')), eol_))
        if self.TipoDeducao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:TipoDeducao>%s</tipos:TipoDeducao>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.TipoDeducao), input_name='TipoDeducao')), eol_))
        if self.CPFCNPJReferencia is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:CPFCNPJReferencia>%s</tipos:CPFCNPJReferencia>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CPFCNPJReferencia), input_name='CPFCNPJReferencia')), eol_))
        if self.NumeroNFReferencia is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:NumeroNFReferencia>%s</tipos:NumeroNFReferencia>%s' % (self.gds_format_integer(self.NumeroNFReferencia, input_name='NumeroNFReferencia'), eol_))
        if self.ValorTotalReferencia is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:ValorTotalReferencia>%s</tipos:ValorTotalReferencia>%s' % (self.gds_format_float(self.ValorTotalReferencia, input_name='ValorTotalReferencia'), eol_))
        if self.PercentualDeduzir is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:PercentualDeduzir>%s</tipos:PercentualDeduzir>%s' % (self.gds_format_float(self.PercentualDeduzir, input_name='PercentualDeduzir'), eol_))
        if self.ValorDeduzir is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:ValorDeduzir>%s</tipos:ValorDeduzir>%s' % (self.gds_format_float(self.ValorDeduzir, input_name='ValorDeduzir'), eol_))
    def build(self, node):
...
class tpNotaCancelamentoNFSe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpNotaCancelamentoNFSe', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpNotaCancelamentoNFSe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpNotaCancelamentoNFSe'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpNotaCancelamentoNFSe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.InscricaoMunicipalPrestador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:InscricaoMunicipalPrestador>%s</tipos:InscricaoMunicipalPrestador>%s' % (self.gds_format_integer(self.InscricaoMunicipalPrestador, input_name='InscricaoMunicipalPrestador'), eol_))
        if self.NumeroNota is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:NumeroNota>%s</tipos:NumeroNota>%s' % (self.gds_format_integer(self.NumeroNota, input_name='NumeroNota'), eol_))
        if self.CodigoVerificacao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:CodigoVerificacao>%s</tipos:CodigoVerificacao>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CodigoVerificacao), input_name='CodigoVerificacao')), eol_))
        if self.MotivoCancelamento is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:MotivoCancelamento>%s</tipos:MotivoCancelamento>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.MotivoCancelamento), input_name='MotivoCancelamento')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class tpDetalhesConsultaRPS(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpDetalhesConsultaRPS', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpDetalhesConsultaRPS', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpDetalhesConsultaRPS'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpDetalhesConsultaRPS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpItens(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpItens', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpItens', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpItens'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpItens', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.DiscriminacaoServico is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:DiscriminacaoServico>%s</tipos:DiscriminacaoServico>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DiscriminacaoServico), input_name='DiscriminacaoServico')), eol_))
        if self.Quantidade is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:Quantidade>%s</tipos:Quantidade>%s' % (self.gds_format_float(self.Quantidade, input_name='Quantidade'), eol_))
        if self.ValorUnitario is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:ValorUnitario>%s</tipos:ValorUnitario>%s' % (self.gds_format_float(self.ValorUnitario, input_name='ValorUnitario'), eol_))
        if self.ValorTotal is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:ValorTotal>%s</tipos:ValorTotal>%s' % (self.gds_format_float(self.ValorTotal, input_name='ValorTotal'), eol_))
        if self.Tributavel is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:Tributavel>%s</tipos:Tributavel>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Tributavel), input_name='Tributavel')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class tpEndereco(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpEndereco', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpEndereco', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpEndereco'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpEndereco', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.TipoLogradouro is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:TipoLogradouro>%s</tipos:TipoLogradouro>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.TipoLogradouro), input_name='TipoLogradouro')), eol_))
        if self.Logradouro is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:Logradouro>%s</tipos:Logradouro>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Logradouro), input_name='Logradouro')), eol_))
        if self.NumeroEndereco is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:NumeroEndereco>%s</tipos:NumeroEndereco>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.NumeroEndereco), input_name='NumeroEndereco')), eol_))
        if self.ComplementoEndereco is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:ComplementoEndereco>%s</tipos:ComplementoEndereco>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ComplementoEndereco), input_name='ComplementoEndereco')), eol_))
        if self.TipoBairro is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:TipoBairro>%s</tipos:TipoBairro>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.TipoBairro), input_name='TipoBairro')), eol_))
        if self.Bairro is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:Bairro>%s</tipos:Bairro>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Bairro), input_name='Bairro')), eol_))
        if self.Cidade is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:Cidade>%s</tipos:Cidade>%s' % (self.gds_format_integer(self.Cidade, input_name='Cidade'), eol_))
        if self.UF is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:UF>%s</tipos:UF>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.UF), input_name='UF')), eol_))
        if self.CEP is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:CEP>%s</tipos:CEP>%s' % (self.gds_format_integer(self.CEP, input_name='CEP'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class tpInformacoesLote(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpInformacoesLote', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpInformacoesLote', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpInformacoesLote'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpInformacoesLote', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.NumeroLote is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:NumeroLote>%s</tipos:NumeroLote>%s' % (self.gds_format_integer(self.NumeroLote, input_name='NumeroLote'), eol_))
        if self.InscricaoPrestador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:InscricaoPrestador>%s</tipos:InscricaoPrestador>%s' % (self.gds_format_integer(self.InscricaoPrestador, input_name='InscricaoPrestador'), eol_))
        if self.CPFCNPJRemetente is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:CPFCNPJRemetente>%s</tipos:CPFCNPJRemetente>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CPFCNPJRemetente), input_name='CPFCNPJRemetente')), eol_))
        if self.DataEnvioLote is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:DataEnvioLote>%s</tipos:DataEnvioLote>%s' % (self.gds_format_datetime(self.DataEnvioLote, input_name='DataEnvioLote'), eol_))
        if self.QtdNotasProcessadas is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:QtdNotasProcessadas>%s</tipos:QtdNotasProcessadas>%s' % (self.gds_format_float(self.QtdNotasProcessadas, input_name='QtdNotasProcessadas'), eol_))
        if self.TempoProcessamento is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:TempoProcessamento>%s</tipos:TempoProcessamento>%s' % (self.gds_format_integer(self.TempoProcessamento, input_name='TempoProcessamento'), eol_))
        if self.ValorTotalServicos is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:ValorTotalServicos>%s</tipos:ValorTotalServicos>%s' % (self.gds_format_float(self.ValorTotalServicos, input_name='ValorTotalServicos'), eol_))
        if self.ValorTotalDeducoes is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:ValorTotalDeducoes>%s</tipos:ValorTotalDeducoes>%s' % (self.gds_format_float(self.ValorTotalDeducoes, input_name='ValorTotalDeducoes'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class tpLogradouroCompleto(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpLogradouroCompleto', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpLogradouroCompleto', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpLogradouroCompleto'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpLogradouroCompleto', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.NomeLogradouro is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:NomeLogradouro>%s</tipos:NomeLogradouro>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.NomeLogradouro), input_name='NomeLogradouro')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class tpListaAlertas(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpListaAlertas', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpListaAlertas', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpListaAlertas'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpListaAlertas', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpListaDeducoes(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpListaDeducoes', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpListaDeducoes', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpListaDeducoes'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpListaDeducoes', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpLoteCancelamentoNFSe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpLoteCancelamentoNFSe', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpLoteCancelamentoNFSe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpLoteCancelamentoNFSe'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpLoteCancelamentoNFSe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpNotasCancelamentoNFSe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpNotasCancelamentoNFSe', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpNotasCancelamentoNFSe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpNotasCancelamentoNFSe'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpNotasCancelamentoNFSe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpRetornoNotasCancelamentoNFSe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpRetornoNotasCancelamentoNFSe', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpRetornoNotasCancelamentoNFSe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpRetornoNotasCancelamentoNFSe'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpRetornoNotasCancelamentoNFSe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpLoteConsultaNFSe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpLoteConsultaNFSe', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpLoteConsultaNFSe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpLoteConsultaNFSe'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpLoteConsultaNFSe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpNotasConsultaNFSe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpNotasConsultaNFSe', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpNotasConsultaNFSe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpNotasConsultaNFSe'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpNotasConsultaNFSe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpNotaConsultaNFSe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpNotaConsultaNFSe', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpNotaConsultaNFSe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpNotaConsultaNFSe'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpNotaConsultaNFSe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpRPSsConsultaNFSe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpRPSsConsultaNFSe', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpRPSsConsultaNFSe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpRPSsConsultaNFSe'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpRPSsConsultaNFSe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpRPSConsultaNFSe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpRPSConsultaNFSe', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpRPSConsultaNFSe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpRPSConsultaNFSe'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpRPSConsultaNFSe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.SeriePrestacao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:SeriePrestacao>%s</tipos:SeriePrestacao>%s' % (self.gds_format_integer(self.SeriePrestacao, input_name='SeriePrestacao'), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class tpListaDetalhesConsultaRPS(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpListaDetalhesConsultaRPS', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpListaDetalhesConsultaRPS', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpListaDetalhesConsultaRPS'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpListaDetalhesConsultaRPS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpListaErros(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpListaErros', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpListaErros', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpListaErros'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpListaErros', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpListaItens(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpListaItens', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpListaItens', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpListaItens'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpListaItens', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpListaNFSeRPS(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpListaNFSeRPS', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpListaNFSeRPS', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpListaNFSeRPS'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpListaNFSeRPS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpListaNFSe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpListaNFSe', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpListaNFSe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpListaNFSe'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpListaNFSe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpListaNFSeConsultaNota(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpListaNFSeConsultaNota', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpListaNFSeConsultaNota', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpListaNFSeConsultaNota'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpListaNFSeConsultaNota', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpLote(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpLote', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpLote', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpLote'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpLote', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class tpNFSe(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpNFSe', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpNFSe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpNFSe'):
        pass
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpNFSe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.DataProcessamento is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:DataProcessamento>%s</tipos:DataProcessamento>%s' % (self.gds_format_datetime(self.DataProcessamento, input_name='DataProcessamento'), eol_))
        if self.NumeroLote is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:NumeroLote>%s</tipos:NumeroLote>%s' % (self.gds_format_integer(self.NumeroLote, input_name='NumeroLote'), eol_))
        if self.CodigoVerificacao is not None:
        ...
        if self.Assinatura is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:Assinatura>%s</tipos:Assinatura>%s' % (self.gds_format_base64(self.Assinatura, input_name='Assinatura'), eol_))
        if self.InscricaoMunicipalPrestador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:InscricaoMunicipalPrestador>%s</tipos:InscricaoMunicipalPrestador>%s' % (self.gds_format_integer(self.InscricaoMunicipalPrestador, input_name='InscricaoMunicipalPrestador'), eol_))
        if self.RazaoSocialPrestador is not None:
        ...
        if self.TipoRPS is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:TipoRPS>%s</tipos:TipoRPS>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.TipoRPS), input_name='TipoRPS')), eol_))
        if self.SerieRPS is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:SerieRPS>%s</tipos:SerieRPS>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.SerieRPS), input_name='SerieRPS')), eol_))
        if self.NumeroRPS is not None:
        ...
        if self.SituacaoRPS is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:SituacaoRPS>%s</tipos:SituacaoRPS>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.SituacaoRPS), input_name='SituacaoRPS')), eol_))
        if self.SerieRPSSubstituido is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:SerieRPSSubstituido>%s</tipos:SerieRPSSubstituido>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.SerieRPSSubstituido), input_name='SerieRPSSubstituido')), eol_))
        if self.NumeroRPSSubstituido is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:NumeroRPSSubstituido>%s</tipos:NumeroRPSSubstituido>%s' % (self.gds_format_integer(self.NumeroRPSSubstituido, input_name='NumeroRPSSubstituido'), eol_))
        if self.NumeroNFSeSubstituida is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:NumeroNFSeSubstituida>%s</tipos:NumeroNFSeSubstituida>%s' % (self.gds_format_integer(self.NumeroNFSeSubstituida, input_name='NumeroNFSeSubstituida'), eol_))
        if self.DataEmissaoNFSeSubstituida is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:DataEmissaoNFSeSubstituida>%s</tipos:DataEmissaoNFSeSubstituida>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DataEmissaoNFSeSubstituida), input_name='DataEmissaoNFSeSubstituida')), eol_))
        if self.SeriePrestacao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:SeriePrestacao>%s</tipos:SeriePrestacao>%s' % (self.gds_format_integer(self.SeriePrestacao, input_name='SeriePrestacao'), eol_))
        if self.InscricaoMunicipalTomador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:InscricaoMunicipalTomador>%s</tipos:InscricaoMunicipalTomador>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.InscricaoMunicipalTomador), input_name='InscricaoMunicipalTomador')), eol_))
        if self.CPFCNPJTomador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:CPFCNPJTomador>%s</tipos:CPFCNPJTomador>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CPFCNPJTomador), input_name='CPFCNPJTomador')), eol_))
        if self.RazaoSocialTomador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:RazaoSocialTomador>%s</tipos:RazaoSocialTomador>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RazaoSocialTomador), input_name='RazaoSocialTomador')), eol_))
        if self.DocTomadorEstrangeiro is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:DocTomadorEstrangeiro>%s</tipos:DocTomadorEstrangeiro>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DocTomadorEstrangeiro), input_name='DocTomadorEstrangeiro')), eol_))
        if self.TipoLogradouroTomador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:TipoLogradouroTomador>%s</tipos:TipoLogradouroTomador>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.TipoLogradouroTomador), input_name='TipoLogradouroTomador')), eol_))
        if self.LogradouroTomador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:LogradouroTomador>%s</tipos:LogradouroTomador>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.LogradouroTomador), input_name='LogradouroTomador')), eol_))
        if self.NumeroEnderecoTomador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:NumeroEnderecoTomador>%s</tipos:NumeroEnderecoTomador>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.NumeroEnderecoTomador), input_name='NumeroEnderecoTomador')), eol_))
        if self.ComplementoEnderecoTomador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:ComplementoEnderecoTomador>%s</tipos:ComplementoEnderecoTomador>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.ComplementoEnderecoTomador), input_name='ComplementoEnderecoTomador')), eol_))
        if self.TipoBairroTomador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:TipoBairroTomador>%s</tipos:TipoBairroTomador>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.TipoBairroTomador), input_name='TipoBairroTomador')), eol_))
        if self.BairroTomador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:BairroTomador>%s</tipos:BairroTomador>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.BairroTomador), input_name='BairroTomador')), eol_))
        if self.CidadeTomador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:CidadeTomador>%s</tipos:CidadeTomador>%s' % (self.gds_format_integer(self.CidadeTomador, input_name='CidadeTomador'), eol_))
        if self.CidadeTomadorDescricao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:CidadeTomadorDescricao>%s</tipos:CidadeTomadorDescricao>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CidadeTomadorDescricao), input_name='CidadeTomadorDescricao')), eol_))
        if self.CEPTomador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:CEPTomador>%s</tipos:CEPTomador>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CEPTomador), input_name='CEPTomador')), eol_))
        if self.EmailTomador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:EmailTomador>%s</tipos:EmailTomador>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.EmailTomador), input_name='EmailTomador')), eol_))
        if self.CodigoAtividade is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:CodigoAtividade>%s</tipos:CodigoAtividade>%s' % (self.gds_format_integer(self.CodigoAtividade, input_name='CodigoAtividade'), eol_))
        if self.AliquotaAtividade is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:AliquotaAtividade>%s</tipos:AliquotaAtividade>%s' % (self.gds_format_float(self.AliquotaAtividade, input_name='AliquotaAtividade'), eol_))
        if self.TipoRecolhimento is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:TipoRecolhimento>%s</tipos:TipoRecolhimento>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.TipoRecolhimento), input_name='TipoRecolhimento')), eol_))
        if self.MunicipioPrestacao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:MunicipioPrestacao>%s</tipos:MunicipioPrestacao>%s' % (self.gds_format_integer(self.MunicipioPrestacao, input_name='MunicipioPrestacao'), eol_))
        if self.MunicipioPrestacaoDescricao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:MunicipioPrestacaoDescricao>%s</tipos:MunicipioPrestacaoDescricao>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.MunicipioPrestacaoDescricao), input_name='MunicipioPrestacaoDescricao')), eol_))
        if self.Operacao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:Operacao>%s</tipos:Operacao>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Operacao), input_name='Operacao')), eol_))
        if self.Tributacao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:Tributacao>%s</tipos:Tributacao>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Tributacao), input_name='Tributacao')), eol_))
        if self.ValorPIS is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:ValorPIS>%s</tipos:ValorPIS>%s' % (self.gds_format_float(self.ValorPIS, input_name='ValorPIS'), eol_))
        if self.ValorCOFINS is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:ValorCOFINS>%s</tipos:ValorCOFINS>%s' % (self.gds_format_float(self.ValorCOFINS, input_name='ValorCOFINS'), eol_))
        if self.ValorINSS is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:ValorINSS>%s</tipos:ValorINSS>%s' % (self.gds_format_float(self.ValorINSS, input_name='ValorINSS'), eol_))
        if self.ValorIR is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:ValorIR>%s</tipos:ValorIR>%s' % (self.gds_format_float(self.ValorIR, input_name='ValorIR'), eol_))
        if self.ValorCSLL is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:ValorCSLL>%s</tipos:ValorCSLL>%s' % (self.gds_format_float(self.ValorCSLL, input_name='ValorCSLL'), eol_))
        if self.AliquotaPIS is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:AliquotaPIS>%s</tipos:AliquotaPIS>%s' % (self.gds_format_float(self.AliquotaPIS, input_name='AliquotaPIS'), eol_))
        if self.AliquotaCOFINS is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:AliquotaCOFINS>%s</tipos:AliquotaCOFINS>%s' % (self.gds_format_float(self.AliquotaCOFINS, input_name='AliquotaCOFINS'), eol_))
        if self.AliquotaINSS is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:AliquotaINSS>%s</tipos:AliquotaINSS>%s' % (self.gds_format_float(self.AliquotaINSS, input_name='AliquotaINSS'), eol_))
        if self.AliquotaIR is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:AliquotaIR>%s</tipos:AliquotaIR>%s' % (self.gds_format_float(self.AliquotaIR, input_name='AliquotaIR'), eol_))
        if self.AliquotaCSLL is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:AliquotaCSLL>%s</tipos:AliquotaCSLL>%s' % (self.gds_format_float(self.AliquotaCSLL, input_name='AliquotaCSLL'), eol_))
        if self.DescricaoRPS is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:DescricaoRPS>%s</tipos:DescricaoRPS>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DescricaoRPS), input_name='DescricaoRPS')), eol_))
        if self.DDDPrestador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:DDDPrestador>%s</tipos:DDDPrestador>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DDDPrestador), input_name='DDDPrestador')), eol_))
        if self.TelefonePrestador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:TelefonePrestador>%s</tipos:TelefonePrestador>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.TelefonePrestador), input_name='TelefonePrestador')), eol_))
        if self.DDDTomador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:DDDTomador>%s</tipos:DDDTomador>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DDDTomador), input_name='DDDTomador')), eol_))
        if self.TelefoneTomador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:TelefoneTomador>%s</tipos:TelefoneTomador>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.TelefoneTomador), input_name='TelefoneTomador')), eol_))
        if self.MotCancelamento is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:MotCancelamento>%s</tipos:MotCancelamento>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.MotCancelamento), input_name='MotCancelamento')), eol_))
        if self.CPFCNPJIntermediario is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:CPFCNPJIntermediario>%s</tipos:CPFCNPJIntermediario>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.CPFCNPJIntermediario), input_name='CPFCNPJIntermediario')), eol_))
...
class tpRPS(GeneratedsSuper):
    ...
    def validate_tpNumero(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            if value > 2147483647:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on tpNumero' % {"value" : value} )
            if not self.gds_validate_simple_patterns(
                    self.validate_tpNumero_patterns_, str(value)):
                warnings_.warn('Value "%s" does not match xsd pattern restrictions: %s' % (value.encode('utf-8'), self.validate_tpNumero_patterns_, ))
    validate_tpNumero_patterns_ = [['^[0-9]{1,12}$']]
    def validate_tpSituacaoRPS(self, value):
        # Validate type tpSituacaoRPS, a restriction on xs:string.
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='tipos:', name_='tpRPS', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='tipos:', name_='tpRPS', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='tipos:', name_='tpRPS'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespace_='tipos:', name_='tpRPS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.CEPTomador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:CEPTomador>%s</tipos:CEPTomador>%s' % (self.gds_format_integer(self.CEPTomador, input_name='CEPTomador'), eol_))
        if self.EmailTomador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:EmailTomador>%s</tipos:EmailTomador>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.EmailTomador), input_name='EmailTomador')), eol_))
        if self.CodigoAtividade is not None:
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'tpBairroCompleto'
        rootClass = tpBairroCompleto
    ...
    if not silence:
        ...
        rootObj.export(
            ...
            namespacedef_='xmlns:tipos="http://localhost:8080/WsNFe2/tp"',
            pretty_print=True)
    return rootObj
