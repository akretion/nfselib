...
#
# Generated Wed Nov 27 15:47:43 2019 by generateDS.py version 2.29.2.
...
#   ('-f', '')
#   ('-o', '/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/ReqConsultaNotas.py')
#
# Command line arguments:
#   -
#
# Command line:
#   /home/mileo/Projects/rvaly/generateds/generateDS.py --no-namespace-defs --use-getter-setter="none" -f -o "/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/ReqConsultaNotas.py" -
#
...
class ReqConsultaNotas(GeneratedsSuper):
    """Schema utilizado para REQUISIÇAO de consultas
                                    de notas que foram enviadas por lote de
    RPS."""
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, Signature=None):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ReqConsultaNotas)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ReqConsultaNotas.subclass:
            return ReqConsultaNotas.subclass(*args_, **kwargs_)
        else:
            return ReqConsultaNotas(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='ns1:', name_='ReqConsultaNotas', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ReqConsultaNotas')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ReqConsultaNotas')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns1:', name_='ReqConsultaNotas', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns1:', name_='ReqConsultaNotas'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='ReqConsultaNotas', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class CabecalhoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Id=None, CodCidade=None, CPFCNPJRemetente=None, InscricaoMunicipalPrestador=None, dtInicio=None, dtFim=None, NotaInicial=None, Versao=None):
        self.original_tagname_ = None
        ...
        self.validate_tpNumero(self.NotaInicial)
        self.Versao = Versao
    ...
    def hasContent_(self):
        if (
            ...
            self.NotaInicial is not None or
    ...
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='CabecalhoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.NotaInicial is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ns1:NotaInicial>%s</ns1:NotaInicial>%s' % (self.gds_format_integer(self.NotaInicial, input_name='NotaInicial'), eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CodCidade':
            ...
            dval_ = self.gds_parse_date(sval_)
            self.dtFim = dval_
        elif nodeName_ == 'NotaInicial':
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError) as exp:
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(ival_, node, 'NotaInicial')
            self.NotaInicial = ival_
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'ReqConsultaNotas'
        rootClass = ReqConsultaNotas
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from ReqConsultaNotas import *\n\n')
        sys.stdout.write('import ReqConsultaNotas as model_\n\n')
