...
#
# Generated Wed Nov 27 15:47:49 2019 by generateDS.py version 2.29.2.
...
#   ('-f', '')
#   ('-o', '/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/RetornoEnvioLoteRPS.py')
#
# Command line arguments:
#   -
#
# Command line:
#   /home/mileo/Projects/rvaly/generateds/generateDS.py --no-namespace-defs --use-getter-setter="none" -f -o "/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/RetornoEnvioLoteRPS.py" -
#
...
class RetornoEnvioLoteRPS(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, Alertas=None, Erros=None, ChavesNFSeRPS=None):
        self.original_tagname_ = None
        self.Cabecalho = Cabecalho
        self.Alertas = Alertas
        self.Erros = Erros
        self.ChavesNFSeRPS = ChavesNFSeRPS
    ...
    def hasContent_(self):
        if (
            ...
            self.ChavesNFSeRPS is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='ns1:', name_='RetornoEnvioLoteRPS', namespacedef_='', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='RetornoEnvioLoteRPS')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns1:', name_='RetornoEnvioLoteRPS', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns1:', name_='RetornoEnvioLoteRPS'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='RetornoEnvioLoteRPS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.ChavesNFSeRPS is not None:
            self.ChavesNFSeRPS.export(outfile, level, namespace_, name_='ChavesNFSeRPS', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'ChavesNFSeRPS':
            obj_ = tpListaNFSeRPS.factory()
            obj_.build(child_)
            self.ChavesNFSeRPS = obj_
            obj_.original_tagname_ = 'ChavesNFSeRPS'
...
class CabecalhoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, CodCidade=None, Sucesso=None, NumeroLote=None, CPFCNPJRemetente=None, DataEnvioLote=None, QtdNotasProcessadas=None, TempoProcessamento=None, ValorTotalServicos=None, ValorTotalDeducoes=None, Versao=None, Assincrono=None):
        self.original_tagname_ = None
        ...
        self.validate_tpAssincrono(self.Assincrono)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def validate_tpAssincrono(self, value):
        # Validate type tpAssincrono, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            value = str(value)
            enumerations = ['S', 'N']
            ...
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on tpAssincrono' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
    ...
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='CabecalhoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Assincrono is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ns1:Assincrono>%s</ns1:Assincrono>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.Assincrono), input_name='Assincrono')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CodCidade':
            ...
            self.validate_tpVersao(self.Versao)
        elif nodeName_ == 'Assincrono':
            Assincrono_ = child_.text
            Assincrono_ = self.gds_validate_string(Assincrono_, node, 'Assincrono')
            self.Assincrono = Assincrono_
            # validate type tpAssincrono
            self.validate_tpAssincrono(self.Assincrono)
