...
#
# Generated Wed Nov 27 15:47:47 2019 by generateDS.py version 2.29.2.
...
#   ('-f', '')
#   ('-o', '/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/RetornoConsultaNotas.py')
#
# Command line arguments:
#   -
#
# Command line:
#   /home/mileo/Projects/rvaly/generateds/generateDS.py --no-namespace-defs --use-getter-setter="none" -f -o "/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/RetornoConsultaNotas.py" -
#
...
class RetornoConsultaNotas(GeneratedsSuper):
    """Schema utilizado para Retrono de consulta de notas."""
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, Notas=None, Erros=None):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, RetornoConsultaNotas)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if RetornoConsultaNotas.subclass:
            return RetornoConsultaNotas.subclass(*args_, **kwargs_)
        else:
            return RetornoConsultaNotas(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            self.Cabecalho is not None or
            self.Notas is not None or
            self.Erros is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='ns1:', name_='RetornoConsultaNotas', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('RetornoConsultaNotas')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='RetornoConsultaNotas')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns1:', name_='RetornoConsultaNotas', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns1:', name_='RetornoConsultaNotas'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='RetornoConsultaNotas', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.Notas is not None:
            self.Notas.export(outfile, level, namespace_, name_='Notas', pretty_print=pretty_print)
...
class CabecalhoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, CodCidade=None, CPFCNPJRemetente=None, InscricaoMunicipalPrestador=None, dtInicio=None, dtFim=None, Versao=None):
        self.original_tagname_ = None
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'RetornoConsultaNotas'
        rootClass = RetornoConsultaNotas
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from RetornoConsultaNotas import *\n\n')
        sys.stdout.write('import RetornoConsultaNotas as model_\n\n')
