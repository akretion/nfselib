...
#
# Generated Wed Nov 27 15:47:40 2019 by generateDS.py version 2.29.2.
...
#   ('-f', '')
#   ('-o', '/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/ReqCancelamentoNFSe.py')
#
# Command line arguments:
#   -
#
# Command line:
#   /home/mileo/Projects/rvaly/generateds/generateDS.py --no-namespace-defs --use-getter-setter="none" -f -o "/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/ReqCancelamentoNFSe.py" -
#
...
class ReqCancelamentoNFSe(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ReqCancelamentoNFSe)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ReqCancelamentoNFSe.subclass:
            return ReqCancelamentoNFSe.subclass(*args_, **kwargs_)
        else:
            return ReqCancelamentoNFSe(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='ns1:', name_='ReqCancelamentoNFSe', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ReqCancelamentoNFSe')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ReqCancelamentoNFSe')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns1:', name_='ReqCancelamentoNFSe', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns1:', name_='ReqCancelamentoNFSe'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='ReqCancelamentoNFSe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Cabecalho':
            ...
            obj_ = tpLoteCancelamentoNFSe.factory()
            obj_.build(child_)
            self.Lote = obj_
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'ReqCancelamentoNFSe'
        rootClass = ReqCancelamentoNFSe
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from ReqCancelamentoNFSe import *\n\n')
        sys.stdout.write('import ReqCancelamentoNFSe as model_\n\n')
