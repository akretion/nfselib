...
#
# Generated Wed Nov 27 15:47:41 2019 by generateDS.py version 2.29.2.
...
#   ('-f', '')
#   ('-o', '/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/ReqConsultaLote.py')
#
# Command line arguments:
#   -
#
# Command line:
#   /home/mileo/Projects/rvaly/generateds/generateDS.py --no-namespace-defs --use-getter-setter="none" -f -o "/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/ReqConsultaLote.py" -
#
...
class ReqConsultaLote(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ReqConsultaLote)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ReqConsultaLote.subclass:
            return ReqConsultaLote.subclass(*args_, **kwargs_)
        else:
            return ReqConsultaLote(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='ns1:', name_='ReqConsultaLote', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ReqConsultaLote')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ReqConsultaLote')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns1:', name_='ReqConsultaLote', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns1:', name_='ReqConsultaLote'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='ReqConsultaLote', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class CabecalhoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, CodCidade=None, CPFCNPJRemetente=None, Versao=None, NumeroLote=None):
        self.original_tagname_ = None
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'ReqConsultaLote'
        rootClass = ReqConsultaLote
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from ReqConsultaLote import *\n\n')
        sys.stdout.write('import ReqConsultaLote as model_\n\n')
