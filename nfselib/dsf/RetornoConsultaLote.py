...
#
# Generated Wed Nov 27 15:47:45 2019 by generateDS.py version 2.29.2.
...
#   ('-f', '')
#   ('-o', '/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/RetornoConsultaLote.py')
#
# Command line arguments:
#   -
#
# Command line:
#   /home/mileo/Projects/rvaly/generateds/generateDS.py --no-namespace-defs --use-getter-setter="none" -f -o "/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/RetornoConsultaLote.py" -
#
...
class RetornoConsultaLote(GeneratedsSuper):
    """Schema utilizado para RETORNO de consulta de lote de RPS."""
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, Alertas=None, Erros=None, ListaNFSe=None):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, RetornoConsultaLote)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if RetornoConsultaLote.subclass:
            return RetornoConsultaLote.subclass(*args_, **kwargs_)
        else:
            return RetornoConsultaLote(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            self.Cabecalho is not None or
            self.Alertas is not None or
            self.Erros is not None or
            self.ListaNFSe is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='ns1:', name_='RetornoConsultaLote', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('RetornoConsultaLote')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='RetornoConsultaLote')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns1:', name_='RetornoConsultaLote', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns1:', name_='RetornoConsultaLote'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='RetornoConsultaLote', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.Alertas is not None:
            self.Alertas.export(outfile, level, namespace_, name_='Alertas', pretty_print=pretty_print)
        if self.Erros is not None:
            self.Erros.export(outfile, level, namespace_, name_='Erros', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'Alertas':
            obj_ = tpListaAlertas.factory()
            obj_.build(child_)
            self.Alertas = obj_
            obj_.original_tagname_ = 'Alertas'
        elif nodeName_ == 'Erros':
            obj_ = tpListaErros.factory()
            obj_.build(child_)
            self.Erros = obj_
            obj_.original_tagname_ = 'Erros'
        elif nodeName_ == 'ListaNFSe':
            obj_ = tpListaNFSe.factory()
            obj_.build(child_)
            self.ListaNFSe = obj_
            obj_.original_tagname_ = 'ListaNFSe'
# end class RetornoConsultaLote
...
class CabecalhoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, CodCidade=None, Sucesso=None, NumeroLote=None, CPFCNPJRemetente=None, RazaoSocialRemetente=None, DataEnvioLote=None, QtdNotasProcessadas=None, TempoProcessamento=None, ValorTotalServicos=None, ValorTotalDeducoes=None, Versao=None):
        self.original_tagname_ = None
        ...
        self.validate_tpDataHoraNulo(self.DataEnvioLote)
        self.QtdNotasProcessadas = QtdNotasProcessadas
        self.validate_tpQtdRpsLote(self.QtdNotasProcessadas)
    ...
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='CabecalhoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Sucesso is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ns1:Sucesso>%s</ns1:Sucesso>%s' % (self.gds_format_boolean(self.Sucesso, input_name='Sucesso'), eol_))
        ...
        if self.DataEnvioLote is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ns1:DataEnvioLote>%s</ns1:DataEnvioLote>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.DataEnvioLote), input_name='DataEnvioLote')), eol_))
        if self.QtdNotasProcessadas is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ns1:QtdNotasProcessadas>%s</ns1:QtdNotasProcessadas>%s' % (self.gds_format_integer(self.QtdNotasProcessadas, input_name='QtdNotasProcessadas'), eol_))
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'RetornoConsultaLote'
        rootClass = RetornoConsultaLote
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from RetornoConsultaLote import *\n\n')
        sys.stdout.write('import RetornoConsultaLote as model_\n\n')
