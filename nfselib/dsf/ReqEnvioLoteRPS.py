...
#
# Generated Wed Nov 27 15:47:44 2019 by generateDS.py version 2.29.2.
...
#   ('-f', '')
#   ('-o', '/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/ReqEnvioLoteRPS.py')
#
# Command line arguments:
#   -
#
# Command line:
#   /home/mileo/Projects/rvaly/generateds/generateDS.py --no-namespace-defs --use-getter-setter="none" -f -o "/home/mileo/Projects/oca10/src/nfselib/nfselib/dsf/ReqEnvioLoteRPS.py" -
#
...
class ReqEnvioLoteRPS(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ReqEnvioLoteRPS)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ReqEnvioLoteRPS.subclass:
            return ReqEnvioLoteRPS.subclass(*args_, **kwargs_)
        else:
            return ReqEnvioLoteRPS(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='ns1:', name_='ReqEnvioLoteRPS', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ReqEnvioLoteRPS')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ReqEnvioLoteRPS')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='ns1:', name_='ReqEnvioLoteRPS', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ns1:', name_='ReqEnvioLoteRPS'):
        pass
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='ReqEnvioLoteRPS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class CabecalhoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, CodCidade=None, CPFCNPJRemetente=None, RazaoSocialRemetente=None, transacao=True, dtInicio=None, dtFim=None, QtdRPS=None, ValorTotalServicos=None, ValorTotalDeducoes=None, Versao=None, MetodoEnvio=None, VersaoComponente=None):
        self.original_tagname_ = None
        ...
        self.RazaoSocialRemetente = RazaoSocialRemetente
        self.validate_tpRazaoSocial(self.RazaoSocialRemetente)
        ...
        self.QtdRPS = QtdRPS
        self.validate_tpQtdRpsLote(self.QtdRPS)
        ...
        self.validate_tpMetodoEnvio(self.MetodoEnvio)
        self.VersaoComponente = VersaoComponente
        self.validate_tpVersaoComponente(self.VersaoComponente)
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def validate_tpQtdRpsLote(self, value):
        # Validate type tpQtdRpsLote, a restriction on xs:integer.
        if value is not None and Validate_simpletypes_:
            if value < 1:
                warnings_.warn('Value "%(value)s" does not match xsd minInclusive restriction on tpQtdRpsLote' % {"value" : value} )
            if value > 250:
                warnings_.warn('Value "%(value)s" does not match xsd maxInclusive restriction on tpQtdRpsLote' % {"value" : value} )
    ...
    def validate_tpMetodoEnvio(self, value):
        # Validate type tpMetodoEnvio, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            value = str(value)
            enumerations = ['WS', 'DLL', 'DMS']
            ...
            if not enumeration_respectee:
                warnings_.warn('Value "%(value)s" does not match xsd enumeration restriction on tpMetodoEnvio' % {"value" : value.encode("utf-8")} )
    def validate_tpVersaoComponente(self, value):
        # Validate type tpVersaoComponente, a restriction on xs:string.
        if value is not None and Validate_simpletypes_:
            if len(value) > 10:
                warnings_.warn('Value "%(value)s" does not match xsd maxLength restriction on tpVersaoComponente' % {"value" : value.encode("utf-8")} )
            if len(value) < 0:
                warnings_.warn('Value "%(value)s" does not match xsd minLength restriction on tpVersaoComponente' % {"value" : value.encode("utf-8")} )
    def hasContent_(self):
        if (
            self.CodCidade is not None or
            self.CPFCNPJRemetente is not None or
            self.RazaoSocialRemetente is not None or
            ...
            self.ValorTotalDeducoes is not None or
            self.Versao is not None or
            self.MetodoEnvio is not None or
            self.VersaoComponente is not None
        ):
            return True
        else:
            return False
    ...
    def exportChildren(self, outfile, level, namespace_='ns1:', name_='CabecalhoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.RazaoSocialRemetente is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ns1:RazaoSocialRemetente>%s</ns1:RazaoSocialRemetente>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.RazaoSocialRemetente), input_name='RazaoSocialRemetente')), eol_))
        ...
        if self.dtInicio is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ns1:dtInicio>%s</ns1:dtInicio>%s' % (self.gds_format_date(self.dtInicio, input_name='dtInicio'), eol_))
        if self.dtFim is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ns1:dtFim>%s</ns1:dtFim>%s' % (self.gds_format_date(self.dtFim, input_name='dtFim'), eol_))
        if self.QtdRPS is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ns1:QtdRPS>%s</ns1:QtdRPS>%s' % (self.gds_format_integer(self.QtdRPS, input_name='QtdRPS'), eol_))
        ...
        if self.MetodoEnvio is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ns1:MetodoEnvio>%s</ns1:MetodoEnvio>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.MetodoEnvio), input_name='MetodoEnvio')), eol_))
        if self.VersaoComponente is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<ns1:VersaoComponente>%s</ns1:VersaoComponente>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.VersaoComponente), input_name='VersaoComponente')), eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CodCidade':
            ...
            self.validate_tpCPFCNPJ(self.CPFCNPJRemetente)
        elif nodeName_ == 'RazaoSocialRemetente':
            RazaoSocialRemetente_ = child_.text
            RazaoSocialRemetente_ = self.gds_validate_string(RazaoSocialRemetente_, node, 'RazaoSocialRemetente')
            self.RazaoSocialRemetente = RazaoSocialRemetente_
            ...
            self.validate_tpVersao(self.Versao)
        elif nodeName_ == 'MetodoEnvio':
            MetodoEnvio_ = child_.text
            MetodoEnvio_ = self.gds_validate_string(MetodoEnvio_, node, 'MetodoEnvio')
            self.MetodoEnvio = MetodoEnvio_
            # validate type tpMetodoEnvio
            self.validate_tpMetodoEnvio(self.MetodoEnvio)
        elif nodeName_ == 'VersaoComponente':
            VersaoComponente_ = child_.text
            VersaoComponente_ = self.gds_validate_string(VersaoComponente_, node, 'VersaoComponente')
            self.VersaoComponente = VersaoComponente_
            # validate type tpVersaoComponente
            self.validate_tpVersaoComponente(self.VersaoComponente)
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'ReqEnvioLoteRPS'
        rootClass = ReqEnvioLoteRPS
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from ReqEnvioLoteRPS import *\n\n')
        sys.stdout.write('import ReqEnvioLoteRPS as model_\n\n')
