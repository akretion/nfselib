...
__NAMESPACE__ = "http://nfse.indaiatuba.sp.gov.br"
...
class CancelarNfseRequest(Input):
    class Meta:
        namespace = "http://nfse.indaiatuba.sp.gov.br"
...
class NfseCancelarNfse:
    style = "document"
    location = "https://deiss.indaiatuba.sp.gov.br/producao/nfse"
    transport = "http://schemas.xmlsoap.org/soap/http"
    soapAction = "http://nfse.indaiatuba.sp.gov.br/CancelarNfse"
...
class NfseConsultarLoteRps:
    ...
    location = "https://deiss.indaiatuba.sp.gov.br/producao/nfse"
    transport = "http://schemas.xmlsoap.org/soap/http"
    soapAction = "http://nfse.indaiatuba.sp.gov.br/ConsultarLoteRps"
...
class NfseConsultarNfsePorFaixa:
    ...
    location = "https://deiss.indaiatuba.sp.gov.br/producao/nfse"
    transport = "http://schemas.xmlsoap.org/soap/http"
    soapAction = "http://nfse.indaiatuba.sp.gov.br/ConsultarNfsePorFaixa"
...
class NfseConsultarNfsePorRps:
    ...
    location = "https://deiss.indaiatuba.sp.gov.br/producao/nfse"
    transport = "http://schemas.xmlsoap.org/soap/http"
    soapAction = "http://nfse.indaiatuba.sp.gov.br/ConsultarNfsePorRps"
...
class NfseConsultarNfseServicoPrestado:
    ...
    transport = "http://schemas.xmlsoap.org/soap/http"
    soapAction = (
        "http://nfse.indaiatuba.sp.gov.br/ConsultarNfseServicoPrestado"
    )
...
class NfseConsultarNfseServicoTomado:
    ...
    location = "https://deiss.indaiatuba.sp.gov.br/producao/nfse"
    transport = "http://schemas.xmlsoap.org/soap/http"
    soapAction = "http://nfse.indaiatuba.sp.gov.br/ConsultarNfseServicoTomado"
...
class NfseRecepcionarLoteRps:
    ...
    location = "https://deiss.indaiatuba.sp.gov.br/producao/nfse"
    transport = "http://schemas.xmlsoap.org/soap/http"
    soapAction = "http://nfse.indaiatuba.sp.gov.br/RecepcionarLoteRps"
...
class NfseRecepcionarLoteRpsSincrono:
    ...
    location = "https://deiss.indaiatuba.sp.gov.br/producao/nfse"
    transport = "http://schemas.xmlsoap.org/soap/http"
    soapAction = "http://nfse.indaiatuba.sp.gov.br/RecepcionarLoteRpsSincrono"
...
class NfseSubstituirNfse:
    ...
    location = "https://deiss.indaiatuba.sp.gov.br/producao/nfse"
    transport = "http://schemas.xmlsoap.org/soap/http"
    soapAction = "http://nfse.indaiatuba.sp.gov.br/SubstituirNfse"
