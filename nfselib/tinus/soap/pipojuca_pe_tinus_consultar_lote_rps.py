...
@dataclass
class ConsultarLoteRpsSoapConsultarLoteRpsOutput:
    class Meta:
        name = "Envelope"
        namespace = "http://schemas.xmlsoap.org/soap/envelope/"

    Body: Optional["ConsultarLoteRpsSoapConsultarLoteRpsOutput.Body"] = field(
        default=None,
        metadata={
            "type": "Element",
        },
    ...
    class Body:
        ...
        Fault: Optional[
            "ConsultarLoteRpsSoapConsultarLoteRpsOutput.Body.Fault"
        ] = field(
            default=None,
            metadata={
                "type": "Element",
...
@dataclass
class ConsultarLoteRpsSoapTestInput:
    class Meta:
        name = "Envelope"
        namespace = "http://schemas.xmlsoap.org/soap/envelope/"

    Body: Optional["ConsultarLoteRpsSoapTestInput.Body"] = field(
        default=None,
        metadata={
            "type": "Element",
        },
...
@dataclass
class ConsultarLoteRpsSoapTestOutput:
    class Meta:
        name = "Envelope"
        namespace = "http://schemas.xmlsoap.org/soap/envelope/"

    Body: Optional["ConsultarLoteRpsSoapTestOutput.Body"] = field(
        default=None,
        metadata={
            "type": "Element",
        },
    ...
    class Body:
        ...
        Fault: Optional["ConsultarLoteRpsSoapTestOutput.Body.Fault"] = field(
            default=None,
            metadata={
                "type": "Element",
            },
...
@dataclass
class ConsultarLoteRpsSoapTesteRetornoInput:
    class Meta:
        name = "Envelope"
        namespace = "http://schemas.xmlsoap.org/soap/envelope/"

    Body: Optional["ConsultarLoteRpsSoapTesteRetornoInput.Body"] = field(
        default=None,
        metadata={
            "type": "Element",
        },
    ...
    @dataclass
    class Body:
        TesteRetorno: Optional[TesteRetorno] = field(
            default=None,
            metadata={
                "type": "Element",
                "namespace": "http://www.abrasf.org.br/nfse.xsd",
...
@dataclass
class TesteRetornoResponse:
    class Meta:
        namespace = "http://www.abrasf.org.br/nfse.xsd"

    TesteRetornoResult: Optional[ConsultarLoteRpsResposta] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
...
class ConsultarLoteRpsSoapTest:
    style = "document"
    location = (
        "http://www.tinus.com.br/csp/ipojuca/WSNFSE.ConsultarLoteRps.cls"
    )
    transport = "http://schemas.xmlsoap.org/soap/http"
    soapAction = (
        "http://www.abrasf.org.br/nfse.xsd/WSNFSE.ConsultarLoteRps.Test"
    )
    input = ConsultarLoteRpsSoapTestInput
    output = ConsultarLoteRpsSoapTestOutput


@dataclass
class ConsultarLoteRpsSoapTesteRetornoOutput:
    class Meta:
        name = "Envelope"
        namespace = "http://schemas.xmlsoap.org/soap/envelope/"

    Body: Optional["ConsultarLoteRpsSoapTesteRetornoOutput.Body"] = field(
        default=None,
        metadata={
            "type": "Element",
        },
    ...
    @dataclass
    class Body:
        TesteRetornoResponse: Optional[TesteRetornoResponse] = field(
            default=None,
            metadata={
                "type": "Element",
                "namespace": "http://www.abrasf.org.br/nfse.xsd",
        ...
        Fault: Optional[
            "ConsultarLoteRpsSoapTesteRetornoOutput.Body.Fault"
        ] = field(
            default=None,
            metadata={
                "type": "Element",
...
@dataclass
class ConsultarLoteRpsSoapConsultarLoteRpsInput:
    class Meta:
        name = "Envelope"
        namespace = "http://schemas.xmlsoap.org/soap/envelope/"

    Body: Optional["ConsultarLoteRpsSoapConsultarLoteRpsInput.Body"] = field(
        default=None,
        metadata={
            "type": "Element",
        },
...
class ConsultarLoteRpsSoapTesteRetorno:
    style = "document"
    location = (
        "http://www.tinus.com.br/csp/ipojuca/WSNFSE.ConsultarLoteRps.cls"
    )
    transport = "http://schemas.xmlsoap.org/soap/http"
    soapAction = "http://www.abrasf.org.br/nfse.xsd/WSNFSE.ConsultarLoteRps.TesteRetorno"
    input = ConsultarLoteRpsSoapTesteRetornoInput
    output = ConsultarLoteRpsSoapTesteRetornoOutput
...
class ConsultarLoteRpsSoapConsultarLoteRps:
    style = "document"
    location = (
        "http://www.tinus.com.br/csp/ipojuca/WSNFSE.ConsultarLoteRps.cls"
    )
    transport = "http://schemas.xmlsoap.org/soap/http"
    soapAction = "http://www.abrasf.org.br/nfse.xsd/WSNFSE.ConsultarLoteRps.ConsultarLoteRps"
    input = ConsultarLoteRpsSoapConsultarLoteRpsInput
    output = ConsultarLoteRpsSoapConsultarLoteRpsOutput
...
@dataclass
class ArrayOfCompNfsetcCompNfse:
...
@dataclass
class ConsultarLoteRpsResposta1:
    class Meta:
        name = "ConsultarLoteRpsResposta"

    ListaNfse: Optional[ArrayOfCompNfsetcCompNfse] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.abrasf.org.br/nfse.xsd",
