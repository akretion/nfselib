...
@dataclass
class ConsultarNfseSoapConsultarNfseOutput:
    class Meta:
        name = "Envelope"
        namespace = "http://schemas.xmlsoap.org/soap/envelope/"

    Body: Optional["ConsultarNfseSoapConsultarNfseOutput.Body"] = field(
        default=None,
        metadata={
            "type": "Element",
        },
    ...
    class Body:
        ...
        Fault: Optional["ConsultarNfseSoapConsultarNfseOutput.Body.Fault"] = (
            field(
                default=None,
                metadata={
                    "type": "Element",
...
@dataclass
class ConsultarNfseSoapTestInput:
    class Meta:
        name = "Envelope"
        namespace = "http://schemas.xmlsoap.org/soap/envelope/"

    Body: Optional["ConsultarNfseSoapTestInput.Body"] = field(
        default=None,
        metadata={
            "type": "Element",
        },
...
@dataclass
class ConsultarNfseSoapTestOutput:
    class Meta:
        name = "Envelope"
        namespace = "http://schemas.xmlsoap.org/soap/envelope/"

    Body: Optional["ConsultarNfseSoapTestOutput.Body"] = field(
        default=None,
        metadata={
            "type": "Element",
        },
    ...
    class Body:
        ...
        Fault: Optional["ConsultarNfseSoapTestOutput.Body.Fault"] = field(
            default=None,
            metadata={
                "type": "Element",
            },
...
class ConsultarNfseSoapTest:
    style = "document"
    location = "http://www.tinus.com.br/csp/ipojuca/WSNFSE.ConsultarNfse.cls"
    transport = "http://schemas.xmlsoap.org/soap/http"
    soapAction = "http://www.abrasf.org.br/nfse.xsd/WSNFSE.ConsultarNfse.Test"
    input = ConsultarNfseSoapTestInput
    output = ConsultarNfseSoapTestOutput
...
@dataclass
class ConsultarNfseSoapConsultarNfseInput:
    class Meta:
        name = "Envelope"
        namespace = "http://schemas.xmlsoap.org/soap/envelope/"

    Body: Optional["ConsultarNfseSoapConsultarNfseInput.Body"] = field(
        default=None,
        metadata={
            "type": "Element",
        },
...
class ConsultarNfseSoapConsultarNfse:
    style = "document"
    location = "http://www.tinus.com.br/csp/ipojuca/WSNFSE.ConsultarNfse.cls"
    transport = "http://schemas.xmlsoap.org/soap/http"
    soapAction = (
        "http://www.abrasf.org.br/nfse.xsd/WSNFSE.ConsultarNfse.ConsultarNfse"
    )
    input = ConsultarNfseSoapConsultarNfseInput
    output = ConsultarNfseSoapConsultarNfseOutput
