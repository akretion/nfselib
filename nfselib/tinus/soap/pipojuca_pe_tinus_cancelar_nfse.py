...
class ConsultarNfseResposta:
    ...
    ConsultarNfse10Result: Optional["ConsultarNfseResposta"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
...
@dataclass
class CancelarNfseSoapCancelarNfseOutput:
    class Meta:
        name = "Envelope"
        namespace = "http://schemas.xmlsoap.org/soap/envelope/"

    Body: Optional["CancelarNfseSoapCancelarNfseOutput.Body"] = field(
        default=None,
        metadata={
            "type": "Element",
        },
    ...
    class Body:
        ...
        Fault: Optional["CancelarNfseSoapCancelarNfseOutput.Body.Fault"] = (
            field(
                default=None,
                metadata={
                    "type": "Element",
...
@dataclass
class CancelarNfseSoapConsultarNfse10Output:
    class Meta:
        name = "Envelope"
        namespace = "http://schemas.xmlsoap.org/soap/envelope/"

    Body: Optional["CancelarNfseSoapConsultarNfse10Output.Body"] = field(
        default=None,
        metadata={
            "type": "Element",
        },
    ...
    @dataclass
    class Body:
        ConsultarNfseResposta: Optional[ConsultarNfseResposta] = field(
            default=None,
            metadata={
                "type": "Element",
                "namespace": "http://www.abrasf.org.br/nfse.xsd",
        ...
        Fault: Optional["CancelarNfseSoapConsultarNfse10Output.Body.Fault"] = (
            field(
                default=None,
                metadata={
                    "type": "Element",
...
@dataclass
class CancelarNfseSoapTestInput:
    class Meta:
        name = "Envelope"
        namespace = "http://schemas.xmlsoap.org/soap/envelope/"

    Body: Optional["CancelarNfseSoapTestInput.Body"] = field(
        default=None,
        metadata={
            "type": "Element",
        },
...
@dataclass
class CancelarNfseSoapTestOutput:
    class Meta:
        name = "Envelope"
        namespace = "http://schemas.xmlsoap.org/soap/envelope/"

    Body: Optional["CancelarNfseSoapTestOutput.Body"] = field(
        default=None,
        metadata={
            "type": "Element",
        },
    ...
    class Body:
        ...
        Fault: Optional["CancelarNfseSoapTestOutput.Body.Fault"] = field(
            default=None,
            metadata={
                "type": "Element",
            },
...
class CancelarNfseSoapTest:
    style = "document"
    location = "http://www.tinus.com.br/csp/ipojuca/WSNFSE.CancelarNfse.cls"
    transport = "http://schemas.xmlsoap.org/soap/http"
    soapAction = "http://www.abrasf.org.br/nfse.xsd/WSNFSE.CancelarNfse.Test"
    input = CancelarNfseSoapTestInput
    output = CancelarNfseSoapTestOutput
...
class ConsultarNfseEnvio:
    ...
    PeriodoEmissao: Optional[PeriodoEmissao] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.abrasf.org.br/nfse.xsd",
...
@dataclass
class CancelarNfseSoapConsultarNfse10Input:
    class Meta:
        name = "Envelope"
        namespace = "http://schemas.xmlsoap.org/soap/envelope/"

    Body: Optional["CancelarNfseSoapConsultarNfse10Input.Body"] = field(
        default=None,
        metadata={
            "type": "Element",
        },
    ...
    @dataclass
    class Body:
        ConsultarNfse10: Optional[ConsultarNfse10] = field(
            default=None,
            metadata={
                "type": "Element",
                "namespace": "http://www.abrasf.org.br/nfse.xsd",
...
class CancelarNfseSoapConsultarNfse10:
    style = "document"
    location = "http://www.tinus.com.br/csp/ipojuca/WSNFSE.CancelarNfse.cls"
    transport = "http://schemas.xmlsoap.org/soap/http"
    soapAction = (
        "http://www.abrasf.org.br/nfse.xsd/WSNFSE.CancelarNfse.ConsultarNfse10"
    )
    input = CancelarNfseSoapConsultarNfse10Input
    output = CancelarNfseSoapConsultarNfse10Output
...
@dataclass
class CancelarNfseSoapCancelarNfseInput:
    class Meta:
        name = "Envelope"
        namespace = "http://schemas.xmlsoap.org/soap/envelope/"

    Body: Optional["CancelarNfseSoapCancelarNfseInput.Body"] = field(
        default=None,
        metadata={
            "type": "Element",
        },
...
@dataclass
class CancelarNfseResposta1:
    class Meta:
        name = "CancelarNfseResposta"

    retCancelamento: Optional[TcCancelamentoNfse] = field(
        default=None,
        metadata={
...
class CancelarNfseSoapCancelarNfse:
    style = "document"
    location = "http://www.tinus.com.br/csp/ipojuca/WSNFSE.CancelarNfse.cls"
    transport = "http://schemas.xmlsoap.org/soap/http"
    soapAction = (
        "http://www.abrasf.org.br/nfse.xsd/WSNFSE.CancelarNfse.CancelarNfse"
    )
    input = CancelarNfseSoapCancelarNfseInput
    output = CancelarNfseSoapCancelarNfseOutput
