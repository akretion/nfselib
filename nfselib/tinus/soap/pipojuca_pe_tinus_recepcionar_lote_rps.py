...
@dataclass
class RecepcionarLoteRpsSoapRecepcionarLoteRpsOutput:
    class Meta:
        name = "Envelope"
        namespace = "http://schemas.xmlsoap.org/soap/envelope/"

    Body: Optional["RecepcionarLoteRpsSoapRecepcionarLoteRpsOutput.Body"] = (
        field(
            default=None,
            metadata={
                "type": "Element",
    ...
    class Body:
        ...
        Fault: Optional[
            "RecepcionarLoteRpsSoapRecepcionarLoteRpsOutput.Body.Fault"
        ] = field(
            default=None,
            metadata={
                "type": "Element",
...
@dataclass
class RecepcionarLoteRpsSoapTestInput:
    class Meta:
        name = "Envelope"
        namespace = "http://schemas.xmlsoap.org/soap/envelope/"

    Body: Optional["RecepcionarLoteRpsSoapTestInput.Body"] = field(
        default=None,
        metadata={
            "type": "Element",
        },
...
@dataclass
class RecepcionarLoteRpsSoapTestOutput:
    class Meta:
        name = "Envelope"
        namespace = "http://schemas.xmlsoap.org/soap/envelope/"

    Body: Optional["RecepcionarLoteRpsSoapTestOutput.Body"] = field(
        default=None,
        metadata={
            "type": "Element",
        },
    ...
    class Body:
        ...
        Fault: Optional["RecepcionarLoteRpsSoapTestOutput.Body.Fault"] = field(
            default=None,
            metadata={
                "type": "Element",
            },
...
class RecepcionarLoteRpsSoapTest:
    style = "document"
    location = (
        "http://www.tinus.com.br/csp/ipojuca/WSNFSE.RecepcionarLoteRps.cls"
    )
    transport = "http://schemas.xmlsoap.org/soap/http"
    soapAction = (
        "http://www.abrasf.org.br/nfse.xsd/WSNFSE.RecepcionarLoteRps.Test"
    )
    input = RecepcionarLoteRpsSoapTestInput
    output = RecepcionarLoteRpsSoapTestOutput
...
class TcLoteRps:
    ...
    ListaRps: Optional[ArrayOfRpstcRps] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.abrasf.org.br/nfse.xsd",
...
@dataclass
class RecepcionarLoteRpsSoapRecepcionarLoteRpsInput:
    class Meta:
        name = "Envelope"
        namespace = "http://schemas.xmlsoap.org/soap/envelope/"

    Body: Optional["RecepcionarLoteRpsSoapRecepcionarLoteRpsInput.Body"] = (
        field(
            default=None,
            metadata={
                "type": "Element",
...
class RecepcionarLoteRpsSoapRecepcionarLoteRps:
    style = "document"
    location = (
        "http://www.tinus.com.br/csp/ipojuca/WSNFSE.RecepcionarLoteRps.cls"
    )
    transport = "http://schemas.xmlsoap.org/soap/http"
    soapAction = "http://www.abrasf.org.br/nfse.xsd/WSNFSE.RecepcionarLoteRps.RecepcionarLoteRps"
    input = RecepcionarLoteRpsSoapRecepcionarLoteRpsInput
    output = RecepcionarLoteRpsSoapRecepcionarLoteRpsOutput
