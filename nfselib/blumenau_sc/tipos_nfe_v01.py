...
__NAMESPACE__ = "http://nfse.blumenau.sc.gov.br/tipos"
...
class TpOpcaoSimples(Enum):
    ...
    :cvar VALUE_4: Optante pelo Simples Nacional.
    :cvar VALUE_6: Optante pelo MEI.
    """
    VALUE_0 = "0"
    VALUE_1 = "1"
    VALUE_2 = "2"
...
class TpTributacaoNfe(Enum):
    ...
    :cvar T: Tributação no municipio de Manaus.
    :cvar F: Tributação fora do municipio de Manaus.
    :cvar I: Isento.
...
class TpNfe:
    ...
    tributacao_nfe: Optional[TpTributacaoNfe] = field(
        default=None,
        metadata={
            "name": "TributacaoNFe",
            "type": "Element",
...
class TpRps:
    ...
    :ivar inscricao_municipal_tomador: Informe a Inscrição Municipal do
        ...
        tomadores estabelecidos no município de Manaus. Quando este
        campo for preenchido, seu conteúdo será considerado como
    ...
    :ivar razao_social_tomador: Informe o Nome/Razão Social do tomador.
        ...
        ou a Inscrição Municipal do tomador pertença ao município de
        Manaus.
    :ivar endereco_tomador: Informe o endereço do tomador. Os campos do
        ...
        pertença ao município de Manaus.
    ...
    tributacao_rps: Optional[TpTributacaoNfe] = field(
        default=None,
        metadata={
            "name": "TributacaoRPS",
            "type": "Element",
