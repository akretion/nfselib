...
class Credenciais:
    ...
    chave_privada: Optional[str] = field(
        default=None,
        metadata={
            "name": "chavePrivada",
            "type": "Element",
...
class TcContato:
    ...
    tipo_telefone: Optional[str] = field(
        default=None,
        metadata={
            "name": "TipoTelefone",
            "type": "Element",
...
class TcInfPedidoCancelamentoRps:
    ...
    descricao_cancelamento: Optional[str] = field(
        default=None,
        metadata={
...
class TcPedidoCancelamentoRps:
    ...
    inf_pedido_cancelamento: Optional[TcInfPedidoCancelamentoRps] = field(
        default=None,
        metadata={
...
class RetCancelamentoRps:
    ...
    rps_cancelamento: List[TcCancelamentoRps] = field(
        default_factory=list,
        metadata={
            "name": "RpsCancelamento",
            "type": "Element",
            "min_occurs": 1,
        }
    )
...
class TcInfNfse:
    ...
    status_nfse: Optional[str] = field(
        default=None,
        metadata={
            "name": "StatusNfse",
            "type": "Element",
...
class CancelarRpsResposta:
    ...
    ret_cancelamento_rps: Optional[RetCancelamentoRps] = field(
        default=None,
        metadata={
