...
__NAMESPACE__ = "http://nfe.sjp.pr.gov.br/servico_consultar_nfse_rps_envio_v03.xsd"


@dataclass
class ConsultarNfseRpsEnvio:
    class Meta:
        namespace = "http://nfe.sjp.pr.gov.br/servico_consultar_nfse_rps_envio_v03.xsd"
