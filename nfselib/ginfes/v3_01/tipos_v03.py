...
#
# Generated Thu Dec 13 15:47:51 2018 by generateDS.py version 2.29.2.
# Python 3.7.1 (default, Oct 22 2018, 10:41:28)  [GCC 8.2.1 20180831]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', 'nfselib/v3_01/tipos_v03.py')
#
# Command line arguments:
#   schemas/v3_01/tipos_v03.xsd
#
# Command line:
#   /usr/bin/generateDS --no-namespace-defs -o "nfselib/v3_01/tipos_v03.py" schemas/v3_01/tipos_v03.xsd
#
...
class tcLoteRps(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='tcLoteRps', fromsubclass_=False, pretty_print=True):
        ...
        if self.QuantidadeRps is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<tipos:QuantidadeRps>%s</tipos:QuantidadeRps>%s' % (self.gds_format_integer(self.QuantidadeRps, input_name='QuantidadeRps'), eol_))
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from tipos_v03 import *\n\n')
        sys.stdout.write('import tipos_v03 as model_\n\n')
