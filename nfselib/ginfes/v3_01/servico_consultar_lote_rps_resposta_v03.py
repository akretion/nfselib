...
#
# Generated Thu Dec 13 15:47:44 2018 by generateDS.py version 2.29.2.
# Python 3.7.1 (default, Oct 22 2018, 10:41:28)  [GCC 8.2.1 20180831]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', 'nfselib/v3_01/servico_consultar_lote_rps_resposta_v03.py')
#
# Command line arguments:
#   schemas/v3_01/servico_consultar_lote_rps_resposta_v03.xsd
#
# Command line:
#   /usr/bin/generateDS --no-namespace-defs -o "nfselib/v3_01/servico_consultar_lote_rps_resposta_v03.py" schemas/v3_01/servico_consultar_lote_rps_resposta_v03.xsd
#
...
class ConsultarLoteRpsResposta(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='ConsultarLoteRpsResposta', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespace_='', name_='ConsultarLoteRpsResposta', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
...
class ListaNfseType(GeneratedsSuper):
    ...
    def insert_CompNfse_at(self, index, value): self.CompNfse.insert(index, value)
    ...
    def export(self, outfile, level, namespace_='', name_='ListaNfseType', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='ListaNfseType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from servico_consultar_lote_rps_resposta_v03 import *\n\n')
        sys.stdout.write('import servico_consultar_lote_rps_resposta_v03 as model_\n\n')
