...
#   ('--no-namespace-defs', '')
#   ('-o', 'nfselib/v3_01/servico_consultar_lote_rps_envio_v03.py')
#
# Command line arguments:
#   schemas/v3_01/servico_consultar_lote_rps_envio_v03.xsd
#
# Command line:
#   /usr/bin/generateDS --no-namespace-defs -o "nfselib/v3_01/servico_consultar_lote_rps_envio_v03.py" schemas/v3_01/servico_consultar_lote_rps_envio_v03.xsd
#
...
class ConsultarLoteRpsEnvio(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='ConsultarLoteRpsEnvio', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespace_='', name_='ConsultarLoteRpsEnvio', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from servico_consultar_lote_rps_envio_v03 import *\n\n')
        sys.stdout.write('import servico_consultar_lote_rps_envio_v03 as model_\n\n')
