...
#
# Generated Thu Dec 13 15:47:50 2018 by generateDS.py version 2.29.2.
# Python 3.7.1 (default, Oct 22 2018, 10:41:28)  [GCC 8.2.1 20180831]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', 'nfselib/v3_01/servico_enviar_lote_rps_resposta_v03.py')
#
# Command line arguments:
#   schemas/v3_01/servico_enviar_lote_rps_resposta_v03.xsd
#
# Command line:
#   /usr/bin/generateDS --no-namespace-defs -o "nfselib/v3_01/servico_enviar_lote_rps_resposta_v03.py" schemas/v3_01/servico_enviar_lote_rps_resposta_v03.xsd
#
...
class EnviarLoteRpsResposta(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='EnviarLoteRpsResposta', namespacedef_='', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespace_='', name_='EnviarLoteRpsResposta', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='EnviarLoteRpsResposta', fromsubclass_=False, pretty_print=True):
        ...
        if self.DataRecebimento is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<DataRecebimento>%s</DataRecebimento>%s' % (self.gds_format_datetime(self.DataRecebimento, input_name='DataRecebimento'), eol_))
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from servico_enviar_lote_rps_resposta_v03 import *\n\n')
        sys.stdout.write('import servico_enviar_lote_rps_resposta_v03 as model_\n\n')
