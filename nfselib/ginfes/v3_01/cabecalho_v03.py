...
#
# Generated Thu Dec 13 15:47:41 2018 by generateDS.py version 2.29.2.
# Python 3.7.1 (default, Oct 22 2018, 10:41:28)  [GCC 8.2.1 20180831]
#
# Command line options:
#   ('--no-namespace-defs', '')
#   ('-o', 'nfselib/v3_01/cabecalho_v03.py')
#
# Command line arguments:
#   schemas/v3_01/cabecalho_v03.xsd
#
# Command line:
#   /usr/bin/generateDS --no-namespace-defs -o "nfselib/v3_01/cabecalho_v03.py" schemas/v3_01/cabecalho_v03.xsd
#
...
class cabecalho(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='ns2:', name_='cabecalho', namespacedef_='xmlns:ns2="http://www.ginfes.com.br/cabecalho_v03.xsd"', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='cabecalho')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='cabecalho', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='cabecalho', fromsubclass_=False, pretty_print=True):
        ...
        if self.versaoDados is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<versaoDados>%s</versaoDados>%s' % (self.gds_encode(self.gds_format_string(quote_xml(self.versaoDados), input_name='versaoDados')), eol_))
    def build(self, node):
        already_processed = set()
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from cabecalho_v03 import *\n\n')
        sys.stdout.write('import cabecalho_v03 as model_\n\n')
